...
-   Las empresas que ofrecen catálogos impresos pueden usar los **códigos de origen** para realizar un seguimiento de la respuesta del cliente a catálogos particulares. Los códigos fuente se imprimen en la parte trasera de un catálogo y se especifican en el pedido de ventas cuando un cliente realiza una compra. Para agregar un código fuente al catálogo, primero debe crear un mercado de destino. El mercado de destino normalmente se asigna a una lista de correo o alquilada propiedad.
