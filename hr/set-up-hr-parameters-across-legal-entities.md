...
-   ** ** – Puede asignar siempre trabajadores a las nuevos puestos cuando se crean los puestos. Cuando se crean los puestos, ** disponible para la asignación ** la fecha y hora en ** general ** la ficha ** puesto ** de la página se establece automáticamente en la fecha de creación y el tiempo.
...
[] Establecer parámetros específicos de la hora de la empresa de la configuración (setup-company-specific-hr-parameters.md)
