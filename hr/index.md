...
Mientras se trabaja con recursos humanos, decidirá cómo estructurar su organización utilizando elementos, como departamentos, trabajos y puestos. Estos son los elementos fundamentales que se configurará en recursos humanos. Se asignan empleados individuales a puestos asociados a trabajos.
...
Para ayudar a sus empleados a alcanzar sus objetivos de carrera mientras que ofrecer críticos para el negocio necesita que puede establecer objetivos, crear revisiones de rendimiento y realizar un seguimiento de los comentarios para ayudar a los empleados a desarrollar las habilidades necesarias, también puede configurar instructores, tipos de cursos, cursos, descripciones de los cursos, agendas, pistas y sesiones antes de asignar un instructor al curso, o registrar una persona para un curso. Los instructores deben existir como trabajadores, candidatos, o contactos.

-   [Gestión del rendimiento](performance-management-overview.md)
-   [Alinear las habilidades del personal y las necesidades del negocio](skills.md)
...
-   [Cumplir con la ley de estadounidenses con discapacidades](localizations/noam-usa-comply-ada.md)
