...
Este tema describe los elementos (UI) de la interfaz de usuario utilizados en Dynamics 365 for Finance and Operations. Para que los usuarios puedan navegar por la interfaz, es importante conocer los nombres y las funciones de los elementos que componen la interfaz.
