...
#### [Características de AX 2012 no implementadas aún](get-started/ax-2012-features-not-implemented-but-not-deprecated.md)
...
#### [Actualización 7 de la plataforma (mayo de 2017)](get-started/whats-new-platform-update-7.md)
...
#### [Crear un pedido de compra regido por el presupuesto](../supply-chain/cost-management/tasks/create-purchase-order-governed-by-budget.md)
#### L. MAT realiza cálculos usando la hoja de gestión de costes
##### [Crear un producto terminado (febrero de 2016 únicamente)](../supply-chain/pim/tasks/create-finished-product-2016-02.md)
##### [Crear un producto semiterminado (febrero de 2016 únicamente)](../supply-chain/pim/tasks/create-semi-finished-product-2016-02.md)
##### [Crear materias primas (febrero de 2016 únicamente)](../supply-chain/pim/tasks/create-raw-materials-2016-02.md)
##### [Crear L. MAT. (febrero de 2016 únicamente)](../supply-chain/pim/tasks/create-boms-2016-02.md)
##### [Crear rutas (febrero de 2016 únicamente)](../supply-chain/pim/tasks/create-routes-2016-02.md)
...
## Administración de datos e integración

### [Entidades de datos, proyectos y paquetes](../dev-itpro/data-entities/data-entities.md)
#### [Marco de trabajo de entidades de datos y paquetes](../dev-itpro/data-entities/data-entities-data-packages.md)
...
##### [Entidades de datos: adquisición y abastecimiento](../dev-itpro/data-entities/data-entities-procurement-sourcing.md)
...
##### [Entidades de datos: venta minorista](../dev-itpro/data-entities/data-entities-retail.md)
...
#### [Introducción](../financials/cost-accounting/get-started.md)
##### [Terminología de contabilidad de costes](../financials/cost-accounting/terms-cost-accounting.md)
#### [Configurar entidades base](../financials/cost-accounting/configure-base-entities.md)
##### [Divisa (eLearning)](https://mbspartner.microsoft.com/AX/CourseModules/1215.md) 
##### [Tipos de cambio (eLearning)](https://mbspartner.microsoft.com/AX/CourseModules/1215.md) 
##### [Calendarios fiscales, ejercicios y períodos](../financials/budgeting/fiscal-calendars-fiscal-years-periods.md)
##### [Dimensiones financieras](../financials/general-ledger/financial-dimensions.md)
...
#### Crear jerarquía de dimensión
##### [Jerarquía de dimensión](../financials/cost-accounting/dimension-hierarchy.md)
...
##### [Espacio de trabajo móvil de control de costes (Vídeo)](https://youtu.be/imsuTg8rUVk.md)
...
##### [Usar un espacio de trabajo de control de costes para informes (Vídeo)](https://youtu.be/imsuTg8rUVk.md)
##### [Exportar entradas a Excel (Vídeo)](https://youtu.be/-HKHYdClvx8.md)
...
#### [Preguntas más frecuentes sobre acciones del personal](../talent/personnel-actions-faq.md)
...
##### [Preguntas más frecuentes sobre nóminas y actualizaciones de datos](hr/localizations/noam-usa-payroll-data-updates.md)
...
#### [Rendimiento de canal comercial ](../dev-itpro/analytics/retail-channel-performance-dashboard-power-bi-data.md)
...
#### [Visión general de Reporting Services de documentos](../dev-itpro/analytics/document-reporting-services.md)
...
##### [Crear informes en formatos de Microsoft Office con imágenes insertadas para informes electrónicos (Part 1.md) ](../dev-itpro/analytics/tasks/er-make-reports-ms-office-formats-embedded-images-july-2017.md)
...
#### [Agregar BI contextual a formularios](../dev-itpro/analytics/add-contextual-bi-forms.md)
#### [Informe de medidas agregadas](../dev-itpro/analytics/aggregate-measurements-report.md)
#### [Informe de entidades de datos agregados](../dev-itpro/analytics/aggregate-data-entities-report.md)
#### [Informe de indicadores clave de rendimiento (KPI.md)](../dev-itpro/analytics/key-performance-indicators-report.md)
#### [Integración de Power BI](../dev-itpro/analytics/power-bi-integration.md)
#### [Obtener acceso a contenido de Power BI](../dev-itpro/analytics/power-bi-content-microsoft-partners.md)
#### [Crear paneles de información e informes de Power BI](../dev-itpro/analytics/create-powerbi-report-dashboard.md)
#### [Crear informes de Power BI con datos de Finance and Operations](../dev-itpro/analytics/create-powerbi-report-data.md)
...
#### [Power BI insertado en espacios de trabajo](../dev-itpro/analytics/embed-power-bi-workspaces.md)
...
#### [Agregar Power BI a espacios de trabajo](../dev-itpro/analytics/add-bi-workspaces.md)
...
#### [Exportar entidades a su propia base de datos Azure SQL Database](../dev-itpro/analytics/export-entities-to-your-own-database.md)
#### [Crear informes analíticos mediante Power BI Desktop](../dev-itpro/analytics/author-distribute-power-bi-reports.md)
#### [Publicar aplicaciones analíticas en Power BI](../dev-itpro/analytics/publish-apps-powerbi.md)


## Gestión del inventario
### [Proceso de entrada](../supply-chain/inventory/arrival-overview.md)
#### [Visión general de llegadas](../supply-chain/inventory/arrival-overview.md)
...
#### [Entrega](../supply-chain/inventory/consignment.md)
#### [Configuración de entrega](../supply-chain/inventory/set-up-consignment.md)
...
### [Administración de calidad](../supply-chain/inventory/quality-management-processes.md)
...
### Dimensiones de seguimiento de elementos
...
#### [Visión general de previsión de la demanda](../supply-chain/master-planning/introduction-demand-forecasting.md)
...
##### [Expansión de una versión de lista de materiales](../supply-chain/master-planning/master-plan-explosion-bom-version.md)
...
#### [Colaboración con los proveedores mediante el portal de proveedores](../supply-chain/procurement/collaborate-vendors-vendor-portal.md)
#### [Espacio de trabajo móvil de colaboración de proveedor](../supply-chain/procurement/vendor-collaboration-mobile-workspace.md)
#### [Seguridad de usuario del portal de proveedores](../supply-chain/procurement/configure-security-vendor-portal-users.md)
...
##### [Funcionalidad del diseñador de lista de materiales](../supply-chain/production-control/bom-designer-functionality.md)
...
##### [Transferir materiales con trabajos kanban (febrero de 2016 únicamente)](../supply-chain/production-control/tasks/transfer-materials-kanban-jobs.md)
...
##### [Gestionar la unidad de medida (Guías de tareas)](../supply-chain/pim/tasks/manage-unit-measure.md)
...
#### Preparar el producto para los pedidos planificados 
...
#### Estimar costes para producto
##### [Cálculos de L. MAT](../supply-chain/cost-management/bom-calculations.md)
### Modelos de configuración del producto
#### [Crear un modelo de configuración de productos](../supply-chain/pim/build-product-configuration-model.md)
...
##### [Configuración basada en dimensiones](../supply-chain/pim/dimension-based-product-configuration.md)
##### [Creación de un producto maestro basado en dimensiones (Guía de tareas)](../supply-chain/pim/tasks/create-dimension-based-product-master.md)
...
#### Crear configuración basada en restricciones
...
##### [Configurar un modelo de configuración](../supply-chain/pim/set-up-maintain-product-configuration-model.md)
...
# [Desarrollo y administración](../dev-itpro/toc.md)
