...
description: Este artículo describe cómo configurar y administrar cuentas de usuario que permitan a los trabajadores iniciar sesión y usar la aplicación de almacén.
author: Mirzaab
ms.date: 09/15/2021
ms.topic: article
ms.search.form: ''
