---
title: Compatibilidad móvil con códigos de barras
description: Este artículo describe cómo deberá gestionarse la aplicación de escaneado móvil de almacén en dispositivos compatibles con Android.
author: Mirzaab
ms.date: 05/26/2017
ms.topic: article
ms.prod: ''
...
La aplicación móvil Warehouse Management se ha probado con una selección de dispositivos con Android para la detección de código de barras. Estas pruebas sólo incluyen una muestra de los dispositivos disponibles en el mercado.
