...
### <a name="turn-flexible-license-plate-reservation-on-or-off"></a>Activar o desactivar la reserva de matrícula de entidad de almacén flexible

Antes de que pueda usar la reserva de matrícula de entidad de almacén flexible, se deben activar dos características para su sistema. Los administradores pueden usar la configuración de [gestión de funciones](../../fin-ops-core/fin-ops/get-started/feature-management/feature-management-overview.md) para verificar el estado de estas características y activarlas si es necesario. Debe activar las funciones en el siguiente orden:

1. *Reserva flexible de la dimensión de nivel de almacén*<br>(A partir de la versión 10.0.29 de Supply Chain Management, esta característica es obligatoria y no se puede desactivar).
1. *Reserva flexible de matrícula de entidad de almacén comprometida de pedido*<br>(A partir de la versión 10.0.29 de Supply Chain Management, esta característica es obligatoria y no se puede desactivar).
