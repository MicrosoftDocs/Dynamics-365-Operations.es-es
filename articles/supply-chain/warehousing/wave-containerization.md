...
description: Este artículo describe cómo automatizar la creación de contenedores de cargas. La creación de contenedores automatizada crea contenedores y el trabajo de picking para los envíos cuando se procesa una oleada.
author: Mirzaab
ms.date: 03/08/2021
ms.topic: article
ms.prod: ''
...
Este artículo describe cómo automatizar la creación de contenedores de cargas. La creación de contenedores automatizada crea contenedores y el trabajo de picking para los envíos cuando se procesa una oleada.
