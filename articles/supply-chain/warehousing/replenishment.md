---
title: Información general de reabastecimiento
description: En este artículo se describen las estrategias de reabastecimiento que están disponibles para los almacenes que utilizan la funcionalidad disponible en Gestión de almacenes.
author: Mirzaab
ms.date: 02/19/2020
ms.topic: overview
ms.prod: ''
...
En este artículo se describen las estrategias de reabastecimiento que están disponibles para los almacenes que utilizan la funcionalidad disponible en Gestión de almacenes. La información de este artículo no se aplica a la solución de almacenamiento que está disponible en Gestión de inventarios.
