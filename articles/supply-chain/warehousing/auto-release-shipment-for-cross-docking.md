...
|---|---|
| Elemento | El artículo se debe habilitar para procesos de administración de almacenes (WMS).<p>**Nota:** los artículos habilitados para peso capturado no se pueden incluir en los procesos de tránsito directo.</p> |
| Almacén | El almacén se debe habilitar para procesos de administración de almacenes (WMS). |
