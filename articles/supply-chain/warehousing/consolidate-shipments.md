...
---
# <a name="consolidate-shipments-by-using-shipment-consolidation-policies"></a>Consolidar envíos utilizando directivas de consolidación de envíos

[!include [banner](../includes/banner.md)]

Los siguientes escenarios le llevarán por el proceso de consolidación de envíos que utiliza directivas de consolidación de envíos durante el deespacho automátizado y manual al almacén:
