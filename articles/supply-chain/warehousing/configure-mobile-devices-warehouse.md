...
[Configurar un elemento de menú del dispositivo móvil para completar trabajo del tipo pedido de compra (guía de tareas)](tasks/set-up-mobile-device-menu.md)
