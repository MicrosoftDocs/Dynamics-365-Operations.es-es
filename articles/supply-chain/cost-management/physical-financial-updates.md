...
description: En este artículo se proporciona un resumen de qué tipos de transacciones aumentan y reducen las cantidades de inventario.
author: JennySong-SH
ms.date: 06/20/2017
ms.topic: article
ms.prod: ''
...
ms.locfileid: "8895855"
---
# <a name="physical-and-financial-updates"></a>Actualizaciones físicas y financieras

[!include [banner](../includes/banner.md)]

En este artículo se proporciona un resumen de qué tipos de transacciones aumentan y reducen las cantidades de inventario. 
