...
---
# <a name="view-cost-object-balance"></a>Ver saldo de objeto de coste
...
3. Use un filtro rápido para filtrar el campo Número de artículo según el valor "m0004".
4. En el panel de acciones, haga clic en Gestionar costes.
5. Haga clic en Objetos de coste.
6. Haga clic en Cantidad física.
7. Haga clic en Presentación de dimensiones.
