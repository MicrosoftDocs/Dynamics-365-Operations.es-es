...
description: En este artículo se describen tareas para realizar antes de ejecutar una conversión de coste estándar.
author: JennySong-SH
ms.date: 06/20/2017
ms.topic: article
ms.prod: ''
...
ms.locfileid: "8887569"
---
# <a name="prerequisites-for-a-standard-cost-conversion"></a>Requisitos previos para la conversión de costes estándar

[!include [banner](../includes/banner.md)]

En este artículo se describen tareas para realizar antes de ejecutar una conversión de coste estándar. 
