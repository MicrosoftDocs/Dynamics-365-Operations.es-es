...
description: Este artículo describe la funcionalidad que permite ejecutar un informe de antigüedad de inventario y generar resultados como formulario y gráfico.
author: JennySong-SH
ms.date: 11/11/2019
ms.topic: article
ms.prod: ''
