...
En la siguiente ilustración, (a) es el L.MAT para el producto H y las parte F y G y (b) es la hoja de ruta de los productos H y la parte F.

![Ejemplo de estructura de lista de materiales en dos niveles.](media/product-H-part-F.png)
...
![La lista de materiales de ingeniería para el producto H.](media/product-H-part-B.png)
...
![El tipo de línea fantasma que se utiliza en estructuras de listas de materiales de varios niveles.](media/product-G-route-sheet-G.png)
...
![Ejemplo de una red de rutas que se utiliza en una lista de materiales de varios niveles.](media/product-G-part-F.png)
...
![La lista de materiales para el producto G y la parte F, y la hoja de ruta para el producto G y la parte F.](media/product-G-part-F-with-route-sheet.png)
