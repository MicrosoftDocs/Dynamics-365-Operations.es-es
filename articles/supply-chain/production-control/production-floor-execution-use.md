...
description: Este artículo describe cómo se utiliza la interfaz de ejecución de la planta de producción desde el punto de vista de un trabajador.
...
Las secciones restantes de este artículo describen cómo interactúan los trabajadores con la interfaz.
