...
## <a name="work-with-scheduled-work-orders-using-a-gantt-chart"></a>Trabajar con órdenes de trabajo programadas usando un diagrama de Gantt

El **Diagrama de Gantt de órdenes de trabajo programadas** proporciona una interfaz gráfica donde puede ver y reprogramar sus órdenes de trabajo.

Para ver y trabajar con el diagrama de Gantt:

1. Vaya a **Gestión de activos > Órdenes de trabajo > Diagrama de Gantt de órdenes de trabajo programadas**.

1. Utilice las listas desplegables y los campos en la sección **Configuraciones** para configurar qué ubicación funcional, intervalo de tiempo y escala de tiempo se mostrarán en el diagrama de Gantt.
