...
- Un nuevo tipo de intervalo del plan de mantenimiento que se denomina *Repetido en valor agregado (solo contador)*. Este tipo activa el mantenimiento cada vez que un contador agregado alcanza un múltiplo de un valor específico. Por ejemplo, el mantenimiento se puede activar cada 10 000 horas. Para obtener más información, consulte la sección anterior de este tema [Descripción general de tipos de intervalo](#interval-types).
