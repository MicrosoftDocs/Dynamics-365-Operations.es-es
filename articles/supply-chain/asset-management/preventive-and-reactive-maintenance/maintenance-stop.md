...
description: Este artículo explica cómo se utiliza el tiempo de inactividad por mantenimiento para obtener una visión general de la capacidad necesaria para llevar a cabo trabajos de mantenimiento en determinados activos durante un período concreto.
...
1. Haga clic en **Administración de activos** > **Actividades del tiempo de inactividad por mantenimiento** > **Todas las actividades del tiempo de inactividad por mantenimiento** o **Actividades del tiempo de inactividad por mantenimiento activas**.
