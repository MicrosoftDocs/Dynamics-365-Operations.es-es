...
## <a name="create-a-maintenance-downtime-registration"></a>Crear un registro del tiempo de inactividad por mantenimiento
...
6. Haga clic en **Guardar** cuando se hayan agregado todos los activos.
