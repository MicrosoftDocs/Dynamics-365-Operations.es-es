...
description: Este artículo describe cómo configurar grupos de administración de devoluciones. Los grupos de administración de devoluciones se pueden utilizar durante los cálculos de descuentos y se pueden adjuntar a un registro maestro.
author: sherry-zheng
ms.date: 02/19/2021
ms.topic: article
ms.prod: ''
