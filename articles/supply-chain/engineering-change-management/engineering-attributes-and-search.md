...
Si su sistema aún no incluye las funciones descritas en esta sección, vaya a [Gestión de funciones](../../fin-ops-core/fin-ops/get-started/feature-management/feature-management-overview.md) y active la característica *Herencia de atributos mejorada para la gestión de cambios de ingeniería*.
