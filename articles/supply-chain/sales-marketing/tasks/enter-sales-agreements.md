...
description: Este artículo explica cómo crear un acuerdo de venta que compromete uno de los clientes a comprar un producto en una cantidad acordada durante un período de tiempo a cambio de descuentos especiales.
author: Henrikan
ms.date: 08/08/2019
...
ms.locfileid: "8897498"
---
# <a name="enter-sales-agreements"></a>Especificar los acuerdos de ventas

[!include [banner](../../includes/banner.md)]

Este artículo explica cómo crear un acuerdo de venta que compromete uno de los clientes a comprar un producto en una cantidad acordada durante un período de tiempo a cambio de descuentos especiales. Puede ejecutar este procedimiento con los datos de la empresa de demostración USMF o utilizar sus propios datos.
