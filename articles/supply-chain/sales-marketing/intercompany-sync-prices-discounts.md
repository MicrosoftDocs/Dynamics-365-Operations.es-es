...
description: Este tema explica la sincronización de precios y descuentos para pedidos de venta y pedidos de compra de empresas vinculadas
author: Henrikan
ms.date: 09/01/2021
ms.topic: article
