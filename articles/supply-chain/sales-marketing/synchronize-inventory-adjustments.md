...
---
# <a name="synchronize-inventory-adjustments-from-field-service-to-supply-chain-management"></a>Sincronizar ajustes de inventario de Field Service a Supply Chain Management
