...
description: Este artículo proporciona una visión general de la integración con Microsoft Dynamics 365 Field Service.
author: Henrikan
ms.date: 07/25/2019
ms.topic: overview
ms.prod: ''
...
- Dynamics 365 Finance and Operations versión 8.1.2 (diciembre de 2018) fue emitido en diciembre de 2018 y tiene un número de compilación de la aplicación 8.1.195 con la actualización de la plataforma 22 (7.0.5095). 
