...
- Solución de integración de Field Service para Dynamics 365, versión 1.0.0.0 o una versión posterior. La solución está disponible para descarga desde AppSource. **(LIBERACIÓN PENDIENTE)**
