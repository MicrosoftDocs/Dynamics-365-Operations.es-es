...
description: Este artículo proporciona información sobre cómo ver, administrar y aprobar pedidos planificados en Optimización de planificación.
author: t-benebo
ms.date: 04/07/2021
ms.topic: article
ms.prod: ''
...
ms.locfileid: "8887439"
---
# <a name="view-manage-and-approve-planned-orders"></a>Ver, administrar y aprobar pedidos planificados

[!include [banner](../../includes/banner.md)]

Este artículo proporciona información sobre cómo ver, administrar y aprobar pedidos planificados en Optimización de planificación.
