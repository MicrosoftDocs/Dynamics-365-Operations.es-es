...
La siguiente ilustración presenta una matriz que resume qué calendarios se aplican cuando se calculan los márgenes de seguridad. Las siguientes abreviaturas y colores se utilizan para indicar dónde se especifica cada tipo de calendario:
