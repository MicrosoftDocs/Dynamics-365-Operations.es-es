...
- La característica *Selección de modelo de previsión en Detalles de previsión de la demanda* agrega configuración en la página **Detalles de previsión de la demanda** que le permite seleccionar los modelos de previsión que se incluirán. A partir de la versión 10.0.21 de Supply Chain Management, esta función está activada de forma predeterminada. A partir de la versión 10.0.25 de Supply Chain Management, esta característica es obligatoria y no se puede desactivar. Si está ejecutando una versión anterior a la 10.0.25, los administradores pueden activar o desactivar esta funcionalidad buscando la característica *Selección de modelo de previsión según los detalles de la previsión de la demanda* en el espacio de trabajo [Administración de características](../../fin-ops-core/fin-ops/get-started/feature-management/feature-management-overview.md).
