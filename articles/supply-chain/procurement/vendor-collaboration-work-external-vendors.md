...
Esta sección describe las interacciones entre clientes y proveedores durante el proceso de solicitud de presupuesto. También explica cómo se comunica la información a los proveedores. Para una visión general básica del soporte para el proceso de solicitud de presupuesto, consulte [Solicitudes las presupuesto](request-quotations.md).
