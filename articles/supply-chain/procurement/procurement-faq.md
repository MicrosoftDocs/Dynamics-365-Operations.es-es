...
description: Este artículo proporciona respuestas a las preguntas más frecuentes (FAQ) sobre la funcionalidad de compras de Supply Chain Management
...
ms.locfileid: "8869586"
---
# <a name="procurement-faq"></a>Preguntas frecuentes sobre adquisición

[!include [banner](../includes/banner.md)]

Este artículo proporciona respuestas a las preguntas más frecuentes (FAQ) sobre la funcionalidad de compras de Supply Chain Management.
