...
Para obtener información sobre Dynamics 365 Finance, vaya a la página [Página principal de Administración financiera](../finance/index.md).

## <a name="videos"></a>Vídeos

Estos vídeos breves le ayudan a descubrir las nuevas características incluidas en la versión 8.0 de Microsoft Dynamics 365 for Finance and Operations (abril de 2018).

- [Sincronizar pedidos de trabajo entre Field Service y Finance and Operations](https://youtu.be/hAB4TDVMjxU)

Estos vídeos breves le ayudan a descubrir las nuevas características incluidas en Microsoft Dynamics 365 for Finance and Operations Enterprise Edition 7.3 (diciembre de 2017).
...
Estos vídeos breves le ayudan a descubrir las nuevas características incluidas en Microsoft Dynamics 365 for Finance and Operations Enterprise Edition (julio de 2017).
