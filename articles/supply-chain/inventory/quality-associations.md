...
description: Este artículo describe cómo puede usar asociaciones de calidad en Microsoft Dynamics 365 Supply Chain Management para generar automáticamente pedidos de calidad relacionados con sus procesos de venta, compra y producción.
author: yufeihuang
ms.date: 03/23/2021
ms.topic: article
ms.prod: ''
...
Este artículo describe cómo puede usar asociaciones de calidad en Microsoft Dynamics 365 Supply Chain Management para generar automáticamente pedidos de calidad relacionados con sus procesos de venta, compra y producción.
