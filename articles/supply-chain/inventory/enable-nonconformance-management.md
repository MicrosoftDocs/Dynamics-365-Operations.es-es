...
[Creación y procesamiento de una disconformidad (guías de tareas)](/dynamics365/unified-operations/supply-chain/inventory/tasks/create-process-non-conformance)

[Procesos de gestión de calidad](quality-management-processes.md)

[Configurar requisitos previos para la gestión de no conformidades (guía de tareas)](/dynamics365/unified-operations/supply-chain/inventory/tasks/set-up-prerequisites-nonconformance-management)
