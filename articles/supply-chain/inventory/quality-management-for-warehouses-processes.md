...
Ahora se crea una orden de compra para una cantidad de 10 del artículo A0001 para el proveedor 104. Luego, se registra una línea de pedido de compra que tiene una cantidad de 10 como recibida en una matrícula usando la aplicación móvil de gestión de almacenes. Este es el resultado:
...
1. Vaya a **Entrante \> Recibir compra** e ingrese los siguientes valores:
    ...
    - **No PO**: número del pedido de compra que acaba de crear.
    - **Cant.**: *5*
    - **Unidad**: *u*
...
1. Cerrar sesión en la aplicación móvil de gestión de almacenes.
