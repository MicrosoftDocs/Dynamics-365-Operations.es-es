---
title: Información general del proceso de salida
description: En este artículo se proporciona información general del proceso de salida en la gestión del inventario.
author: yufeihuang
ms.date: 07/25/2019
ms.topic: overview
ms.prod: ''
...
ms.locfileid: "8852487"
---
# <a name="outbound-process-overview"></a>Información general del proceso de salida

[!include [banner](../includes/banner.md)]

En este artículo se proporciona información general del proceso de salida en la gestión del inventario.
