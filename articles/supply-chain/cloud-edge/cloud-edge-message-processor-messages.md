...
description: Este artículo proporciona información sobre la función de mensajes del procesador de mensajes para las cargas de trabajo de la unidad de escalado.
author: perlynne
ms.date: 04/22/2021
ms.topic: article
ms.prod: ''
