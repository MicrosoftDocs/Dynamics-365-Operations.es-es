...
description: Este artículo proporciona información sobre cómo probar las unidades de escalado en la nube y en el perímetro para cargas de trabajo de gestión de almacenes y fabricación.
author: perlynne
ms.date: 05/02/2022
ms.topic: article
