...
description: Este artículo proporciona información sobre el procesamiento y el diario de ajuste de inventario del almacén cuando utiliza unidades de escalado.
author: perlynne
ms.date: 04/22/2021
ms.topic: article
ms.prod: ''
