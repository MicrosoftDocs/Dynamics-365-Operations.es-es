...
description: Este artículo explica cómo puede utilizar la página de seguimiento de entrada para realizar un seguimiento del progreso de sus viajes y viajes de contenedores de envío.
author: Weijiesa
ms.date: 01/13/2021
ms.topic: article
ms.prod: ''
