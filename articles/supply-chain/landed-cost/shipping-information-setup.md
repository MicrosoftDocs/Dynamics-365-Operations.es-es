...
description: Este artículo describe cómo configurar la información de envío para el módulo de costo de entrega.
author: Weijiesa
ms.date: 12/04/2020
ms.topic: article
ms.prod: ''
...
Este artículo describe cómo configurar la información de envío para el módulo de **costo de entrega**.
