...
description: Este artículo proporciona información que ayuda a configurar los detalles de las políticas de transacciones excesivas / insuficientes, de modo que el sistema pueda determinar cómo gestionar el procesamiento excesivo y el procesamiento insuficiente de mercancías en el momento de la recepción.
author: Weijiesa
ms.date: 01/13/2021
ms.topic: article
ms.prod: ''
