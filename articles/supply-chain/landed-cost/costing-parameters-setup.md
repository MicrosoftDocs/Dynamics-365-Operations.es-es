...
description: Cuando configura el módulo de costo de aterrizaje, puede definir varios conjuntos de valores comunes que estarán disponibles cuando seleccione tipos específicos de valores de parámetros de costos en otras partes de la aplicación. Este artículo explica cómo establecer estos conjuntos de valores.
author: Weijiesa
ms.date: 12/07/2020
ms.topic: article
ms.prod: ''
...
| Divisor volumétrico | Introduzca el valor de divisor volumétrico que se aplica a la fila. El volumen de cada paquete se dividirá por el valor que introduzca aquí para determinar el peso volumétrico de ese paquete. |

> [!NOTE]
> El sistema utilizará el valor máximo entre **peso actual** y **peso volumétrico**.
