---
title: Versión preliminar de Dynamics 365 Supply Chain Management 10.0.25 (abril de 2022)
description: En este tema se describen las características nuevas o modificadas en Microsoft Dynamics 365 Supply Chain Management 10.0.25.
author: kamaybac
ms.date: 02/01/2022
ms.topic: article
...
ms.locfileid: "8087329"
---
# <a name="preview-of-dynamics-365-supply-chain-management-10025-april-2022"></a>Versión preliminar de Dynamics 365 Supply Chain Management 10.0.25 (abril de 2022)

[!include [banner](../includes/banner.md)]
[!include [preview banner](../includes/preview-banner.md)]

En este tema se enumeran las características nuevas o modificadas en la versión preliminar de Microsoft Dynamics 365 Supply Chain Management de la versión 10.0.25. Esta versión tiene el número de compilación 10.0.1149 y está disponible de la siguiente manera:
...
|---|---|---|---|
| Inventario&nbsp;y&nbsp;logística | Mejoras para materiales peligrosos | Estas mejoras se basan en la funcionalidad de materiales peligrosos existente para ayudar mejor a las empresas a cumplir con las regulaciones locales al transportar materiales peligrosos en diferentes geografías. <!-- KFM: Update to 2022w1 link when published -->| Administración de características:<br>*Mejoras para materiales peligrosos* |
| Inventario&nbsp;y&nbsp;logística | Trabajo de embalaje para estaciones de embalaje | Esta característica mejora en gran medida la flexibilidad y agilidad de sus operaciones de empaque y envío. Durante el proceso de empaque, los trabajadores del almacén ahora pueden empacar y enviar paquetes individuales relacionados con el mismo envío y carga. Las líneas de pedido que forman parte del mismo envío no necesariamente deben enviarse juntas si algunos artículos están listos para el envío de inmediato. Un solo pedido se puede empacar y enviar en varios paquetes en diferentes tiempos de envío, lo que reduce los tiempos de espera y agrega agilidad.<!-- KFM: Update to 2022w1 link when published --> | Administración de características:<br>*Trabajo de embalaje para estaciones de embalaje* |
| Inventario&nbsp;y&nbsp;logística | [Escanear códigos de barras en el almacén utilizando los estándares de formato GS1](/dynamics365-release-plan/2021wave2/finance-operations/dynamics365-supply-chain-management/scan-barcodes-warehouse-using-gs1-format-standards) <!-- KFM: Update to 2022w1 link when published --> | [Códigos de barras GS1 y códigos QR](../warehousing/gs1-barcodes.md) | Administración de características:<br>*Digitalizar códigos de barras de GS1* |
| Fabricación | [Consumo de material y reservas en la interfaz de ejecución de planta de producción](/dynamics365-release-plan/2022wave1/finance-operations/dynamics365-supply-chain-management/material-consumption-reservations-production-floor-execution-interface) | [Cómo los trabajadores usan la interfaz de ejecución de la planta de producción](../production-control/production-floor-execution-use.md) | Administración de características:<br>*(Vista previa) Registrar el consumo de material en la interfaz de ejecución de planta de producción (con WMS habilitado)* |
...
| Adquisición y abastecimiento | Deshabilitar el botón Restablecer de la distribución de la solicitud de compra | Esta función desactiva el botón **Reiniciar** en la página **Distribución contable** para las solicitudes de compra que están en revisión. |
...
| Gestión de almacenes | Deshabilitar las recepciones esperadas de pedidos de calidad que muestrean el inventario bloqueado | Esta función evita que el sistema cree transacciones de recepción esperadas para pedidos de calidad que muestrean inventario con un estado de bloqueo. Debido a que el inventario bloqueado no está disponible, esta función elimina los recibos esperados. Esto ayuda a garantizar que el inventario no finalice con varios estados de bloqueo, lo que puede provocar problemas de integridad de datos. |
...
| --- | --- | --- |
| Administración de activos | Aplicar reglas para agrupar órdenes de trabajo mientras se ejecuta un plan de mantenimiento | Disponibilidad general |
| Administración de activos | Mejoras de mantenimiento basadas en contador | Disponibilidad general |
| Gestión de costes | Nivel de cálculo de costes | Disponibilidad general |
...
| Gestión de costes | Detalles del progreso del cierre de inventario | Disponibilidad general |
| Gestión de costes | Opciones de dimensiones financieras predeterminadas para la revalorización de coste estándar de inventario | Disponibilidad general |
| Gestión de costes | Limpieza de datos del informe del valor del inventario | Activado de forma predeterminada |
| Gestión de costes | Almacenamiento de informes de valor de inventario | Activado de forma predeterminada |
| Gestión de costes | Mostrar registro de cierre de inventario en cuadrícula | Activado de forma predeterminada |
| Administración de cambios de ingeniería | Habilitar la administración de cambios en productos existentes | Activado de forma predeterminada |
| Administración de cambios de ingeniería | Administración de cambios de ingeniería | Activado de forma predeterminada |
| Administración de cambios de ingeniería | Notificaciones de ingeniería para producción | Activado de forma predeterminada |
| Administración de cambios de ingeniería | Herencia de atributos mejorada para la administración de cambios de ingeniería | Activado de forma predeterminada |
| Administración de cambios de ingeniería | Administrar cambios en fórmulas y sus componentes | Activado de forma predeterminada |
| Administración de cambios de ingeniería | Comprobaciones de preparación de producto | Activado de forma predeterminada |
| Administración de cambios de ingeniería | Generación de variantes de productos de ingeniería | Activado de forma predeterminada |
| Gestión de inventario y almacenes | Navegación hasta la versión de L.M. desde las líneas de L.M. | Obligatoria |
| Planificación maestra | Consolidación y puesta en firme por lotes de pedidos de lote masivos y empaquetados planificados | Disponibilidad general |
...
| Planificación maestra | Selección de modelo de previsión según los detalles de la previsión de la demanda | Obligatoria |
| Planificación maestra | Visualización del progreso de la planificación maestra | Obligatoria |
| Planificación maestra | Puesta en firme en paralelo de pedidos planificados | Obligatoria |
| Planificación maestra | Puesta en firme de pedido planificado con filtrado | Activado de forma predeterminada |
| Planificación maestra | Vistas guardadas para pedidos planificados | Activado de forma predeterminada |
...
| Adquisición y abastecimiento | Habilitar el restablecimiento de los flujos de trabajo relacionados con la compra | Disponibilidad general |
...
| Adquisición y abastecimiento | Permitir que los proveedores soliciten categorías de compras mediante la colaboración de proveedor | Activado de forma predeterminada |
...
| Adquisición y abastecimiento | Parte responsable del acuerdo de compra | Activado de forma predeterminada |
| Adquisición y abastecimiento | Vistas guardadas para pedidos de compra | Activado de forma predeterminada |
| Gestión de información de productos | Validación estricta en las cantidades de pedido predeterminadas | Obligatoria |
...
| Gestión de información de productos | Mejoras de la página de sugerencias de variantes | Activado de forma predeterminada |
...
| Control de producción | Habilitar la generación automática de matrícula de entidad de almacén al informar como terminado en el dispositivo de tarjetas de trabajo | Obligatoria |
...
| Control de producción | Función para bloquear un dispositivo de tarjeta de trabajo y un terminal de tarjetas de trabajo para que se puedan desinfectar | Obligatoria |
| Control de producción | Mejoras en los cuadros de diálogo Aprobar y Transferir trabajos | Obligatoria |
| Control de producción | Matrícula de entidad de almacén para notificaciones agregada al dispositivo de tarjetas de trabajo | Obligatoria |
| Control de producción | Imprimir etiqueta desde dispositivo de tarjeta de trabajo | Obligatoria |
| Control de producción | Ejecución de la planta de producción | Obligatoria |
| Control de producción | Funcionalidad de administración de activos para la interfaz de ejecución de la planta de producción | Activado de forma predeterminada |
| Control de producción | Búsqueda de trabajos para la interfaz de ejecución de la planta de producción | Activado de forma predeterminada |
| Control de producción | Pasar por alto la reserva de producción predeterminada | Activado de forma predeterminada |
| Control de producción | Mostrar los números de serie completa, lote y matrícula de entidad de almacén en la interfaz de ejecución de planta de producción | Activado de forma predeterminada |
| Ventas y marketing | Mejora del rendimiento de los detalles del pedido de ventas | Disponibilidad general |
...
| Ventas y marketing | Directiva de eliminación de línea de pedido de ventas para línea de pedido de compra | Obligatoria |
| Ventas y marketing | Directiva de exportación de datos de referencia del presupuesto de ventas | Obligatoria |
| Ventas y marketing | Optimización de exportación de entidad de datos de persona de contacto | Activado de forma predeterminada |
...
| Ventas y marketing | Mejorar el rendimiento de los 100 mejores clientes | Activado de forma predeterminada |
| Ventas y marketing | Recalcular el saldo estimado del cliente | Activado de forma predeterminada |
| Ventas y marketing | Registro de línea de pedido de devolución de ventas con precisión decimal con y sin peso capturado | Activado de forma predeterminada |
| Ventas y marketing | Vistas guardadas de ventas y marketing | Activado de forma predeterminada |
| Ventas y marketing | Confirmación del pedido de ventas con un solo clic | Activado de forma predeterminada |
| Gestión de almacenes | Plantillas de tránsito directo con directivas de ubicación | Disponibilidad general |
| Gestión de almacenes | Deshabilitar las recepciones esperadas de pedidos de calidad que muestrean el inventario bloqueado | Disponibilidad general |
| Gestión de almacenes | Historial de recepción de matrículas de entidad de almacén | Disponibilidad general |
| Gestión de almacenes | Redondear cantidades por debajo a la unidad de ventas más cercana durante la liberación al almacén | Disponibilidad general |
...
| Gestión de almacenes | Use una API más rápida para el cierre o la reapertura de contenedores en la estación de embalaje | Disponibilidad general |
| Gestión de almacenes | Validar plantillas seleccionadas para los trabajos de reabastecimiento | Disponibilidad general |
...
| Gestión de almacenes | Cambiar el estado de inventario de artículos controlados por dimensiones de seguimiento | Obligatoria |
| Gestión de almacenes | Cambiar grupo de trabajo en trabajo | Obligatoria |
| Gestión de almacenes | Posición completa del clúster | Obligatoria |
| Gestión de almacenes | Característica de ubicación de clúster | Obligatoria |
| Gestión de almacenes | Confirmar y transferir | Obligatoria |
| Gestión de almacenes | Confirmar envíos salientes de trabajos por lotes | Obligatoria |
| Gestión de almacenes | Controlar si se mostrará una página de resumen de recepción en los dispositivos móviles | Obligatoria |
| Gestión de almacenes | Procesamiento diferido de la operación de movimiento de inventario manual | Obligatoria |
...
| Gestión de almacenes | Diseños de etiquetas de matrícula de entidad de almacén mejorados | Obligatoria |
| Gestión de almacenes | Evaluar todas las acciones para directivas de ubicación de SKU múltiples | Obligatoria |
...
| Gestión de almacenes | Posición de matrícula de entidad de almacén de ubicación | Obligatoria |
| Gestión de almacenes | Combinación de dimensiones de producto de ubicación | Obligatoria |
...
| Gestión de almacenes | Impedir que las matrículas de entidad de almacén enviadas se usen en almacenes que no sean el almacén de destino | Obligatoria |
| Gestión de almacenes | Solicitar la resolución de nombres de "Ubicación / N.º licencia" ambiguos | Obligatoria |
| Gestión de almacenes | Control de calidad | Obligatoria |
| Gestión de almacenes | Configuración de usuario, iconos y títulos de pasos mejorados para la nueva aplicación de almacén | Obligatoria |
| Gestión de almacenes | Zona de ubicación adicional | Activado de forma predeterminada |
| Gestión de almacenes | Crear y procesar pedidos de transferencia desde la aplicación de almacén | Activado de forma predeterminada |
...
| Gestión de almacenes | Uso de la ubicación de consolidación de artículos | Activado de forma predeterminada |
| Gestión de almacenes | Tiempo de ejecución máximo para el trabajo de limpieza de entradas disponibles de gestión de almacenes | Activado de forma predeterminada |
| Gestión de almacenes | Visualización de carga de trabajo de salida | Activado de forma predeterminada |
| Gestión de almacenes | Procesar eventos de la aplicación de almacén | Activado de forma predeterminada |
| Gestión de almacenes | Vista guardada para el área de trabajo de planificación de la carga | Activado de forma predeterminada |
| Gestión de almacenes | Vista guardada para la página de detalles del trabajo | Activado de forma predeterminada |
| Gestión de almacenes | Vista guardada para procesamiento de oleadas | Activado de forma predeterminada |
| Gestión de almacenes | Vistas guardadas para procesamiento de carga | Activado de forma predeterminada |
| Gestión de almacenes | Vistas guardadas para procesamiento de envíos | Activado de forma predeterminada |
| Gestión de almacenes | Detalles del trabajo por lotes de oleada | Activado de forma predeterminada |
| Gestión de almacenes | Notificaciones de ejecución de lanzamientos | Activado de forma predeterminada |
