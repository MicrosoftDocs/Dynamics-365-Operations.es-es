...
En este tema se enumeran las características nuevas o modificadas en la versión preliminar de Microsoft Dynamics 365 Supply Chain Management de la versión 10.0.23. Esta versión tiene el número de compilación 10.0.1037 y está disponible de la siguiente manera:
...
| Ventas y marketing | Eliminar historial de actualización de pedido de ventas | Esta característica le permite eliminar registros históricos temporales relacionados con actualizaciones de pedidos de venta. Agrega un nuevo botón llamado **Eliminar historial de actualización de ventas** al panel de acciones de las páginas de detalle y lista para pedidos de ventas. |
