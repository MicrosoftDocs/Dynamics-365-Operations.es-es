---
title: Novedades y cambios en Dynamics 365 Supply Chain Management 10.0.28 (agosto de 2022)
...
En este artículo se enumeran las características nuevas o modificadas en Microsoft Dynamics 365 Supply Chain Management versión 10.0.28. Esta versión tiene el número de compilación 10.0.1264 y está disponible con la siguiente programación:
...
| Planificada | [Soporte de optimización de planificación para vida útil](/dynamics365-release-plan/2022wave1/finance-operations/dynamics365-supply-chain-management/planning-optimization-support-shelf-life) | [Planificación maestra para productos con vida útil limitada](../master-planning/planning-optimization/shelf-life.md) | Habilitado por defecto |
...
Microsoft Dynamics 365 Supply Chain Management 10.0.28 incluye Platform updates. Para obtener más información, consulte [Platform updates para la versión 10.0.28 de aplicaciones de finanzas y operaciones (agosto de 2022)](../../fin-ops-core/dev-itpro/get-started/whats-new-platform-updates-10-0-28.md).
