...
---
# <a name="learning-catalog-for-dynamics-365-supply-chain-management"></a>Catálogo de formación para Dynamics 365 Supply Chain Management

Busque la formación en línea adecuada, talleres presenciales y eventos para su rol como usuario de la aplicación Dynamics 365 Supply Chain.
...
<!-- ![Universal Windows Platform (UWP)](images/platform-uwp.png)  -->  
    ...
    [Gestión de la cadena de suministro](learning-catalog-business-user.md#supply-chain-management)

    [Fabricación](learning-catalog-business-user.md#manufacturing)
...
:::row:::
    ...
    [Fabricación](learning-catalog-functional-consultant.md#manufacturing)
