...
---
# <a name="whats-new-or-changed-in-dynamics-365-supply-chain-management-1007-january-2020"></a>Novedades y cambios en Dynamics 365 Supply Chain Management 10.0.7 (enero de 2020)

[!include [banner](../includes/banner.md)]


En este tema se describen las características nuevas o modificadas en Microsoft Dynamics 365 Supply Chain Management 10.0.7. Esta versión tiene el número de compilación 10.0.283 y está disponible de la siguiente manera:

- Versión preliminar en octubre de 2019.
- Disponibilidad general (actualización automática) en noviembre de 2019.
- Actualización automática en enero de 2020. 

Para obtener más información sobre la versión 10.0.7, consulte [Recursos adicionales](whats-new-scm-10-0-7.md#additional-resources).
...
Microsoft Dynamics 365 Supply Chain Management 10.0.7 incluye la Platform update 31. Para obtener más información sobre la Platform update 31, consulte [Novedades y cambios en la Platform update 31](../../fin-ops-core/dev-itpro/get-started/whats-new-platform-update-31.md).
...
Consulte [Dynamics 365: plan de la segunda oleada de lanzamiento de versiones de 2019](https://docs.microsoft.com/dynamics365-release-plan/2019wave2/). Hemos recogido absolutamente todos los detalles en un solo documento que puede usar para la planificación.
