...
description: Este artículo describe los libros de contabilidad de inventario global, que se definen mediante una combinación de una moneda, un calendario, una convención y una asociación con una entidad jurídica.
author: JennySong-SH
ms.date: 06/18/2021
ms.topic: article
