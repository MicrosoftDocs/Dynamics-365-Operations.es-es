...
- Recopilar y procesar información de un origen de datos como elementos de mensaje. El origen de los datos es una tabla de Finance and Operations.
...
- Recibir una respuesta de un servicio Web, interpretar la respuesta, y actualizar los datos Finance and Operations según sea adecuado.
