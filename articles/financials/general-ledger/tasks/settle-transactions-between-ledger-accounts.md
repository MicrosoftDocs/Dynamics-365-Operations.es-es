...
1. Cierre la página.
2. Vaya a Contabilidad general > Consultas e informes > Saldo de comprobación.
3. Haga clic en Parámetros para abrir el cuadro de diálogo desplegable.
4. Haga clic en Actualizar.
5. En la lista, encuentre la cuenta que tiene la transacción liquidada.
6. Haga clic en Todas las transacciones.
7. Use un filtro para buscar fácilmente la transacción en la lista.
8. Haga clic en Liquidaciones contables.
