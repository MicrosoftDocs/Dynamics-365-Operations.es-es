...
ms.locfileid: "1550270"
---
# <a name="mexico"></a>México 

[!include [banner](../includes/banner.md)]

Este tema incluye información y vínculos a recursos que pueden ayudarle a configurar Dynamics 365 for Finance and Operations para personas jurídicas con una dirección principal en México. 


- [Ámbito de localización](latam-mex-scope.md)
- [Informe de la declaración de inflación de ajuste](latam-mex-adjustment-inflation-declaration-report.md)
...
- [Especificar la identificación del registro de RFC para las cuentas bancarias mejicanas](tasks/mx-00020-specify-rfc-registration-id-mexican-bank-accounts.md)
- [Id. de registro de proveedores](tasks/mx-00008-vendor-registration-ids.md)
