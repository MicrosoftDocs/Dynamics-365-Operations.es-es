...
<tr class="even">
<td>Almacenes</td>
<td>Cuentas de proveedor asociadas con los códigos de almacén para rellenar el número de identificación fiscal al transferir el pedido de transferencia.</td>
</tr>
</tbody>
</table>
...
<li>Configuración para informar de unidades (suplementarias) adicionales en la pestaña <strong>Comercio exterior</strong>. Puede seleccionar la unidad adicional en la lista de la unidad. También puede especificar si el peso de las mercancías se debe notificar además de la unidad adicional seleccionada.</li>
</ul></td>
</tr>
<tr class="even">
