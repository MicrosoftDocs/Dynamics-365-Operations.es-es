...
<xliff xmlns:logoport="urn:logoport:xliffeditor:xliff-extras:1.0" xmlns:tilt="urn:logoport:xliffeditor:tilt-non-translatables:1.0" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xmlns="urn:oasis:names:tc:xliff:document:1.2" xmlns:xliffext="urn:microsoft:content:schema:xliffextensions" version="1.2" xsi:schemaLocation="urn:oasis:names:tc:xliff:document:1.2 xliff-core-1.2-transitional.xsd">
  <file datatype="xml" source-language="en-US" original="cash-bank-management.md" target-language="es-ES">
    <header>
    ...
    <body>
      <group extype="content" id="content">
        ...
        <target logoport:matchpercent="101" state="translated" state-qualifier="leveraged-tm">Página principal de gestión de efectivo y bancos</target></trans-unit>
        ...
        <target logoport:matchpercent="101" state="translated" state-qualifier="leveraged-tm">Puede usar la Gestión de efectivo y bancos para mantener las cuentas bancarias de la entidad jurídica y los instrumentos financieros asociados a dichas cuentas bancarias.</target></trans-unit>
        ...
        <target logoport:matchpercent="101" state="translated" state-qualifier="leveraged-tm">Entre estos instrumentos se encuentran resguardos de depósito, cheques, letras de cambio y pagarés.</target></trans-unit>
        <trans-unit xml:space="preserve" translate="yes" id="106">
          <source>You can also reconcile bank statements and print bank data on standard reports.</source>
        <target logoport:matchpercent="101" state="translated" state-qualifier="leveraged-tm">También puede conciliar extractos bancarios e imprimir los datos bancarios en informes estándar.</target></trans-unit>
        ...
        <target logoport:matchpercent="101" state="translated" state-qualifier="leveraged-tm"><bpt id="p1">[</bpt><ph id="ph1">![</ph>Proceso empresarial<ept id="p1">](./media/Cash-process.PNG)](./media/Cash-process.PNG)</ept></target></trans-unit>
        <trans-unit xml:space="preserve" translate="yes" id="109">
          <source><bpt id="p1">[</bpt>Cash discounts<ept id="p1">](cash-discounts.md)</ept></source>
        <target logoport:matchpercent="101" state="translated" state-qualifier="leveraged-tm"><bpt id="p1">[</bpt>Descuentos por pronto pago<ept id="p1">](cash-discounts.md)</ept></target></trans-unit>
        <trans-unit xml:space="preserve" translate="yes" id="110">
          <source><bpt id="p1">[</bpt>Settlement overview<ept id="p1">](settlement-overview.md)</ept></source>
        <target logoport:matchpercent="101" state="translated" state-qualifier="leveraged-tm"><bpt id="p1">[</bpt>Descripción de la liquidación<ept id="p1">](settlement-overview.md)</ept></target></trans-unit>
        <trans-unit xml:space="preserve" translate="yes" id="111">
          <source><bpt id="p1">[</bpt>Configure settlement<ept id="p1">](configure-settlement.md)</ept></source>
        <target logoport:matchpercent="101" state="translated" state-qualifier="leveraged-tm"><bpt id="p1">[</bpt>Configurar liquidación<ept id="p1">](configure-settlement.md)</ept></target></trans-unit>
        ...
        <target logoport:matchpercent="101" state="translated" state-qualifier="leveraged-tm"><bpt id="p1">[</bpt>Revalorización de divisa extranjera para clientes y proveedores<ept id="p1">](foreign-currency-revaluation-accounts-payable-accounts-receivable.md)</ept></target></trans-unit>
        <trans-unit xml:space="preserve" translate="yes" id="113">
          <source><bpt id="p1">[</bpt>Letters of credit<ept id="p1">](letters-of-credit.md)</ept></source>
        <target logoport:matchpercent="101" state="translated" state-qualifier="leveraged-tm"><bpt id="p1">[</bpt>Carta de crédito<ept id="p1">](letters-of-credit.md)</ept></target></trans-unit>
        ...
        <target logoport:matchpercent="101" state="translated" state-qualifier="leveraged-tm"><bpt id="p1">[</bpt>Cartas de crédito y remesas documentarias<ept id="p1">](letters-of-credit-import-collections.md)</ept></target></trans-unit>
        <trans-unit xml:space="preserve" translate="yes" id="115">
          <source><bpt id="p1">[</bpt>Letter of guarantee<ept id="p1">](letters-of-guarantee.md)</ept></source>
        <target logoport:matchpercent="101" state="translated" state-qualifier="leveraged-tm"><bpt id="p1">[</bpt>Carta de garantía<ept id="p1">](letters-of-guarantee.md)</ept></target></trans-unit>
        <trans-unit xml:space="preserve" translate="yes" id="116">
          <source><bpt id="p1">[</bpt>Set up centralized payments<ept id="p1">](set-up-centralized-payments.md)</ept></source>
        <target logoport:matchpercent="101" state="translated" state-qualifier="leveraged-tm"><bpt id="p1">[</bpt>Configurar pagos centralizados<ept id="p1">](set-up-centralized-payments.md)</ept></target></trans-unit>
        <trans-unit xml:space="preserve" translate="yes" id="117">
          <source>Bank reconciliation</source>
        <target logoport:matchpercent="101" state="translated" state-qualifier="leveraged-tm">Conciliación bancaria</target></trans-unit>
        ...
        <target logoport:matchpercent="101" state="translated" state-qualifier="leveraged-tm"><bpt id="p1">[</bpt>Visión general de conciliación bancaria avanzada<ept id="p1">](advanced-bank-reconciliation-overview.md)</ept></target></trans-unit>
        ...
        <target logoport:matchpercent="101" state="translated" state-qualifier="leveraged-tm"><bpt id="p1">[</bpt>Configurar la conciliación bancaria avanzada<ept id="p1">](configure-advanced-bank-reconciliation.md)</ept></target></trans-unit>
        ...
        <target logoport:matchpercent="101" state="translated" state-qualifier="leveraged-tm"><bpt id="p1">[</bpt>Configurar la importación avanzada de conciliación bancaria<ept id="p1">](set-up-advanced-bank-reconciliation-import-process.md)</ept></target></trans-unit>
        ...
        <target logoport:matchpercent="101" state="translated" state-qualifier="leveraged-tm"><bpt id="p1">[</bpt>Conciliar extractos bancarios mediante la conciliación bancaria avanzada<ept id="p1">](reconcile-bank-statements-advanced-bank-reconciliation.md)</ept></target></trans-unit>
        ...
        <target logoport:matchpercent="101" state="translated" state-qualifier="leveraged-tm"><bpt id="p1">[</bpt>Configurar las reglas de coincidencia de conciliación bancaria<ept id="p1">](set-up-bank-reconciliation-matching-rules.md)</ept></target></trans-unit>
        <trans-unit xml:space="preserve" translate="yes" id="123">
          <source>Accounts payable payments and settlements</source>
        <target logoport:matchpercent="101" state="translated" state-qualifier="leveraged-tm">Pagos y liquidaciones de proveedores</target></trans-unit>
        ...
        <target logoport:matchpercent="101" state="translated" state-qualifier="leveraged-tm"><bpt id="p1">[</bpt>Pagos centralizados para proveedores<ept id="p1">](../accounts-payable/centralized-payments-accounts-payable.md)</ept></target></trans-unit>
        ...
        <target logoport:matchpercent="101" state="translated" state-qualifier="leveraged-tm"><bpt id="p1">[</bpt>Creación de facturas de proveedor mediante una propuesta de pago<ept id="p1">](../accounts-payable/create-vendor-payments-payment-proposal.md)</ept></target></trans-unit>
        <trans-unit xml:space="preserve" translate="yes" id="126">
          <source><bpt id="p1">[</bpt>Reverse a vendor payment<ept id="p1">](../accounts-payable/reverse-vendor-payment.md)</ept></source>
        <target logoport:matchpercent="101" state="translated" state-qualifier="leveraged-tm"><bpt id="p1">[</bpt>Inversión de un pago de proveedor<ept id="p1">](../accounts-payable/reverse-vendor-payment.md)</ept></target></trans-unit>
        ...
        <target logoport:matchpercent="101" state="translated" state-qualifier="leveraged-tm"><bpt id="p1">[</bpt>Pagos de proveedor para un importe parcial<ept id="p1">](../accounts-payable/vendor-payments-partial-amount.md)</ept></target></trans-unit>
        ...
        <target logoport:matchpercent="101" state="translated" state-qualifier="leveraged-tm"><bpt id="p1">[</bpt>Facturas de anticipo y visión general de anticipos<ept id="p1">](../accounts-payable/prepayments-invoices-vs-prepayments.md)</ept></target></trans-unit>
        ...
        <target logoport:matchpercent="101" state="translated" state-qualifier="leveraged-tm"><bpt id="p1">[</bpt>Escenario: liquidar un pago de proveedor parcial y liquidar el pago final completamente antes de la fecha de descuento<ept id="p1">](../accounts-payable/settle-partial-vendor-payment-or-final-payment-before-discount.md)</ept></target></trans-unit>
        ...
        <target logoport:matchpercent="101" state="translated" state-qualifier="leveraged-tm"><bpt id="p1">[</bpt>Escenario: liquidar un pago de proveedor parcial antes de la fecha de descuento con un pago final después de la fecha de descuento<ept id="p1">](../accounts-payable/settle-partial-vendor-payment-before-discount-or-final-payment-after.md)</ept></target></trans-unit>
        ...
        <target logoport:matchpercent="101" state="translated" state-qualifier="leveraged-tm"><bpt id="p1">[</bpt>Escenario: liquidar un pago de proveedor parcial con descuentos en notas de abono de proveedor<ept id="p1">](../accounts-payable/settle-partial-vendor-payment-discounts-vendor-credit-notes.md)</ept></target></trans-unit>
        ...
        <target logoport:matchpercent="101" state="translated" state-qualifier="leveraged-tm"><bpt id="p1">[</bpt>Escenario: liquidar un pago de proveedor parcial con varios períodos de descuento<ept id="p1">](../accounts-payable/settle-partial-vendor-payment-multiple-discount-periods.md)</ept></target></trans-unit>
        ...
        <target logoport:matchpercent="101" state="translated" state-qualifier="leveraged-tm"><bpt id="p1">[</bpt>Escenario: aprovechar un descuento superior al calculado para un pago de proveedor<ept id="p1">](../accounts-payable/take-discount-more-calculated-discount-vendor-payment.md)</ept></target></trans-unit>
        ...
        <target logoport:matchpercent="101" state="translated" state-qualifier="leveraged-tm"><bpt id="p1">[</bpt>Escenario: obtener un descuento por pronto pago fuera del período de descuento por pronto pago<ept id="p1">](../accounts-payable/take-cash-discount-outside-cash-discount-timeframe.md)</ept></target></trans-unit>
        <trans-unit xml:space="preserve" translate="yes" id="135">
          <source>Accounts receivable payments and settlements</source>
        <target logoport:matchpercent="101" state="translated" state-qualifier="leveraged-tm">Pagos y liquidaciones de clientes</target></trans-unit>
        ...
        <target logoport:matchpercent="101" state="translated" state-qualifier="leveraged-tm"><bpt id="p1">[</bpt>Pagos centralizados para Clientes<ept id="p1">](../accounts-receivable/centralized-payments-accounts-receivable.md)</ept></target></trans-unit>
        ...
        <target logoport:matchpercent="101" state="translated" state-qualifier="leveraged-tm"><bpt id="p1">[</bpt>Pagos de cliente para un importe parcial<ept id="p1">](../accounts-receivable/customer-payments-partial-amount.md)</ept></target></trans-unit>
        <trans-unit xml:space="preserve" translate="yes" id="138">
          <source><bpt id="p1">[</bpt>Reimburse customers<ept id="p1">](../accounts-receivable/reimburse-customers.md)</ept></source>
        <target logoport:matchpercent="101" state="translated" state-qualifier="leveraged-tm"><bpt id="p1">[</bpt>Reembolsar a clientes<ept id="p1">](../accounts-receivable/reimburse-customers.md)</ept></target></trans-unit>
        ...
        <target logoport:matchpercent="101" state="translated" state-qualifier="leveraged-tm"><bpt id="p1">[</bpt>Escenario: liquidación y priorización automáticas<ept id="p1">](../accounts-receivable/automatic-settlement-prioritization.md)</ept></target></trans-unit>
        ...
        <target logoport:matchpercent="101" state="translated" state-qualifier="leveraged-tm"><bpt id="p1">[</bpt>Escenario: gestión de descuentos por pronto pago para sobrepagos<ept id="p1">](../cash-bank-management/cash-discount-handling-overpayments.md)</ept></target></trans-unit>
        ...
        <target logoport:matchpercent="101" state="translated" state-qualifier="leveraged-tm"><bpt id="p1">[</bpt>Escenario: liquidar un pago de cliente parcial y liquidar el pago final completamente antes de la fecha de descuento<ept id="p1">](../accounts-payable/settle-partial-customer-payment-or-final-payment-before-discount.md)</ept></target></trans-unit>
        ...
        <target logoport:matchpercent="101" state="translated" state-qualifier="leveraged-tm"><bpt id="p1">[</bpt>Escenario: liquidar un pago de cliente parcial antes de la fecha de descuento con un pago final después de la fecha de descuento<ept id="p1">](../accounts-receivable/settle-partial-customer-payment-before-discount-or-final-payment-after.md)</ept></target></trans-unit>
        ...
        <target logoport:matchpercent="101" state="translated" state-qualifier="leveraged-tm"><bpt id="p1">[</bpt>Escenario: liquidar un pago de cliente parcial con descuentos en notas de abono de proveedor<ept id="p1">](../accounts-receivable/settle-partial-customer-payment-discounts-credit-notes.md)</ept></target></trans-unit>
        ...
        <target logoport:matchpercent="101" state="translated" state-qualifier="leveraged-tm"><bpt id="p1">[</bpt>Escenario: liquidar un pago de cliente parcial con varios períodos de descuento<ept id="p1">](../accounts-receivable/settle-partial-customer-payment-multiple-discount-periods.md)</ept></target></trans-unit>
        ...
        <target logoport:matchpercent="101" state="translated" state-qualifier="leveraged-tm"><bpt id="p1">[</bpt>Escenario: usar un pago de cliente para liquidar varias facturas que abarcan varios períodos de descuento<ept id="p1">](../accounts-receivable/customer-payment-settle-multiple-invoices-multiple-discount-periods.md)</ept></target></trans-unit>
        ...
        <target logoport:matchpercent="101" state="translated" state-qualifier="leveraged-tm">Vaya a las <bpt id="p1">[</bpt>Notas de la versión Microsoft Dynamics 365<ept id="p1">](https://go.microsoft.com/fwlink/?linkid=2010158)</ept> para ver qué nuevas características se han planificado.</target></trans-unit>
        ...
        <target logoport:matchpercent="101" state="translated" state-qualifier="leveraged-tm">Consulte los vídeos de procedimientos que se encuentran ahora disponibles en el [canal de YouTube de Microsoft Dynamics 365] (<ph id="ph1">https://www.youtube.com/channel/UCJGCg4rB3QSs8y_1FquelBQ)</ph>.</target></trans-unit>
      </group>
    </body>
  </file>
</xliff>