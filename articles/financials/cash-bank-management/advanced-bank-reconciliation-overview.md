...
3.  Concilie extractos bancarios con las transacciones bancarias de Finance and Operations.
    -   Realice la creación y la conciliación automáticas de diarios de conciliación.
    -   Vea extractos bancarios y las transacciones bancarias de Finance and Operations en paralelo.
    -   Registre automáticamente transacciones bancarias de Finance and Operations si aparecen en un extracto bancario pero no aparecen en Finance and Operations.
