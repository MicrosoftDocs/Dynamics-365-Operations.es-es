...
description: En el siguiente tema se proporciona información acerca de la página de lista de transacciones de cliente para Microsoft Dynamics 365 for Finance and Operations.
author: mikefalkner
manager: aolson
ms.date: 08/28/2018
ms.topic: article
