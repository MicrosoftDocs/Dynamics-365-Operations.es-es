...
# <a name="add-new-location-roles-and-party-relationship-types"></a>Agregar nuevos roles de ubicación y tipos de relaciones de las partes 

## <a name="add-new-location-roles"></a>Agregar nuevas funciones de ubicación
...
## <a name="add-new-party-relationship-types"></a>Agregar nuevos tipos de relación de terceros 
