...
description: Este artículo describe cómo modificar el formato de informes electrónicos (ER) que se usa para generar documentos empresariales reaplicando una plantilla de Excel modificada.
author: NickSelin
ms.date: 05/18/2022
ms.topic: article
ms.prod: ''
