...
ms.locfileid: "6768474"
---
# <a name="len-er-function"></a>Función LEN de ER

[!include [banner](../includes/banner.md)]

La función `LEN` devuelve un valor de tipo *Entero* que representa el número de caracteres de la cadena especificada.
