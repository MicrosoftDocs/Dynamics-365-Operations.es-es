...
Usar carpetas para organizar los bloques de creación en el diseñador de informes. Todas las carpetas son específicas al tipo de bloques de creación que contienen. Por ejemplo, todas las carpetas que contienen definiciones de filas están ubicadas en el panel **Definiciones de las filas** de Report designer.

### <a name="create-a-folder"></a>Crear una carpeta

1. En Report designer, seleccione el tipo de bloque de creación para organizar en el panel de navegación. Por ejemplo, para clasificar una definición de filas, haga clic en **Definiciones de filas**.
...
1. En Report designer, abra el componente del informe que quiere bloquear, por ejemplo una definición de fila, una definición de columna, una definición del informe o una definición del organigrama.
...
1. En Report designer, en el menú **Herramientas**, haga clic en **Elementos desprotegidos**.
