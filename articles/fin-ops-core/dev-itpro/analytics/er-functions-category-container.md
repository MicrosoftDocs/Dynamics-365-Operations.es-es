...
| Función | Descripción |
|----------|-------------|
| [Base64StringToContainer](er-functions-container-base64stringtocontainer.md) | Esta función devuelve un valor de *Contenedor* que consta de contenido binario que se descodifica a partir de la cadena ASCII especificada que representa un grupo Base64 de esquemas de codificación de binario a texto. |
