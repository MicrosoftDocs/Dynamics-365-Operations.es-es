...
| Ver informe                       | Abrir la versión más reciente del informe generado. Este comando está disponible desde una definición del informe si ha generado al menos un informe. |
...
| Comando | Descripción                                                              |
|---------|--------------------------------------------------------------------------|
| Ayuda    | Abra la página del tema de ayuda para los informes financieros. |
|         |                                                                          |
