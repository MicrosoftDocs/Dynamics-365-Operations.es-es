...
description: Este artículo describe el contenido en Power BI de Prestaciones.
author: jcart1106
ms.date: 12/19/2017
ms.topic: article
ms.prod: ''
...
ms.locfileid: "8848820"
---
# <a name="benefits-power-bi-content"></a>Contenido de prestaciones de Power BI

[!include [banner](../includes/banner.md)]

Este artículo describe el contenido en Microsoft Power BI de **Prestaciones**. Explica cómo obtener acceso a los informes incluidos y proporciona información acerca del modelo de datos y las entidades que se utilizan para generar el contenido.
