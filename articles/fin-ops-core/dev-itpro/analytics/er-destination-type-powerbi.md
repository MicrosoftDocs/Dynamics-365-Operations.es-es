...
Puede configurar un destino de Microsoft Power BI para cada componente de archivo o carpeta de un formato de informe electrónico (ER) que está configurado para generar documentos salientes. Según la configuración del destino, el documento generado se almacena en una carpeta de SharePoint previamente configurada.
