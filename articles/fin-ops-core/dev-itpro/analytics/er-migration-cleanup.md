---
title: Limpieza de migración de informes electrónicos
description: Este artículo explica cómo puede usar la función de limpieza de migración de ER para resolver problemas con las plantillas de ER.
author: kfend
ms.date: 04/29/2020
ms.topic: article
ms.prod: ''
