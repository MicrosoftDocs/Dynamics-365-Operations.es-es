...
description: Este artículo describe cómo se puede usar el editor avanzado de fórmulas para configurar expresiones en la asignación de modelos y los componentes de formato de informes electrónicos (ER).
author: kfend
ms.date: 06/17/2021
ms.topic: article
ms.prod: ''
...
ms.locfileid: "9286229"
---
# <a name="electronic-reporting-advanced-formula-editor"></a>Editor de fórmulas avanzadas de informes electrónicos

[!include [banner](../includes/banner.md)]

Además del [editor de fórmulas ](general-electronic-reporting-formula-designer.md) de [informes electrónicos ](general-electronic-reporting.md), puede usar el editor avanzado de fórmulas de informes electrónicos para mejorar la experiencia de configurar expresiones de informes electrónicos (ER). El editor avanzado está basado en el navegador y funciona con el [editor Monaco](https://microsoft.github.io/monaco-editor). Las características avanzadas más utilizadas del editor se describen en este artículo:
