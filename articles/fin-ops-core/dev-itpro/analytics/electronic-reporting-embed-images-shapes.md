...
description: Este tema explica cómo utilizar la herramienta de informes electrónicos (ER) para generar documentos comerciales que tienen imágenes y formas incrustadas.
author: NickSelin
ms.date: 04/23/2021
ms.topic: article
ms.prod: ''
