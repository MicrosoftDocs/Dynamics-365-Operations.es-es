...
- Si el método **isLanguageRTL** del origen de datos **Sistema** tiene un parámetro **EN-US** del tipo de datos *Cadena*, este método debe hacer referencia a una expresión de ER como `System.isLanguageRTL("EN-US")`.
