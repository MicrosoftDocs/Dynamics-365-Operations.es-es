## <a name="customers-v3-to-contacts"></a>Clientes V3 para contactos

Esta plantilla sincroniza datos entre aplicaciones de Finance and Operations y Common Data Service.

Filtro de origen: ((PartyType == "Persona"))

Filtro de origen invertido: msdyn_sellable eq true y msdyn_contactpersonid ne ''

Campo de Finance and Operations | Tipo de asignación | Otro campo de Dynamics 365 | Valor predeterminado
---|---|---|---
none | >> | msdyn_sellable | Verdadero
PARTYTYPE | << | none | Persona
...
ADDRESSLOCATIONROLES | << | none | Negocio
