...
1. Para configurar la conexión de escritura doble entre instancias de la aplicación de Finance and Operations y Common Data Service u otra aplicación de Dynamics 365, inicie sesión en la aplicación de Finance and Operations como administrador. 
...
4. Habilite la asignación de entidad **Cdm_companies**. Esto sincroniza empresas de la aplicación de Finance and Operations con Common Data Service.  
    > [!div class="mx-imgBorder"]
