...
description: Este artículo describe la integración de datos de sitios y almacenes entre finanzas y operaciones y Dataverse.
author: t-benebo
ms.date: 10/09/2019
ms.topic: article
...
Este artículo describe la integración de datos de sitios y almacenes entre finanzas y operaciones y Dataverse. Los sitios operativos y los almacenes son conceptos comunes en una aplicación de Supply Chain Management. Se usan para modelar a la cadena de suministro de la empresa.
