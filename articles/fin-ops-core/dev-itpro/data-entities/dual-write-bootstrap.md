...
Debe usar el arranque antes de habilitar las asignaciones de entidad de escritura doble (durante el paso 5).  
1. Para configurar la conexión de escritura doble entre instancias de la aplicación de Finance and Operations y Common Data Service u otra aplicación de Dynamics 365, inicie sesión a la aplicación de Finance and Operations como administrador. 
...
4. Habilite la asignación de entidad **Cdm_companies**. Esto sincroniza las empresas de la aplicación de Finance and Operations a Common Data Service.  
    > [!div class="mx-imgBorder"]
    > ![Habilitar la asignación de entidad](media/dual-write-boot-2.png)
5. Ejecute el código de arranque de muestra en la instancia de Common Data Service u otra instancia de la aplicación de Dynamics 365.  
6. Cuando se haya efectuado el arranque y el sistema está listo para la sincronización en directo, habilite las asignaciones de entidades.  

    Habilitar las asignaciones de entidades desencadena la sincronización de datos inicial para las asignaciones de entidades habilitadas. Los datos correspondientes a las empresas elegidas en la conexión de escritura doble se sincronizan entre la aplicaciones de Finance and Operations y Common Data Service. 
