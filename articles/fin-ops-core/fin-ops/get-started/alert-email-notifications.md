---
title: Notificaciones por correo electrónico de alertas del cliente
description: Este artículo proporciona información acerca de cómo configurar las reglas que envían notificaciones por correo electrónico para los eventos predefinidos que ocurren.
author: RichdiMSFT
ms.date: 09/20/2019
ms.topic: article
ms.prod: ''
