...
| \*Comprobación de continuidad de asiento para China                                                                                               | China                             |
...
| \*Registrar asientos del diario general                                                                                         | China                             |
...
| Línea BPM                                                                   | País o región |
|----------------------------------------------------------------------------|----------------|
| \*Cambiar la propiedad del inventario de entrega en base a la demanda de la producción | Global         |
| \*Crear un pedido de reabastecimiento de entrega                                 | Global         |
| \*Supervisar el inventario de entrega mediante la colaboración de proveedores                 | Global         |
...
| \*Crear una nomenclatura de números de producto para las variantes de producto predefinidas | Global         |
| \*Crear una nomenclatura de números de producto para las variantes de producto configuradas | Global         |
...
| \*Crear un artículo de menú del dispositivo móvil para la consolidación del número de matrícula          | Global         |
...
| \*Configuración de la reasignación de artículos para la selección corta                                    | Global         |
