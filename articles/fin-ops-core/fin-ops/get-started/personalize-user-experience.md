...
- Las personalizaciones relacionadas con el uso de la página, denominadas personalizaciones *implícitas*. Por ejemplo, el sistema mantiene el seguimiento del ancho de las columnas de cuadrícula si las ajusta, y el estado de expandido o contraído de las fichas desplegables.
...
Además de modificar la configuración del usuario, también puede ver y eliminar sus datos de uso y personalizaciones haciendo clic en el botón **Datos de uso**. Cuando se utiliza la aplicación, muchas de las selecciones se recuerdan para que pueda utilizar el sistema más fácilmente en el futuro. La pestaña **Personalización** en particular, le permite ver y gestionar los cambios personales que realizó en las páginas del sistema. Las llamadas de característica, las ventanas emergentes que le presentan las nuevas características del sistema (disponible en la Platform update 26), también puede reiniciarse desde esta ficha para reciba avisos de nuevo sobre las características anteriormente presentadas.  
...
Las distintas personas y empresas tienen una perspectiva diferente sobre los datos que son más importante para ellas, o los datos que no requieren para la forma en que ejecutan su negocio. Pede ajustar la manera en la que la información se ordena o cómo se interactúa con ella. También puede especificar que cierta información debe mantenerse oculta. Estas capacidades son clave para tener una experiencia personal y productiva, y son ejemplos de personalizaciones explícitas. Las personalizaciones explícitas son aquellas personalizaciones que se realizan explícitamente con la intención de cambiar el aspecto o el comportamiento de un elemento o de una página.
...
El panel de información suele ser la primera página que verá al abrir la aplicación. Puede personalizar el panel de información de modo que muestre solo los mosaicos del espacio de trabajo que desea ver. También puede reorganizar los mosaicos de modo que se encuentren en el orden que prefiere consultarlos, cambiar el nombre de los mosaicos de navegación de área de trabajo, o agregar un mosaico de espacio de trabajo completamente nuevo.
...
- **Administrador por usuario** Seleccione un usuario para ver la lista de páginas que este usuario ha personalizado. A continuación puede habilitar o deshabilitar la capacidad del usuario seleccionado para utilizar personalizaciones para páginas determinadas o el sistema completo. También puede importar, exportar o borrar una personalización para el usuario seleccionado. Además, puede restablecer las llamadas de función para el usuario seleccionado, lo que hará que todas las ventanas emergentes anteriormente despedidas que presentaron características nuevas aparezcan de nuevo la próxima vez que el usuario encuentra dichas características.   
...
Los ajustes de **visualización de dimensiones** se aplican a todas las páginas y estos valores anulan cualquier configuración personalizada de campos de dimensión de inventario en cada página individual.
