...
description: Este artículo enumera las guías de tareas que estaban publicadas en las bibliotecas de Microsoft BPM en febrero de 2016.
author: josaw1
ms.date: 06/20/2017
ms.topic: article
ms.prod: ''
...
ms.locfileid: "8861745"
---
# <a name="new-task-guides-february-2016"></a>Nuevas guías de tareas (febrero de 2016)

[!include [banner](../includes/banner.md)]

Este artículo enumera las guías de tareas que estaban publicadas en las bibliotecas de Microsoft BPM en febrero de 2016. Las bibliotecas que se publicaron incluyen la biblioteca unificada APQC (febrero de 2016) para Microsoft Dynamics AX y la biblioteca de introducción (febrero de 2016).
...
| Línea BPM                                                            | País/región |
|---------------------------------------------------------------------|----------------|
| Comparar los costes activos, estimados y realizados en un pedido de producción | Global         |
...
| Configuración de la forma de pago para domiciliaciones bancarias SEPA                                                         | Europa                          |
...
| Línea BPM                                                                                 | País/región |
|------------------------------------------------------------------------------------------|----------------|
| Analizar resultados de cuestionario                                                            | Global         |
| Crear una pregunta cerrada                                                           | Global         |
...
| Línea BPM                                                      | País/región |
|---------------------------------------------------------------|----------------|
| Agregar una directiva de cálculo de cantidad kanban a una regla kanban     | Global         |
...
| Cree un pedido de producción                                     | Global         |
...
| Modificar manualmente una previsión de demanda                 | Global         |
...
| Configurar libretas de direcciones                   | Global         |
...
| Configurar secuencias numéricas mediante un asistente | Global         |
...
| Línea BPM                                                         | País/región |
|------------------------------------------------------------------|----------------|
| Crear un acuerdo de compra                                      | Global         |
...
| Transferir datos para modelos de producto                                   | Global         |
...
| Creación de un asiento contable avanzado para el sector público                                       | Global         |
...
| Almacenar configuraciones para los extractos de Retail                                                | Global         |

### <a name="sales"></a>Ventas

| Línea BPM                                   | País/región |
|--------------------------------------------|----------------|
| Confirmar pedidos de ventas                       | Global         |
...
| Configurar códigos de disposiciones                                                         | Global         |
...
| Crear un producto liberado para una sola empresa     | Global         |
