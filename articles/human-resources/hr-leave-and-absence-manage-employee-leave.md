...
## <a name="adjust-leave-balances"></a>Ajustar resultados de bajas

1. En el registro del empleado, seleccione **Baja**.

2. Seleccione **Configuración de bajas y ausencias**.

3. Seleccione **Ajustar resultados**.

4. Seleccione el **Tipo de baja**.

5. Introduzca un **Valor de ajuste**. 

6. Opcionalmente, puede seleccionar una **Fecha**. 
