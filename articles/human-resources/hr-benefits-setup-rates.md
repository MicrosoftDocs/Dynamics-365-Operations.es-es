...
---
# <a name="configure-rates"></a>Configurar tasas
...
3. Especifique los valores para los siguientes campos:
   ...
   | Cálculo de la tasa de frecuencia de pago | El método para el cálculo de la tasa de frecuencia de pago: Estándar o Anual. |
