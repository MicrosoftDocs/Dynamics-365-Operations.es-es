...
| Cambio en la cobertura (salario) | Trabajador > Compensación > Plan fijo | El salario anual de prestaciones se recalcula automáticamente cuando cambia la compensación |
