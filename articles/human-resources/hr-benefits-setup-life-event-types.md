...
| **Cambio de la situación laboral** |<br><ul><li>Trabajador > Empleo</li><li>Página del historial de empleo</li></ul> | Para un trabajador con un detalle de empleo existente, la creación de un nuevo detalle de empleo con un estado laboral diferente desencadenará un evento de vida.  La actualización de un detalle de empleado existente con un estado laboral diferente también desencadenará un evento de vida.  |
| **Cambio de dirección del empleado** |<br><ul><li>Trabajador > Perfil > Direcciones</li><li>Trabajador > Información personal > Contactos personales > Dirección</li></ul> | Cambio de domicilio. La dirección debe ser **Principal** para desencadenar un evento de vida. |
