...
description: Este artículo proporciona una API y una referencia de campos personalizados. También proporciona información sobre la integración con otras aplicaciones.
author: twheeloc
ms.date: 02/03/2020
ms.topic: overview
ms.prod: ''
...
Este artículo proporciona una API y una referencia de campos personalizados. También proporciona información sobre la integración con otras aplicaciones.

- [Información general](hr-developer-overview.md)
