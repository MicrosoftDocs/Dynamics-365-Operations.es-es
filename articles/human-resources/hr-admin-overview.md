...
- [Configurar y administrar el registro de la base de datos](hr-admin-database-logging.md)
...
Para cursos y formación en línea, consulte [Dynamics 365 Human Resources rutas de aprendizaje](/training/browse/?products=dynamics-human-resources&resource_type=learning%20path).
