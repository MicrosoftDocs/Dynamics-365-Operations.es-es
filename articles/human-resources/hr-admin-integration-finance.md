...
Este artículo describe la funcionalidad disponible para la integración de Dynamics 365 Human Resources y Dynamics 365 Finance. La plantilla de Human Resources para Finance que está disponible con el [Integrador de datos](https://docs.microsoft.com/powerapps/administrator/data-integrator) habilita el flujo de datos para trabajos, puestos y trabajadores. Los datos fluyen de Human Resources a Finance. La plantilla no brinda la capacidad de que los datos fluyan de Finance a Human Resources. 

![Flujo de integración de Human Resources a Finance](./media/TalentFinOpsFlow.png)

La solución Human Resources para Finance proporciona los siguientes tipos de sincronización de datos. 
...
- Dynamics 365 Human Resources en Common Data Service.
- Dynamics 365 Finance versión 7.2 y posteriores.

## <a name="template-and-tasks"></a>Plantilla y tareas

Para obtener acceso a la plantilla, realice lo siguiente.
1. Abra el [Centro de administración de Power Apps](https://admin.powerapps.com/). 
1. Seleccione **Proyectos**y, a continuación, en la esquina superior derecha, seleccione **Nuevo proyecto** para seleccionar plantillas públicas. Será necesario crear un nuevo proyecto para cada entidad jurídica que desee integrar en Finance.

La siguiente plantilla se utiliza para sincronizar registros de Centro de administración con Finance.

- **Nombre de la plantilla en Integración de datos:** Human Resources (Common Data Service de Human Resources con Finance)

  > [!NOTE]
  > El nombre de la tarea contiene las entidades utilizadas en cada aplicación. El origen (Human Resources) está a la izquierda y el destino (Finance and Operations) está a la derecha.

Las siguientes tareas subyacentes se utilizan para sincronizar registros de Human Resources con Finance.
...
| Entidad de Common Data Service (origen)                 | Entidad de Finance and Operations (destino) |
|-------------------------------------|---------------------------------------------|
...
### <a name="job-positions-to-position-hiearchies"></a>Puestos de trabajo con jerarquías de puestos de trabajo
...
Al integrar datos de Human Resources con Finance, la integración intentará hacer coincidir los registros según el id. Si se produce la coincidencia, los datos en Finance se sobrescribirán con los valores en Human Resources. Sin embargo, puede ocurrir un problema si lógicamente estos son registros diferentes y se generó el mismo id. en Human Resources o Finance en función de la secuencia numérica respectiva.

Las áreas donde esto puede ocurrir son Trabajador, que usa el número de Personal para hacer la coincidencia, y Posiciones. Los trabajos no usan secuencias numéricas. Como resultado, si la misma ID de trabajo está presente tanto en Human Resources como en Finance, la información de Human Resources sobrescribirá la información de Dynamics 365 Finance. 
