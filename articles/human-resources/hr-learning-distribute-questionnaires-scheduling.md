...
5. En el campo **Tipo**, seleccione el tipo de planificación.  En este ejemplo utilizaremos el tipo **Satisfacción**.
...
9. En el árbol, expanda el nodo para el tipo de cuestionario **Encuesta de satisfacción**.
