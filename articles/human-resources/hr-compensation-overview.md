...
description: Este artículo describe cómo utilizar la administración de compensación para administrar y procesar planes de compensación.
author: twheeloc
ms.date: 08/25/2021
ms.topic: overview
ms.prod: ''
