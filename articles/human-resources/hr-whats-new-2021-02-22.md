...
description: Este artículo describe las características que son nuevas o que se han cambiado en Microsoft Dynamics 365 Human Resources para el 22 de febrero de 2021.
author: marcelbf
ms.date: 02/22/2021
ms.topic: article
ms.prod: ''
...
Para obtener más información sobre el proceso de actualización del servicio, consulte [Proceso de actualización](./hr-admin-setup-update-process.md).
