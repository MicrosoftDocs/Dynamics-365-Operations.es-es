...
description: Este artículo describe cómo configurar la autenticación de servidor a servidor para integraciones con la API de integración del sistema de seguimiento de candidatos (ATS) de Dynamics 365 Human Resources.
author: jaredha
ms.date: 06/30/2021
ms.topic: article
ms.prod: ''
