...
- <span data-ttu-id="c2a44-111">Datos de recursos humanos</span><span class="sxs-lookup"><span data-stu-id="c2a44-111">Human resources data</span></span>
...
## <a name="configure-your-data"></a><span data-ttu-id="c2a44-141">Configurar los datos</span><span class="sxs-lookup"><span data-stu-id="c2a44-141">Configure your data</span></span> 
...
##### <a name="benefits"></a><span data-ttu-id="c2a44-158">Beneficios</span><span class="sxs-lookup"><span data-stu-id="c2a44-158">Benefits</span></span>
...
- [<span data-ttu-id="c2a44-204">Definición del proceso de compensación y el cálculo de resultados</span><span class="sxs-lookup"><span data-stu-id="c2a44-204">Define compensation process and calculate results</span></span>](https://docs.microsoft.com/dynamics365/unified-operations/fin-and-ops/hr/tasks/define-compensation-process-calculate-results)
...
- <span data-ttu-id="c2a44-226">Ciclo de pago (obligatorio)</span><span class="sxs-lookup"><span data-stu-id="c2a44-226">Pay cycle (required)</span></span>
...
#### <a name="pay-cycles-and-pay-periods"></a><span data-ttu-id="c2a44-241">Ciclos y períodos de pago</span><span class="sxs-lookup"><span data-stu-id="c2a44-241">Pay cycles and pay periods</span></span>
...
#### <a name="earning-codes"></a><span data-ttu-id="c2a44-257">Códigos de ganancia</span><span class="sxs-lookup"><span data-stu-id="c2a44-257">Earning codes</span></span>
...
#### <a name="contact-information"></a><span data-ttu-id="c2a44-296">Información de contacto</span><span class="sxs-lookup"><span data-stu-id="c2a44-296">Contact information</span></span> 
...
<span data-ttu-id="c2a44-342">Un plan de compensación fija se debe asociar al puesto principal de cada empleado durante un período de empleo.</span><span class="sxs-lookup"><span data-stu-id="c2a44-342">A fixed compensation plan must be associated with every employee's primary position throughout an employment period.</span></span> <span data-ttu-id="c2a44-343">Este período comienza en la fecha de contratación del empleado (o la fecha de inicio del empleo) y continúa hasta la finalización.</span><span class="sxs-lookup"><span data-stu-id="c2a44-343">This period starts on the date that the employee was hired (or the employment start date) and continues until termination.</span></span>
...
- <span data-ttu-id="c2a44-358">Principal (obligatorio)</span><span class="sxs-lookup"><span data-stu-id="c2a44-358">Primary (required)</span></span>
...
### <a name="job-types"></a><span data-ttu-id="c2a44-396">Tipos de trabajo</span><span class="sxs-lookup"><span data-stu-id="c2a44-396">Job types</span></span>
...
|------------------------|----------------------|
| <span data-ttu-id="c2a44-454">Casado/a</span><span class="sxs-lookup"><span data-stu-id="c2a44-454">Married</span></span>                | <span data-ttu-id="c2a44-455">Casado/a</span><span class="sxs-lookup"><span data-stu-id="c2a44-455">Married</span></span>              |
...
- <span data-ttu-id="c2a44-484">Todas</span><span class="sxs-lookup"><span data-stu-id="c2a44-484">All</span></span>
...
### <a name="addresses"></a><span data-ttu-id="c2a44-513">Direcciones</span><span class="sxs-lookup"><span data-stu-id="c2a44-513">Addresses</span></span>
...
| <span data-ttu-id="c2a44-524">Población</span><span class="sxs-lookup"><span data-stu-id="c2a44-524">City</span></span>            | <span data-ttu-id="c2a44-525">Población</span><span class="sxs-lookup"><span data-stu-id="c2a44-525">City</span></span>                  |
| <span data-ttu-id="c2a44-526">Comarca</span><span class="sxs-lookup"><span data-stu-id="c2a44-526">County</span></span>          | <span data-ttu-id="c2a44-527">Condado (municipio)</span><span class="sxs-lookup"><span data-stu-id="c2a44-527">County (Municipality)</span></span> |
| <span data-ttu-id="c2a44-528">Calle</span><span class="sxs-lookup"><span data-stu-id="c2a44-528">Street</span></span>          | <span data-ttu-id="c2a44-529">Línea de dirección 1</span><span class="sxs-lookup"><span data-stu-id="c2a44-529">Address Line 1</span></span>        |

### <a name="tax-regions"></a><span data-ttu-id="c2a44-530">Regiones de impuestos</span><span class="sxs-lookup"><span data-stu-id="c2a44-530">Tax regions</span></span>

<span data-ttu-id="c2a44-531">Las regiones de impuestos se usan para determinar los impuestos correspondientes que se deben aplicar durante la generación de nómina.</span><span class="sxs-lookup"><span data-stu-id="c2a44-531">Tax regions are used to determine the appropriate tax that should be applied during payroll generation.</span></span> <span data-ttu-id="c2a44-532">Las regiones de impuestos se asignan a Dayforce como direcciones de ubicación.</span><span class="sxs-lookup"><span data-stu-id="c2a44-532">Tax regions are mapped to Dayforce as location addresses.</span></span> <span data-ttu-id="c2a44-533">La región de impuestos predeterminada se debe asociar al puesto activo del trabajador.</span><span class="sxs-lookup"><span data-stu-id="c2a44-533">The default tax region must be associated with the worker's active position.</span></span> 

- <span data-ttu-id="c2a44-534">Región de impuestos (obligatorio)</span><span class="sxs-lookup"><span data-stu-id="c2a44-534">Tax region (required)</span></span>
- <span data-ttu-id="c2a44-535">País o región (obligatorio)</span><span class="sxs-lookup"><span data-stu-id="c2a44-535">Country/Region (required)</span></span>
- <span data-ttu-id="c2a44-536">Estado (obligatorio)</span><span class="sxs-lookup"><span data-stu-id="c2a44-536">State (required)</span></span>
- <span data-ttu-id="c2a44-537">Comarca</span><span class="sxs-lookup"><span data-stu-id="c2a44-537">County</span></span> 
- <span data-ttu-id="c2a44-538">Ciudad (obligatorio)</span><span class="sxs-lookup"><span data-stu-id="c2a44-538">City (required)</span></span>

## <a name="configure-your-data-to-generate-payroll-in-mexico"></a><span data-ttu-id="c2a44-539">Configurar los datos para generar nóminas en México</span><span class="sxs-lookup"><span data-stu-id="c2a44-539">Configure your data to generate payroll in Mexico</span></span>

<span data-ttu-id="c2a44-540">Si va a generar el sueldo de los empleados en México, los siguientes elementos deben estar configurados:</span><span class="sxs-lookup"><span data-stu-id="c2a44-540">If you're generating pay for employees in Mexico, the following elements must be configured:</span></span>

- <span data-ttu-id="c2a44-541">Se requieren departamentos en los puestos.</span><span class="sxs-lookup"><span data-stu-id="c2a44-541">Departments are required on positions.</span></span>
- <span data-ttu-id="c2a44-542">Los centros de coste deben configurarse como dimensiones financieras y deben ser el primer elemento de la cadena de dimensión financiera predeterminada.</span><span class="sxs-lookup"><span data-stu-id="c2a44-542">Cost centers must be set as financial dimensions and must be the first element in the Default Financial Dimension string.</span></span>

### <a name="job-types"></a><span data-ttu-id="c2a44-543">Tipos de trabajo</span><span class="sxs-lookup"><span data-stu-id="c2a44-543">Job types</span></span>

<span data-ttu-id="c2a44-544">Los tipos de trabajo se utilizan para agrupar trabajos similares en categorías.</span><span class="sxs-lookup"><span data-stu-id="c2a44-544">Job types are used to group similar jobs into categories.</span></span> <span data-ttu-id="c2a44-545">Los tipos de trabajo son obligatorios para procesar la nómina en México.</span><span class="sxs-lookup"><span data-stu-id="c2a44-545">Job types are required in order to process payroll in Mexico.</span></span> <span data-ttu-id="c2a44-546">Entre los ejemplos de tipos de trabajo se incluyen jornada completa y tiempo parcial, o con sueldo y paga por horas.</span><span class="sxs-lookup"><span data-stu-id="c2a44-546">Examples of job types include full-time and part-time, or salary and hourly pay.</span></span> <span data-ttu-id="c2a44-547">Los tipos de trabajo se asignan a Dayforce como tipos de sueldo que indican si un empleado trabaja por horas o es asalariado.</span><span class="sxs-lookup"><span data-stu-id="c2a44-547">Job types are mapped to Dayforce as pay types that indicate whether an employee is hourly or salaried.</span></span>

<span data-ttu-id="c2a44-548">Los siguientes tipos de trabajo y descripciones son obligatorios.</span><span class="sxs-lookup"><span data-stu-id="c2a44-548">The following job types and descriptions are required.</span></span>

| <span data-ttu-id="c2a44-549">Tipo de trabajo</span><span class="sxs-lookup"><span data-stu-id="c2a44-549">Job type</span></span>   | <span data-ttu-id="c2a44-550">Descripción</span><span class="sxs-lookup"><span data-stu-id="c2a44-550">Description</span></span> |
|------------|-------------|
| <span data-ttu-id="c2a44-551">Por hora</span><span class="sxs-lookup"><span data-stu-id="c2a44-551">Hourly</span></span>     | <span data-ttu-id="c2a44-552">MX Por hora</span><span class="sxs-lookup"><span data-stu-id="c2a44-552">MX Hourly</span></span>   |
| <span data-ttu-id="c2a44-553">Asalariado</span><span class="sxs-lookup"><span data-stu-id="c2a44-553">Salaried</span></span>   | <span data-ttu-id="c2a44-554">MX Asalariado</span><span class="sxs-lookup"><span data-stu-id="c2a44-554">MX Salaried</span></span> |

### <a name="position-types"></a><span data-ttu-id="c2a44-555">Tipos de puestos</span><span class="sxs-lookup"><span data-stu-id="c2a44-555">Position types</span></span> 

<span data-ttu-id="c2a44-556">Use los tipos de puesto para describir si el puesto es a jornada completa, a tiempo parcial u otro tipo.</span><span class="sxs-lookup"><span data-stu-id="c2a44-556">You use position types to describe whether the position is full-time, part-time, or something else.</span></span> <span data-ttu-id="c2a44-557">Los tipos de puesto se asignan a Dayforce como clases de sueldo que indican si un empleado a jornada completa o a tiempo parcial.</span><span class="sxs-lookup"><span data-stu-id="c2a44-557">Position types are mapped to Dayforce as pay classes that indicate whether an employee is full-time or part-time.</span></span>

<span data-ttu-id="c2a44-558">Los siguientes tipos de puesto y descripciones son obligatorios.</span><span class="sxs-lookup"><span data-stu-id="c2a44-558">The following position types and descriptions are required.</span></span>

| <span data-ttu-id="c2a44-559">Tipo de puesto</span><span class="sxs-lookup"><span data-stu-id="c2a44-559">Position type</span></span>   | <span data-ttu-id="c2a44-560">Descripción</span><span class="sxs-lookup"><span data-stu-id="c2a44-560">Description</span></span>        |
|-----------------|--------------------|
| <span data-ttu-id="c2a44-561">Jornada completa</span><span class="sxs-lookup"><span data-stu-id="c2a44-561">Full-time</span></span>       | <span data-ttu-id="c2a44-562">Empleado a jornada completa</span><span class="sxs-lookup"><span data-stu-id="c2a44-562">Full time employee</span></span> |
| <span data-ttu-id="c2a44-563">A tiempo parcial</span><span class="sxs-lookup"><span data-stu-id="c2a44-563">Part-time</span></span>       | <span data-ttu-id="c2a44-564">Empleado a tiempo parcial</span><span class="sxs-lookup"><span data-stu-id="c2a44-564">Part time employee</span></span> |

### <a name="reason-codes"></a><span data-ttu-id="c2a44-565">Códigos de motivos</span><span class="sxs-lookup"><span data-stu-id="c2a44-565">Reason codes</span></span>

<span data-ttu-id="c2a44-566">Los códigos de motivos proporcionan información sobre el estado de un empleado.</span><span class="sxs-lookup"><span data-stu-id="c2a44-566">Reason codes provide information about the status of an employee.</span></span> <span data-ttu-id="c2a44-567">Los códigos de motivos se asignan a Dayforce como motivos de estado que indican el motivo de los cambios en el puesto de un empleado o su situación laboral.</span><span class="sxs-lookup"><span data-stu-id="c2a44-567">Reason codes are mapped to Dayforce as status reasons that indicate the reason for changes to an employee's position or employment status.</span></span>

<span data-ttu-id="c2a44-568">Los siguientes códigos de motivos y descripciones son obligatorios.</span><span class="sxs-lookup"><span data-stu-id="c2a44-568">The following reason codes and descriptions are required.</span></span>

| <span data-ttu-id="c2a44-569">Código de motivo</span><span class="sxs-lookup"><span data-stu-id="c2a44-569">Reason code</span></span>            | <span data-ttu-id="c2a44-570">Descripción</span><span class="sxs-lookup"><span data-stu-id="c2a44-570">Description</span></span>                    | <span data-ttu-id="c2a44-571">Situaciones aplicables</span><span class="sxs-lookup"><span data-stu-id="c2a44-571">Applicable scenarios</span></span> |
|------------------------|--------------------------------|----------------------|
| <span data-ttu-id="c2a44-572">DEPARTUREBEFOREPAYMENT</span><span class="sxs-lookup"><span data-stu-id="c2a44-572">DEPARTUREBEFOREPAYMENT</span></span> | <span data-ttu-id="c2a44-573">Salida antes de la primera nómina</span><span class="sxs-lookup"><span data-stu-id="c2a44-573">Departure before first payroll</span></span> | <span data-ttu-id="c2a44-574">Dar de baja a trabajador</span><span class="sxs-lookup"><span data-stu-id="c2a44-574">Terminate worker</span></span>     |
| <span data-ttu-id="c2a44-575">RESIGNATION</span><span class="sxs-lookup"><span data-stu-id="c2a44-575">RESIGNATION</span></span>            | <span data-ttu-id="c2a44-576">Dimisión</span><span class="sxs-lookup"><span data-stu-id="c2a44-576">Resignation</span></span>                    | <span data-ttu-id="c2a44-577">Dar de baja a trabajador</span><span class="sxs-lookup"><span data-stu-id="c2a44-577">Terminate worker</span></span>     |
| <span data-ttu-id="c2a44-578">PENSION</span><span class="sxs-lookup"><span data-stu-id="c2a44-578">PENSION</span></span>                | <span data-ttu-id="c2a44-579">Pensión</span><span class="sxs-lookup"><span data-stu-id="c2a44-579">Pension</span></span>                        | <span data-ttu-id="c2a44-580">Dar de baja a trabajador</span><span class="sxs-lookup"><span data-stu-id="c2a44-580">Terminate worker</span></span>     |
| <span data-ttu-id="c2a44-581">TERMINATION</span><span class="sxs-lookup"><span data-stu-id="c2a44-581">TERMINATION</span></span>            | <span data-ttu-id="c2a44-582">Finalización</span><span class="sxs-lookup"><span data-stu-id="c2a44-582">Termination</span></span>                    | <span data-ttu-id="c2a44-583">Dar de baja a trabajador</span><span class="sxs-lookup"><span data-stu-id="c2a44-583">Terminate worker</span></span>     |
| <span data-ttu-id="c2a44-584">JUBILACIÓN</span><span class="sxs-lookup"><span data-stu-id="c2a44-584">RETIREMENT</span></span>             | <span data-ttu-id="c2a44-585">Jubilación</span><span class="sxs-lookup"><span data-stu-id="c2a44-585">Retirement</span></span>                     | <span data-ttu-id="c2a44-586">Dar de baja a trabajador</span><span class="sxs-lookup"><span data-stu-id="c2a44-586">Terminate worker</span></span>     |
| <span data-ttu-id="c2a44-587">ABSENTEE</span><span class="sxs-lookup"><span data-stu-id="c2a44-587">ABSENTEE</span></span>               | <span data-ttu-id="c2a44-588">Ausente</span><span class="sxs-lookup"><span data-stu-id="c2a44-588">Absentee</span></span>                       | <span data-ttu-id="c2a44-589">Dar de baja a trabajador</span><span class="sxs-lookup"><span data-stu-id="c2a44-589">Terminate worker</span></span>     |
| <span data-ttu-id="c2a44-590">OTHER</span><span class="sxs-lookup"><span data-stu-id="c2a44-590">OTHER</span></span>                  | <span data-ttu-id="c2a44-591">Otros motivos</span><span class="sxs-lookup"><span data-stu-id="c2a44-591">Other Reasons</span></span>                  | <span data-ttu-id="c2a44-592">Dar de baja a trabajador</span><span class="sxs-lookup"><span data-stu-id="c2a44-592">Terminate worker</span></span>     |
| <span data-ttu-id="c2a44-593">CLOSURE</span><span class="sxs-lookup"><span data-stu-id="c2a44-593">CLOSURE</span></span>                | <span data-ttu-id="c2a44-594">Cierre de operaciones</span><span class="sxs-lookup"><span data-stu-id="c2a44-594">Business Closure</span></span>               | <span data-ttu-id="c2a44-595">Dar de baja a trabajador</span><span class="sxs-lookup"><span data-stu-id="c2a44-595">Terminate worker</span></span>     |
| <span data-ttu-id="c2a44-596">MUERTE</span><span class="sxs-lookup"><span data-stu-id="c2a44-596">DEATH</span></span>                  | <span data-ttu-id="c2a44-597">Muerte</span><span class="sxs-lookup"><span data-stu-id="c2a44-597">Death</span></span>                          | <span data-ttu-id="c2a44-598">Dar de baja a trabajador</span><span class="sxs-lookup"><span data-stu-id="c2a44-598">Terminate worker</span></span>     |
| <span data-ttu-id="c2a44-599">LEAVEOFABSENCE</span><span class="sxs-lookup"><span data-stu-id="c2a44-599">LEAVEOFABSENCE</span></span>         | <span data-ttu-id="c2a44-600">Permiso para ausentarse</span><span class="sxs-lookup"><span data-stu-id="c2a44-600">Leave of Absence</span></span>               | <span data-ttu-id="c2a44-601">Dar de baja a trabajador</span><span class="sxs-lookup"><span data-stu-id="c2a44-601">Terminate worker</span></span>     |
| <span data-ttu-id="c2a44-602">CONTRACTEND</span><span class="sxs-lookup"><span data-stu-id="c2a44-602">CONTRACTEND</span></span>            | <span data-ttu-id="c2a44-603">Fin de contrato</span><span class="sxs-lookup"><span data-stu-id="c2a44-603">End of Contract</span></span>                | <span data-ttu-id="c2a44-604">Dar de baja a trabajador</span><span class="sxs-lookup"><span data-stu-id="c2a44-604">Terminate worker</span></span>     |
| <span data-ttu-id="c2a44-605">SALARYCHANGE</span><span class="sxs-lookup"><span data-stu-id="c2a44-605">SALARYCHANGE</span></span>           | <span data-ttu-id="c2a44-606">Cambio de salario</span><span class="sxs-lookup"><span data-stu-id="c2a44-606">Change of Salary</span></span>               | <span data-ttu-id="c2a44-607">Compensación</span><span class="sxs-lookup"><span data-stu-id="c2a44-607">Compensation</span></span>         |

### <a name="terms-of-employment"></a><span data-ttu-id="c2a44-608">Condiciones laborales</span><span class="sxs-lookup"><span data-stu-id="c2a44-608">Terms of employment</span></span>

<span data-ttu-id="c2a44-609">Las condiciones laborales se usan para crear categorías de condiciones laborales.</span><span class="sxs-lookup"><span data-stu-id="c2a44-609">Terms of employment are used to create categories of employment terms.</span></span> <span data-ttu-id="c2a44-610">Las condiciones se asignan a Dayforce como valores de indicador de empleo.</span><span class="sxs-lookup"><span data-stu-id="c2a44-610">The terms are mapped to Dayforce as employment indicator values.</span></span>

<span data-ttu-id="c2a44-611">Las siguientes condiciones laborales y descripciones son obligatorias.</span><span class="sxs-lookup"><span data-stu-id="c2a44-611">The following terms of employment and descriptions are required.</span></span>

| <span data-ttu-id="c2a44-612">Condiciones laborales</span><span class="sxs-lookup"><span data-stu-id="c2a44-612">Terms of employment</span></span>   | <span data-ttu-id="c2a44-613">Descripción</span><span class="sxs-lookup"><span data-stu-id="c2a44-613">Description</span></span> |
|-----------------------|-------------|
| <span data-ttu-id="c2a44-614">Normal</span><span class="sxs-lookup"><span data-stu-id="c2a44-614">Regular</span></span>               | <span data-ttu-id="c2a44-615">Normal</span><span class="sxs-lookup"><span data-stu-id="c2a44-615">Regular</span></span>     |
| <span data-ttu-id="c2a44-616">Directo</span><span class="sxs-lookup"><span data-stu-id="c2a44-616">Direct</span></span>                | <span data-ttu-id="c2a44-617">Directo</span><span class="sxs-lookup"><span data-stu-id="c2a44-617">Direct</span></span>      |
| <span data-ttu-id="c2a44-618">Prácticas</span><span class="sxs-lookup"><span data-stu-id="c2a44-618">Internship</span></span>            | <span data-ttu-id="c2a44-619">Prácticas</span><span class="sxs-lookup"><span data-stu-id="c2a44-619">Internship</span></span>  |
| <span data-ttu-id="c2a44-620">Permanente</span><span class="sxs-lookup"><span data-stu-id="c2a44-620">Permanent</span></span>             | <span data-ttu-id="c2a44-621">Permanente</span><span class="sxs-lookup"><span data-stu-id="c2a44-621">Permanent</span></span>   |

### <a name="marital-status"></a><span data-ttu-id="c2a44-622">Estado civil</span><span class="sxs-lookup"><span data-stu-id="c2a44-622">Marital status</span></span>

<span data-ttu-id="c2a44-623">Los valores de estado civil se asignan a Dayforce y se traducen, según corresponda, a los valores aceptados tras la integración.</span><span class="sxs-lookup"><span data-stu-id="c2a44-623">Marital status values are mapped to Dayforce and translated, as appropriate, to the accepted values upon integration.</span></span>

<span data-ttu-id="c2a44-624">En la siguiente tabla se muestra cómo los valores de estado civil se asignan a Dayforce.</span><span class="sxs-lookup"><span data-stu-id="c2a44-624">The following table shows how marital status values are mapped to Dayforce.</span></span>

| <span data-ttu-id="c2a44-625">Recursos humanos</span><span class="sxs-lookup"><span data-stu-id="c2a44-625">Human Resources</span></span>                 | <span data-ttu-id="c2a44-626">Dayforce</span><span class="sxs-lookup"><span data-stu-id="c2a44-626">Dayforce</span></span>                  |
|------------------------|---------------------------|
| <span data-ttu-id="c2a44-627">Casado/a</span><span class="sxs-lookup"><span data-stu-id="c2a44-627">Married</span></span>                | <span data-ttu-id="c2a44-628">Casado/a</span><span class="sxs-lookup"><span data-stu-id="c2a44-628">Married</span></span>                   |
| <span data-ttu-id="c2a44-629">Único</span><span class="sxs-lookup"><span data-stu-id="c2a44-629">Single</span></span>                 | <span data-ttu-id="c2a44-630">Único</span><span class="sxs-lookup"><span data-stu-id="c2a44-630">Single</span></span>                    |
| <span data-ttu-id="c2a44-631">Viudo/a</span><span class="sxs-lookup"><span data-stu-id="c2a44-631">Widowed</span></span>                | <span data-ttu-id="c2a44-632">Viudo/a</span><span class="sxs-lookup"><span data-stu-id="c2a44-632">Widowed</span></span>                   |
| <span data-ttu-id="c2a44-633">Divorciado/a</span><span class="sxs-lookup"><span data-stu-id="c2a44-633">Divorced</span></span>               | <span data-ttu-id="c2a44-634">Divorciado/a</span><span class="sxs-lookup"><span data-stu-id="c2a44-634">Divorced</span></span>                  |
| <span data-ttu-id="c2a44-635">Unión registrada</span><span class="sxs-lookup"><span data-stu-id="c2a44-635">Registered Partnership</span></span> | <span data-ttu-id="c2a44-636">Sociedad doméstica</span><span class="sxs-lookup"><span data-stu-id="c2a44-636">Domestic Partnership</span></span>      |
| <span data-ttu-id="c2a44-637">Sin ordenar</span><span class="sxs-lookup"><span data-stu-id="c2a44-637">None</span></span>                   | <span data-ttu-id="c2a44-638">*No se admite en México*</span><span class="sxs-lookup"><span data-stu-id="c2a44-638">*Not supported by Mexico*</span></span> |
| <span data-ttu-id="c2a44-639">Cohabitando</span><span class="sxs-lookup"><span data-stu-id="c2a44-639">Cohabiting</span></span>             | <span data-ttu-id="c2a44-640">*No se admite en México*</span><span class="sxs-lookup"><span data-stu-id="c2a44-640">*Not supported by Mexico*</span></span> |

### <a name="gender"></a><span data-ttu-id="c2a44-641">Género</span><span class="sxs-lookup"><span data-stu-id="c2a44-641">Gender</span></span>

<span data-ttu-id="c2a44-642">Las designaciones de género se asignan a Dayforce y se traducen, según corresponda, a los valores aceptados tras la integración.</span><span class="sxs-lookup"><span data-stu-id="c2a44-642">Gender designations are mapped to Dayforce and translated, as appropriate, to the accepted values upon integration.</span></span>

<span data-ttu-id="c2a44-643">En la siguiente tabla se muestra cómo las designaciones de género se asignan a Dayforce.</span><span class="sxs-lookup"><span data-stu-id="c2a44-643">The following table shows how gender designations are mapped to Dayforce.</span></span>

| <span data-ttu-id="c2a44-644">Recursos humanos</span><span class="sxs-lookup"><span data-stu-id="c2a44-644">Human Resources</span></span>       | <span data-ttu-id="c2a44-645">Dayforce</span><span class="sxs-lookup"><span data-stu-id="c2a44-645">Dayforce</span></span>                  |
|--------------|---------------------------|
| <span data-ttu-id="c2a44-646">Masculino</span><span class="sxs-lookup"><span data-stu-id="c2a44-646">Male</span></span>         | <span data-ttu-id="c2a44-647">Masculino</span><span class="sxs-lookup"><span data-stu-id="c2a44-647">Male</span></span>                      |
| <span data-ttu-id="c2a44-648">Femenino</span><span class="sxs-lookup"><span data-stu-id="c2a44-648">Female</span></span>       | <span data-ttu-id="c2a44-649">Femenino</span><span class="sxs-lookup"><span data-stu-id="c2a44-649">Female</span></span>                    |
| <span data-ttu-id="c2a44-650">No específico</span><span class="sxs-lookup"><span data-stu-id="c2a44-650">Non-specific</span></span> | <span data-ttu-id="c2a44-651">*No se admite en México*</span><span class="sxs-lookup"><span data-stu-id="c2a44-651">*Not supported by Mexico*</span></span> |

### <a name="payment-method"></a><span data-ttu-id="c2a44-652">Método de pago</span><span class="sxs-lookup"><span data-stu-id="c2a44-652">Payment method</span></span>

<span data-ttu-id="c2a44-653">Los métodos de pago ofrecen al empleado y la empresa una forma de describir cómo se pagará a los empleados.</span><span class="sxs-lookup"><span data-stu-id="c2a44-653">Payment methods give the employee and the company a way to describe how employees will be paid.</span></span> <span data-ttu-id="c2a44-654">Los métodos de pago se asignan a Dayforce y se traducen, según corresponda, a los valores aceptados tras la integración.</span><span class="sxs-lookup"><span data-stu-id="c2a44-654">Payment methods are mapped to Dayforce and translated, as appropriate, to the accepted values upon integration.</span></span>

<span data-ttu-id="c2a44-655">En la siguiente tabla se muestra cómo los métodos de pago se asignan a Dayforce.</span><span class="sxs-lookup"><span data-stu-id="c2a44-655">The following table shows how payment methods are mapped to Dayforce.</span></span>

| <span data-ttu-id="c2a44-656">Recursos humanos</span><span class="sxs-lookup"><span data-stu-id="c2a44-656">Human Resources</span></span>             | <span data-ttu-id="c2a44-657">Dayforce</span><span class="sxs-lookup"><span data-stu-id="c2a44-657">Dayforce</span></span>                  |
|--------------------|---------------------------|
| <span data-ttu-id="c2a44-658">Efectivo</span><span class="sxs-lookup"><span data-stu-id="c2a44-658">Cash</span></span>               | <span data-ttu-id="c2a44-659">Efectivo</span><span class="sxs-lookup"><span data-stu-id="c2a44-659">Cash</span></span>                      |
| <span data-ttu-id="c2a44-660">Pago electrónico</span><span class="sxs-lookup"><span data-stu-id="c2a44-660">Electronic Payment</span></span> | <span data-ttu-id="c2a44-661">Transferir</span><span class="sxs-lookup"><span data-stu-id="c2a44-661">Transfer</span></span>                  |
| <span data-ttu-id="c2a44-662">Comprobación</span><span class="sxs-lookup"><span data-stu-id="c2a44-662">Check</span></span>              | <span data-ttu-id="c2a44-663">Cheque</span><span class="sxs-lookup"><span data-stu-id="c2a44-663">Cheque</span></span>                    |
| <span data-ttu-id="c2a44-664">Efecto bancario</span><span class="sxs-lookup"><span data-stu-id="c2a44-664">Bank Draft</span></span>         | <span data-ttu-id="c2a44-665">*No se admite en México*</span><span class="sxs-lookup"><span data-stu-id="c2a44-665">*Not supported by Mexico*</span></span> |
| <span data-ttu-id="c2a44-666">Otras</span><span class="sxs-lookup"><span data-stu-id="c2a44-666">Other</span></span>              | <span data-ttu-id="c2a44-667">*No se admite en México*</span><span class="sxs-lookup"><span data-stu-id="c2a44-667">*Not supported by Mexico*</span></span> |

### <a name="bank-account-type"></a><span data-ttu-id="c2a44-668">Tipo de cuenta bancaria</span><span class="sxs-lookup"><span data-stu-id="c2a44-668">Bank account type</span></span>

<span data-ttu-id="c2a44-669">Los tipos de cuenta bancaria se usan para los pagos electrónicos a los empleados.</span><span class="sxs-lookup"><span data-stu-id="c2a44-669">Bank account types are used for electronic payments to employees.</span></span> <span data-ttu-id="c2a44-670">Los tipos de cuenta bancaria se asignan a Dayforce como información de cuenta de transferencia.</span><span class="sxs-lookup"><span data-stu-id="c2a44-670">Bank account types are mapped to Dayforce as transfer account information.</span></span> <span data-ttu-id="c2a44-671">Los tipos de cuenta bancaria se convierten, según proceda, en los valores aceptados en la integración.</span><span class="sxs-lookup"><span data-stu-id="c2a44-671">The bank account types are translated, as appropriate, to the accepted values upon integration.</span></span>

| <span data-ttu-id="c2a44-672">Recursos humanos</span><span class="sxs-lookup"><span data-stu-id="c2a44-672">Human Resources</span></span>            | <span data-ttu-id="c2a44-673">Dayforce</span><span class="sxs-lookup"><span data-stu-id="c2a44-673">Dayforce</span></span>                  |
|-------------------|---------------------------|
| <span data-ttu-id="c2a44-674">Cuenta corriente</span><span class="sxs-lookup"><span data-stu-id="c2a44-674">Checking Account</span></span>  | <span data-ttu-id="c2a44-675">CheckingAccount</span><span class="sxs-lookup"><span data-stu-id="c2a44-675">CheckingAccount</span></span>           |
| <span data-ttu-id="c2a44-676">Cuenta de nómina</span><span class="sxs-lookup"><span data-stu-id="c2a44-676">Payroll Account</span></span>   | <span data-ttu-id="c2a44-677">PayrollAccount</span><span class="sxs-lookup"><span data-stu-id="c2a44-677">PayrollAccount</span></span>            |
| <span data-ttu-id="c2a44-678">Cuenta de ahorros</span><span class="sxs-lookup"><span data-stu-id="c2a44-678">Savings Account</span></span>   | <span data-ttu-id="c2a44-679">*No se admite en México*</span><span class="sxs-lookup"><span data-stu-id="c2a44-679">*Not supported by Mexico*</span></span> |
| <span data-ttu-id="c2a44-680">Cuenta de BankGirot</span><span class="sxs-lookup"><span data-stu-id="c2a44-680">BankGirot account</span></span> | <span data-ttu-id="c2a44-681">*No se admite en México*</span><span class="sxs-lookup"><span data-stu-id="c2a44-681">*Not supported by Mexico*</span></span> |
| <span data-ttu-id="c2a44-682">Cuenta de PlusGirot</span><span class="sxs-lookup"><span data-stu-id="c2a44-682">PlusGirot account</span></span> | <span data-ttu-id="c2a44-683">*No se admite en México*</span><span class="sxs-lookup"><span data-stu-id="c2a44-683">*Not supported by Mexico*</span></span> |

### <a name="earning-codes"></a><span data-ttu-id="c2a44-684">Códigos de ganancia</span><span class="sxs-lookup"><span data-stu-id="c2a44-684">Earning codes</span></span>

<span data-ttu-id="c2a44-685">Los códigos de ganancias identifican de forma exclusiva cada tipo de ganancias que reciben trabajadores.</span><span class="sxs-lookup"><span data-stu-id="c2a44-685">Earning codes uniquely identify every type of earnings that workers receive.</span></span> <span data-ttu-id="c2a44-686">Los códigos abarcan varios parámetros relacionados con las ganancias, como las reglas de contabilidad, las leyes tributarias, los requisitos de informes y la capacidad de valor bruto.</span><span class="sxs-lookup"><span data-stu-id="c2a44-686">The codes cover several parameters that are related to earnings, such as accounting rules, tax laws, reporting requirements, and gross-up capability.</span></span> <span data-ttu-id="c2a44-687">Si se usa una frecuencia no admitida, la frecuencia **Cada sueldo** se utiliza de forma predeterminada para el cálculo.</span><span class="sxs-lookup"><span data-stu-id="c2a44-687">If an unsupported frequency is used, the **Every Pay** frequency is used by default for the calculation.</span></span>

#### <a name="supported-frequencies"></a><span data-ttu-id="c2a44-688">Frecuencias admitidas</span><span class="sxs-lookup"><span data-stu-id="c2a44-688">Supported frequencies</span></span>

- <span data-ttu-id="c2a44-689">Todas</span><span class="sxs-lookup"><span data-stu-id="c2a44-689">All</span></span>
- <span data-ttu-id="c2a44-690">EVERYPAY</span><span class="sxs-lookup"><span data-stu-id="c2a44-690">EVERYPAY</span></span>
- <span data-ttu-id="c2a44-691">EACHPAYPERIOD</span><span class="sxs-lookup"><span data-stu-id="c2a44-691">EACHPAYPERIOD</span></span>
- <span data-ttu-id="c2a44-692">EVRYOTHRPAYODD</span><span class="sxs-lookup"><span data-stu-id="c2a44-692">EVRYOTHRPAYODD</span></span>
- <span data-ttu-id="c2a44-693">EVRYOTHRPAYEVN</span><span class="sxs-lookup"><span data-stu-id="c2a44-693">EVRYOTHRPAYEVN</span></span>
- <span data-ttu-id="c2a44-694">1OFMTH</span><span class="sxs-lookup"><span data-stu-id="c2a44-694">1OFMTH</span></span>
- <span data-ttu-id="c2a44-695">LASTOFMTH</span><span class="sxs-lookup"><span data-stu-id="c2a44-695">LASTOFMTH</span></span>
- <span data-ttu-id="c2a44-696">2OFMTH</span><span class="sxs-lookup"><span data-stu-id="c2a44-696">2OFMTH</span></span>
- <span data-ttu-id="c2a44-697">3OFMTH</span><span class="sxs-lookup"><span data-stu-id="c2a44-697">3OFMTH</span></span>
- <span data-ttu-id="c2a44-698">4OFMTH</span><span class="sxs-lookup"><span data-stu-id="c2a44-698">4OFMTH</span></span>
- <span data-ttu-id="c2a44-699">5OFMTH</span><span class="sxs-lookup"><span data-stu-id="c2a44-699">5OFMTH</span></span>
- <span data-ttu-id="c2a44-700">1N2OFMTH</span><span class="sxs-lookup"><span data-stu-id="c2a44-700">1N2OFMTH</span></span>
- <span data-ttu-id="c2a44-701">3N4OFMTH</span><span class="sxs-lookup"><span data-stu-id="c2a44-701">3N4OFMTH</span></span>
- <span data-ttu-id="c2a44-702">1N3OFMTH</span><span class="sxs-lookup"><span data-stu-id="c2a44-702">1N3OFMTH</span></span>
- <span data-ttu-id="c2a44-703">1N4OFMTH</span><span class="sxs-lookup"><span data-stu-id="c2a44-703">1N4OFMTH</span></span>
- <span data-ttu-id="c2a44-704">2N3OFMTH</span><span class="sxs-lookup"><span data-stu-id="c2a44-704">2N3OFMTH</span></span>
- <span data-ttu-id="c2a44-705">2N4OFMTH</span><span class="sxs-lookup"><span data-stu-id="c2a44-705">2N4OFMTH</span></span>
- <span data-ttu-id="c2a44-706">1N2N3OFMTH</span><span class="sxs-lookup"><span data-stu-id="c2a44-706">1N2N3OFMTH</span></span>
- <span data-ttu-id="c2a44-707">1N2N4OFMTH</span><span class="sxs-lookup"><span data-stu-id="c2a44-707">1N2N4OFMTH</span></span>
- <span data-ttu-id="c2a44-708">1N3N4OFMTH</span><span class="sxs-lookup"><span data-stu-id="c2a44-708">1N3N4OFMTH</span></span>
- <span data-ttu-id="c2a44-709">2N3N4OFMTH</span><span class="sxs-lookup"><span data-stu-id="c2a44-709">2N3N4OFMTH</span></span>
- <span data-ttu-id="c2a44-710">1N2N3N4OFMTH - 1N2N3N4OFMTH</span><span class="sxs-lookup"><span data-stu-id="c2a44-710">1N2N3N4OFMTH - 1N2N3N4OFMTH</span></span>
- <span data-ttu-id="c2a44-711">2N3N4N5OFMth - 2N3N4N5OFMth</span><span class="sxs-lookup"><span data-stu-id="c2a44-711">2N3N4N5OFMth - 2N3N4N5OFMth</span></span>
- <span data-ttu-id="c2a44-712">1OFQTR - 1OFQTR</span><span class="sxs-lookup"><span data-stu-id="c2a44-712">1OFQTR - 1OFQTR</span></span>
- <span data-ttu-id="c2a44-713">LASTOFQTR – LASTOFQTR</span><span class="sxs-lookup"><span data-stu-id="c2a44-713">LASTOFQTR – LASTOFQTR</span></span>
- <span data-ttu-id="c2a44-714">LASTMTHOFQTR – LASTMTHOFQTR</span><span class="sxs-lookup"><span data-stu-id="c2a44-714">LASTMTHOFQTR – LASTMTHOFQTR</span></span>
- <span data-ttu-id="c2a44-715">1OFYEAR - 1OFYEAR</span><span class="sxs-lookup"><span data-stu-id="c2a44-715">1OFYEAR - 1OFYEAR</span></span>
- <span data-ttu-id="c2a44-716">LASTOFYEAR – LASTOFYEAR</span><span class="sxs-lookup"><span data-stu-id="c2a44-716">LASTOFYEAR – LASTOFYEAR</span></span>
- <span data-ttu-id="c2a44-717">NOVNDECOFYEAR - NOVNDECOFYEAR</span><span class="sxs-lookup"><span data-stu-id="c2a44-717">NOVNDECOFYEAR - NOVNDECOFYEAR</span></span>

### <a name="addresses"></a><span data-ttu-id="c2a44-718">Direcciones</span><span class="sxs-lookup"><span data-stu-id="c2a44-718">Addresses</span></span>

<span data-ttu-id="c2a44-719">La identificación de códigos específicos de país o región, estado y condado (municipio) requiere formatos específicos que los proveedores de Dayforce y en el país o región puedan reconocer.</span><span class="sxs-lookup"><span data-stu-id="c2a44-719">The identification of specific country or region, state, and county (municipality) codes requires specific formats that Dayforce and in-country/in-region providers can recognize.</span></span> <span data-ttu-id="c2a44-720">Aunque el formato de las ciudades sea flexible, cada una debe asociarse a un estado.</span><span class="sxs-lookup"><span data-stu-id="c2a44-720">Although the format for cities is flexible, every city must be associated with a state.</span></span>

| <span data-ttu-id="c2a44-721">Recursos humanos</span><span class="sxs-lookup"><span data-stu-id="c2a44-721">Human Resources</span></span>              | <span data-ttu-id="c2a44-722">Dayforce</span><span class="sxs-lookup"><span data-stu-id="c2a44-722">Dayforce</span></span>              |
|---------------------|-----------------------|
| <span data-ttu-id="c2a44-723">País/región</span><span class="sxs-lookup"><span data-stu-id="c2a44-723">Country/Region</span></span>      | <span data-ttu-id="c2a44-724">Código de país</span><span class="sxs-lookup"><span data-stu-id="c2a44-724">Country Code</span></span>          |
| <span data-ttu-id="c2a44-725">Código postal</span><span class="sxs-lookup"><span data-stu-id="c2a44-725">Zip/Postal Code</span></span>     | <span data-ttu-id="c2a44-726">Código postal</span><span class="sxs-lookup"><span data-stu-id="c2a44-726">Postal Code</span></span>           |
| <span data-ttu-id="c2a44-727">Comunidad autónoma</span><span class="sxs-lookup"><span data-stu-id="c2a44-727">State</span></span>               | <span data-ttu-id="c2a44-728">Código de la comunidad autónoma</span><span class="sxs-lookup"><span data-stu-id="c2a44-728">State Code</span></span>            |
| <span data-ttu-id="c2a44-729">Población</span><span class="sxs-lookup"><span data-stu-id="c2a44-729">City</span></span>                | <span data-ttu-id="c2a44-730">Población</span><span class="sxs-lookup"><span data-stu-id="c2a44-730">City</span></span>                  |
| <span data-ttu-id="c2a44-731">Comarca</span><span class="sxs-lookup"><span data-stu-id="c2a44-731">County</span></span>              | <span data-ttu-id="c2a44-732">Condado (municipio)</span><span class="sxs-lookup"><span data-stu-id="c2a44-732">County (Municipality)</span></span> |
| <span data-ttu-id="c2a44-733">Calle</span><span class="sxs-lookup"><span data-stu-id="c2a44-733">Street</span></span>              | <span data-ttu-id="c2a44-734">Línea de dirección 1</span><span class="sxs-lookup"><span data-stu-id="c2a44-734">Address Line 1</span></span>        |
| <span data-ttu-id="c2a44-735">Número de calle</span><span class="sxs-lookup"><span data-stu-id="c2a44-735">Street Number</span></span>       | <span data-ttu-id="c2a44-736">Línea de dirección 2</span><span class="sxs-lookup"><span data-stu-id="c2a44-736">Address Line 2</span></span>        |
| <span data-ttu-id="c2a44-737">Complemento de edificio</span><span class="sxs-lookup"><span data-stu-id="c2a44-737">Building Complement</span></span> | <span data-ttu-id="c2a44-738">Línea de dirección 5</span><span class="sxs-lookup"><span data-stu-id="c2a44-738">Address Line 5</span></span>        |

### <a name="passport-number"></a><span data-ttu-id="c2a44-739">Número de pasaporte</span><span class="sxs-lookup"><span data-stu-id="c2a44-739">Passport number</span></span>

<span data-ttu-id="c2a44-740">Los empleados pueden declarar la información del pasaporte.</span><span class="sxs-lookup"><span data-stu-id="c2a44-740">Employees can declare passport information.</span></span> <span data-ttu-id="c2a44-741">Esta información es del tipo de identificación **Pasaporte** y se integra en Dayforce como parte de la información específica de México de un empleado.</span><span class="sxs-lookup"><span data-stu-id="c2a44-741">This information is of the **Passport** identification type and is integrated into Dayforce as part of an employee's Mexico-specific information.</span></span>

- <span data-ttu-id="c2a44-742">Tipo de identificación = "Pasaporte"</span><span class="sxs-lookup"><span data-stu-id="c2a44-742">Identification Type = "Passport"</span></span>
- <span data-ttu-id="c2a44-743">Fecha de emisión</span><span class="sxs-lookup"><span data-stu-id="c2a44-743">Issued Date</span></span>
- <span data-ttu-id="c2a44-744">Fecha de vencimiento</span><span class="sxs-lookup"><span data-stu-id="c2a44-744">Expiration Date</span></span>

<span data-ttu-id="c2a44-745">Los empleados pueden declarar números de identificación múltiples del tipo de identificación del **Pasaporte**.</span><span class="sxs-lookup"><span data-stu-id="c2a44-745">Employees can declare multiple identification numbers of the **Passport** identification type.</span></span> <span data-ttu-id="c2a44-746">Sin embargo, solo la entrada de pasaporte activa actual se integra en Dayforce.</span><span class="sxs-lookup"><span data-stu-id="c2a44-746">However, only the current active passport entry is integrated into Dayforce.</span></span> <span data-ttu-id="c2a44-747">Si todas las entradas de pasaporte han caducado, el pasaporte que se emitió más recientemente se integra en Dayforce.</span><span class="sxs-lookup"><span data-stu-id="c2a44-747">If all passport entries are expired, the passport that was most recently issued is integrated into Dayforce.</span></span>
