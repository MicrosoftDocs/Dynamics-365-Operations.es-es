...
description: Este artículo describe las características que son nuevas o que se han cambiado en Microsoft Dynamics 365 Human Resources para el 22 de octubre de 2020.
author: jcart1106
ms.date: 10/22/2020
ms.topic: article
ms.prod: ''
...
| --- | --- | --- |
| Platform update 10.0.14(38) | -- | [Actualizaciones de plataforma para aplicaciones de la versión 10.0.14 de finanzas y operaciones (noviembre de 2020)](../fin-ops-core/dev-itpro/get-started/whats-new-platform-updates-10-0-14.md) |
