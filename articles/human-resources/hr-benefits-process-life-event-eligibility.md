...
description: En este tema se explica cómo procesar la idoneidad de eventos de vida.
author: twheeloc
ms.date: 08/23/2021
ms.topic: article
ms.prod: ''
...
En este tema se explica cómo procesar la idoneidad de eventos de vida.

1. En el espacio de trabajo **Administración de prestaciones**, en **Procesamiento**, seleccione **Procesamiento de idoneidad de eventos de vida**.

2. En el cuadro de diálogo **Ejecutar proceso de idoneidad de evento de vida**, especifique valores para los siguientes campos:

   | Campo | Descripción |
   | --- | --- |
   | **Período de inscripción** | El periodo de inscripción para procesar la idoneidad de evento de vida. |
