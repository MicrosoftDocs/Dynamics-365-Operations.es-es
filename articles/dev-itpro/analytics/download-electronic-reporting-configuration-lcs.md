...
9. Haga clic en **Importar** para descargar la versión seleccionada de LCS a la instancia actual de Finance and Operations.

    > [!NOTE]
    > El botón **Importar** no está disponible para las versiones de configuración de ER que ya están presentes en la instancia actual de Finance and Operations.
