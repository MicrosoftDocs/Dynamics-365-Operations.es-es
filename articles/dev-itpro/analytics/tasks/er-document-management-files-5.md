...
---
# <a name="modify-and-run-formats-to-use-document-management-files-in-er-output"></a>Modificar y ejecutar formatos para usar archivos de administración de documentos en la salida de ER
