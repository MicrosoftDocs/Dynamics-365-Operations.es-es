...
37. Cierre la página. 
38. Cierre la página. 
39. Cuando tenga que ampliar el conjunto de metadatos existente, puede hacerlo en Finance and Operations. A continuación, puede exportar la nueva versión completada de la configuración de metadatos de ER desde Finance and Operations, importarla en RCS y actualizar los requisitos previos de la configuración de asignación del modelo configurado que hacen referencia a una nueva versión de la configuración de los metadatos importados. 

> [!NOTE]
> Esta forma de obtener información sobre metadatos de la aplicación es la única disponible para aplicaciones implementadas localmente (cuando se utiliza un modelo de implementación de datos empresariales locales (LBD), o en las instalaciones, para Dynamics 365 for Finance and Operations).
