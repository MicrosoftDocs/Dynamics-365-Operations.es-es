...
9. En el árbol, expanda **format\root: XML Element(raíz)**.
10. En el árbol, seleccione **format\root: XML Element(raíz)\document: XML Element 1..* (documento)**.
11. Haga clic en **Enlazar**.
12. En el árbol, expanda **format\root: XML Element(raíz)\document: XML Element 1..* (documento)**.
13. En el árbol, seleccione **format\root: XML Element(raíz)\document: XML Element 1..* (documento)\id**.
