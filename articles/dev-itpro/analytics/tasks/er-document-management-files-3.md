...
---
# <a name="create-formats-to-use-document-management-files-in-er-output"></a>Crear formatos para usar archivos de administración de documentos en la salida de ER
