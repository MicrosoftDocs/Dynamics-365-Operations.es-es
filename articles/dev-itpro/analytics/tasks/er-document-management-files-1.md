...
---
# <a name="prepare-data-models-to-use-document-management-files-in-er-output"></a>Preparar modelos de datos para usar archivos de administración de documentos en la salida de ER
