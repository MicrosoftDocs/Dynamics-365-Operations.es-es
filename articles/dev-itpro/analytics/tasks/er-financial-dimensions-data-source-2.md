...
---
# <a name="map-models--to-use-financial-dimensions-as-a-data-source-for-electronic-reporting-er"></a>Asignar modelos para usar dimensiones financieras como origen de datos para informes electrónicos (ER)
