...
También debe completar el procedimiento [Crear un proveedor de la configuración y marcarlo como activo](tasks/er-configuration-provider-mark-it-active-2016-11.md).

Finalmente, deberá descargar los archivos siguientes de [CustomerSource](https://go.microsoft.com/fwlink/?linkid=874111).

| Descripción del contenido                       | Nombre de archivo                                     |
|-------------------------------------------|-----------------------------------------------|
| Plantilla para la primera página del informe | [IntrastatReportTemplate1.pdf](https://mbs.microsoft.com/Files/public/CS)                  |
| Plantilla para las otras páginas del informe    | [IntrastatReportTemplate2.pdf](https://mbs.microsoft.com/Files/public/CS/AX/IntrastatReportTemplate2.pdf)                  |
| Formato de ER de ejemplo - PDF                          | [Informe Intrastat (PDF).version.1.1.xm](https://mbs.microsoft.com/Files/public/CS/AX/IntrastatreportPDFversion11.xml)        |
| Formato ER de ejemplo - Excel                          | [Intrastat (importar desde Excel).version.1.1.xml](https://mbs.microsoft.com/Files/public/CS/AX/IntrastatimportfromExcelversion11.xml) |
| Conjunto de datos de ejemplo                            | [Ejemplo instrastat data.xlsx](https://mbs.microsoft.com/Files/public/CS/AX/Intrastatsampledata.xlsx)                    |
...
- [ER Diseñar una configuración para generar informes en formato OPENXML](tasks/er-design-reports-openxml-2016-11.md)
- [Diseñar configuraciones de ER para generar informes en formato Microsoft Word](tasks/er-design-configuration-word-2016-11.md)
