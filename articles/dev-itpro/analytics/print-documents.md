---
title: "Impresión en las solicitudes de Finance and Operations"
...
# <a name="printing-in-finance-and-operations-applications"></a>Impresión en las solicitudes de Finance and Operations
...
|---------------------------------|-----------------------------------------------------------|---------------------------------------------------------------------------------------------------------------------|
| 1. Imprimir lo que ve        | Imprima lo que se muestra actualmente en el explorador.             | Se genera una versión “imprimible” de la página web para el explorador.                                             |
...
| 3. Impresión en un dispositivo de red | Envíe un documento de precisión a una impresora de dominio.     | Un documento de precisión se envía a una aplicación cliente que se ejecute en un servidor que se hospeda en el dominio del cliente. |
