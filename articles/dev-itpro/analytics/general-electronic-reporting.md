...
### <a name="configuring-finance-and-operations-to-start-to-use-a-created-format-internally"></a>Configuración de Finance and Operations para comenzar a usar un formato creado internamente
