...
Esta plantilla sincroniza la información de maestro de cliente para los clientes comerciales y organizativos entre Finance and Operations y Common Data Service.
...
Esta plantilla sincroniza los datos maestros del cliente para los consumidores y usuarios finales entre Finance and Operations y Customer Engagement.
...
Esta plantilla sincroniza toda la información de contacto princpal, secundaria y terciaria para clientes y proveedores entre Finance and Operations y Customer Engagement.
...
Esta plantilla sincroniza la información de grupo de clientes entre Finance and Operations y Customer Engagement.
...
Esta plantilla sincroniza la información de método de pago de cliente entre Finance and Operations y Customer Engagement.
...
Esta plantilla sincroniza la información de tarjetas de fidelización de cliente entre Finance and Operations y Customer Engagement.
...
Esta plantilla sincroniza los datos de referencia de multivencimientos para clientes y proveedores entre Finance and Operations y Customer Engagement.
...
Sincroniza los datos de referencia de las líneas de multivencimientos para clientes y proveedores entre Finance and Operations y Customer Engagement.
...
Esta plantilla sincroniza los datos de referencia de días de pago para clientes y proveedores entre Finance and Operations y Customer Engagement.
...
Esta plantilla sincroniza los datos de referencia de las líneas de días de pago para clientes y proveedores entre Finance and Operations y Customer Engagement.
...
Esta plantilla sincroniza los datos de referencia de las condiciones de pago (términos de pago) para clientes y proveedores entre Finance and Operations y Customer Engagement.
...
Esta plantilla sincroniza los datos de referencia de afijos de nombre para clientes y proveedores entre Finance and Operations y Customer Engagement.
