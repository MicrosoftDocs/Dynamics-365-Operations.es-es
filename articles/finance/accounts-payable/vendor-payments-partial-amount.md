...
Puede devolver algunos de los artículos de una factura y recibir una nota de abono. Si el descuento por pronto pago se ha tomado de la factura original, puede restar el valor del descuento y recibir una devolución por el importe correcto. Si la opción **Calcular descuentos por pronto pago para notas de abono** está definida en **Sí** en la página **Parámetros de proveedores**, se calcula automáticamente el descuento para la nota de abono. 
