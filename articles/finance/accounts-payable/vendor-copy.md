...
description: En este artículo se explica cómo usar secuencias numéricas compartidas para copiar un proveedor en otra entidad jurídica pero conservando el mismo id. de proveedor.
author: sunfzam
ms.date: 08/24/2018
ms.topic: index-page
ms.prod: ''
