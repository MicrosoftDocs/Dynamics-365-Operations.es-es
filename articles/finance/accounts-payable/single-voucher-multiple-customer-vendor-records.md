...
| Comprobante | Tipo de cuenta | Cuenta  | Descripción | Débito | Crédito |
|-------------|------------------|--------------|-----------------|-----------|------------|
...
| Comprobante | Cuenta  | Tipo de registro | Importe en divisa de la transacción |
|-------------|--------------|------------------|------------------------------------|
...
| Comprobante | Cuenta  | Tipo de registro     | Débito | Crédito |
|-------------|--------------|----------------------|-----------|------------|
...
| Comprobante | Tipo de cuenta | Cuenta  | Descripción | Débito | Crédito | Tipo de contrapartida | Cuenta de contrapartida |
|-------------|------------------|--------------|-----------------|-----------|------------|-----------------|--------------------|
...
| Comprobante | Tipo de cuenta | Cuenta | Descripción | Débito | Crédito | Tipo de cuenta | Cuenta  |
|-------------|------------------|-------------|-----------------|-----------|------------|------------------|--------------|
...
| Comprobante | Cuenta  | Tipo de registro | Importe en la divisa de transacción (EUR) | Importe en la divisa de contabilidad (USD) |
|-------------|--------------|------------------|------------------------------------------|-----------------------------------------|
...
Dos situaciones de uso general que utilizan un documento que contiene varios clientes o proveedores incluyen las transferencias de saldos de un lciente/proveedor a otro cliente/proveedor, y la compensación de un cliente y un proveedor que son la misma organización. Los dos ejemplos siguientes muestran el método preferido para especificar estas situaciones, como alternativa a incorporarlas en un documento. 
...
A continuación, el usuario transfiere el saldo pendiente de ACME a la empresa aseguradora, en un documento del diario de pago de cuentas de clientes. Configurar la empresa aseguradora como seguro del cliente.
