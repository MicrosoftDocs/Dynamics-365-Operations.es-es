...
5. En la lista de configuración, busque **Modelo de conciliación avanzado de extracto bancario \> Formato ABR BAI2**.
...
>[!NOTE]
>El **Modelo de extracto bancario de BAI2** quedará en desuso en una fecha posterior. 
