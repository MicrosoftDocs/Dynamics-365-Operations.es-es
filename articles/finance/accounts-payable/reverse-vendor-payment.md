...
description: Este artículo describe las diferencias entre la inversión, la eliminación, la anulación y el rechazo de un pago y cómo revertir un cheque de proveedor.
author: angelad116
ms.date: 10/24/2022
ms.topic: article
ms.prod: ''
...
ms.locfileid: "9715813"
---
# <a name="reverse-a-vendor-payment"></a>Reversión de un pago de proveedor
