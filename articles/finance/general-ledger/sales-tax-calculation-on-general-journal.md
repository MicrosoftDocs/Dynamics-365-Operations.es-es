...
description: Este artículo explica cómo se calculan los impuestos para distintos tipos de cuentas (proveedor, cliente, contabilidad, y proyecto) en las líneas del diario general.
author: EricWangChen
ms.date: 02/16/2022
ms.topic: article
ms.prod: ''
...
ms.locfileid: "8845298"
---
# <a name="sales-tax-calculation-on-general-journal-lines"></a>Cálculo de impuestos en líneas de diario generales
[!include [banner](../includes/banner.md)]

Este artículo explica cómo se calculan los impuestos para distintos tipos de cuentas (proveedor, cliente, contabilidad, y proyecto) en las líneas del diario general.
