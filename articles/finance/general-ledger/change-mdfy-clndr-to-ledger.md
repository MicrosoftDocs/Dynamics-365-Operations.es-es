...
description: En este artículo se explica cómo cambiar el calendario que está asignado actualmente a un libro mayor y cómo asignar un nuevo calendario al libro mayor.
author: kweekley
ms.date: 05/07/2021
ms.topic: index-page
ms.prod: ''
...
ms.locfileid: "8848617"
---
# <a name="change-or-reassign-a-ledger-calendar"></a>Cambiar o reasignar un calendario de libro mayor

[!include [banner](../includes/banner.md)]

En este artículo se explica cómo cambiar el calendario que está asignado actualmente a un libro mayor y cómo asignar un nuevo calendario al libro mayor.
