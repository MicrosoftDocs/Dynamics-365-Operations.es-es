...
description: Este artículo proporciona información sobre las mejoras que afectan las liquidaciones del libro mayor y el cierre de fin de año del Libro mayor.
author: kweekley
ms.date: 04/06/2022
ms.topic: article
ms.prod: ''
