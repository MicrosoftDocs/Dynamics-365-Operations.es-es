...
description: Este artículo proporciona información de resolución de problemas relacionada con el rendimiento del cálculo de impuestos y su efecto en las transacciones.
author: shtao
ms.date: 04/07/2021
ms.topic: article
ms.prod: ''
