...
La creación de una WBS es un proceso intensivo que se realiza normalmente durante un período largo, y que requiere la colaboración y la información de una amplia variedad de personas. Este tema describe cómo puede usar las mejoras de WBS para cumplir los requisitos de estimaciones y seguimiento.
...
**Programación de tareas** Los factores siguientes determinan la programación de las tareas de nodo de hoja:
...
Finance tiene tres vistas para la WBS de un proyecto: la vista Planificación, la vista Seguimiento de esfuerzos y la vista Seguimiento de costes.
...
Finance usa la regla de obtención 0:100 cuando representa el valor planificado. En esta regla, el valor de la tarea se registra en la tarea como su fecha final. No se registra ningún valor hasta que la tarea se completa al 100 por cien. 
...
Finance usa la regla de obtención 0:100 cuando representa los valores obtenidos. En esta regla, el valor de la tarea se registra en la tarea como su fecha final. No se registra ningún valor hasta que la tarea se completa al 100 por cien. 
