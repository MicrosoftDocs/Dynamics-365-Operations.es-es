...
description: Este artículo describe la información que se mantiene en los libros de arrendamiento. Los libros de arrendamiento contienen las directivas contables que determinan cómo se contabiliza un arrendamiento en el sistema.
author: moaamer
ms.date: 07/16/2021
ms.topic: article
ms.prod: ''
