...
Las versiones preliminares (1) pueden utilizar menos medidas de privacidad y seguridad que el servicio de finanzas y operaciones de Dynamics 365, (2) no están incluidas en el contrato de nivel de servicio para este servicio, (3) no deben utilizarse para procesar datos personales u otros datos que estén sujetos a requisitos de cumplimiento legal o reglamentario, y (4) tienen soporte limitado.
