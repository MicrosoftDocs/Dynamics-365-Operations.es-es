...
ms.locfileid: "5224798"
---
# <a name="collections-in-accounts-receivable"></a>Cobros en Clientes

[!include [banner](../includes/banner.md)]

La información de los cobros de clientes se gestiona en una vista central usando la página Cobros de Microsoft Dynamics 365 Finance. Los administradores de crédito y cobros pueden usar esta vista central para gestionar los cobros. Los agentes de cobros pueden comenzar el proceso de cobro por las listas de clientes que se generan mediante criterios de cobro predefinidos o por la página Clientes.
...
De forma predeterminada, los usuarios pueden ver toda la información de clientes en las páginas de listas de cobros. Puede usar los registros de agente de cobros para determinar las secciones de clientes disponibles para filtrar la información de las páginas de listas de cobros y en la página Cobros. 
