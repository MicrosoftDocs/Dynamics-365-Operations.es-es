...
[![Líneas de pedido de ventas para el portátil y el plan de soporte técnico](./media/07_rev-rec-scenarios.png)](./media/07_rev-rec-scenarios.png)
...
Si selecciona **Asiento esperado**, no se muestra nada, porque no se han contabilizado facturas.
