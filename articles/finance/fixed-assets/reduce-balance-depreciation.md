...
La **opción Calendario** actualiza la base de depreciación, que normalmente el valor neto menos el valor residual, el 1 de enero de cada año. En el posterior ejemplo de reducción de depreciación del saldo en este artículo, la base de depreciación es el numerador en la primera expresión en la columna de cálculos. 
