...
description: Este tema contiene información sobre los informes de Intrastat en Polonia.
author: andosip
ms.date: 11/09/2021
ms.topic: article
...
16. Seleccione **Aceptar** y revise el informe en formato XML que se genera. En la tabla siguiente se muestran los valores en el informe de ejemplo.
    ...
    <tr>
    <td colspan="3">
    <p style="text-align: center;"><strong>Información relativa al documento</strong></p>
    </td>
    </tr>
    <tr>
    <td>
    ...
    <tr>
    <td colspan="3">
    <p style="text-align: center;"><strong>Información relativa a la empresa</strong></p>
    </td>
    </tr>
    <tr>
    <td width="191">
    ...
    <tr>
    <td colspan="3">
    <p style="text-align: center;"><strong>Información sobre el producto</strong></p>
    </td>
    </tr>
    <tr>
    <td>
