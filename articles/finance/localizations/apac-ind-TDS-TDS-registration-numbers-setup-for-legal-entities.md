...
description: Este artículo explica cómo configurar números de registro para entidades jurídicas de impuestos deducidos en el origen (TDS).
author: kailiang
ms.date: 02/12/2021
ms.topic: article
ms.prod: ''
...
Este artículo explica cómo configurar números de registro para entidades jurídicas de impuestos deducidos en el origen (TDS).
...
4. En el campo **Número de distrito**, introduzca el número de distrito de la autoridad de TDS.
5. En el campo **Oficial evaluador**, introduzca los detalles del oficial evaluador para la autoridad TDS.
6. En el campo **Tipo de deductor**, seleccione la categoría de tipo de deductor para la entidad jurídica.
