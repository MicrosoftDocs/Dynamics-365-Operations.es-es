...
description: Este artículo explica cómo compartir configuraciones de informes electrónicos (ER) en los Regulatory Configuration Services (RCS) de Microsoft/repositorio global directamente con organizaciones externas.
author: JaneA07
ms.date: 05/04/2020
ms.topic: article
ms.prod: ''
...
La configuración se comparte con la organización externa y está disponible para esa organización en el repositorio global. A partir de ahí, se puede importar a la instancia de RCS de la organización o a sus instancias de las aplicaciones de finanzas y operaciones.
