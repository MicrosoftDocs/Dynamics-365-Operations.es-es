...
description: Este tema proporciona una descripción general del proceso para configurar recursos de Microsoft Azure para la facturación electrónica.
author: dkalyuzh
ms.date: 01/26/2022
ms.topic: article
ms.prod: ''
