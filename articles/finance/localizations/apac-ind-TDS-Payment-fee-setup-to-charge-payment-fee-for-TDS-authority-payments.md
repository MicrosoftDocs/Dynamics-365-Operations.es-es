...
description: Este artículo explica cómo configurar las cuotas de pago que se cobran por los pagos de la autoridad con impuestos deducidos en el origen (TDS).
author: kailiang
ms.date: 02/12/2021
ms.topic: article
ms.prod: ''
...
Este artículo explica cómo configurar las cuotas de pago que se cobran por los pagos de la autoridad con impuestos deducidos en el origen (TDS).
