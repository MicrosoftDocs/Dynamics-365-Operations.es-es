...
ms.locfileid: "6727258"
---
# <a name="tds-calculation-on-intercompany-transactions"></a>Cálculo de TDS en transacciones de empresas vinculadas

[!include [banner](../includes/banner.md)]

Este tema describe el proceso que se utiliza para calcular los impuestos deducidos en el origen (TDS) en transacciones entre empresas vinculadas.
