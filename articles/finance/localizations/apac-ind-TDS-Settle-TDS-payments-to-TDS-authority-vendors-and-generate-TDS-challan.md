...
description: Este artículo explica cómo liquidar pagos de impuestos deducidos en el origen (TDS) a proveedores de autoridad de TDS.
author: kailiang
ms.date: 03/12/2021
ms.topic: article
ms.prod: ''
...
Este artículo explica cómo liquidar pagos de impuestos deducidos en el origen (TDS) a proveedores de autoridad de TDS.
