...
- [Titulares de anticipo](emea-advance-holders.md)
 ...
 - [Anticipo a un empleado (Europa del Este)](tasks/advance-payment-employee.md)
- [Facturación avanzada](emea-advance-invoice.md)
- [Conciliación bancaria](emea-bank-reconciliation.md)
- [Facturación correctiva](emea-corrective-invoice.md)
- [Crear y registrar diarios periódicos](emea-create-post-periodic-journals.md)
...
- [Estándares OIOUBL](emea-oioubl-standards-electronic-invoicing.md)
...
- [Cargos invertidos](emea-reverse-charge.md)
...
- Impuesto sobre el valor añadido (IVA)
  - [nombre: Configuración del id. de IVA](tasks/eur-00015-vat-id.md)
  - [Registrar un id. de IVA de proveedor](tasks/eur-00015-registration-vendor-vat-id.md)
  ...
  - [Fecha de punto fiscal (la fecha de registro de IVA)](emea-tax-point-date.md)
