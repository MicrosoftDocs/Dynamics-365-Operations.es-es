---
title: Información general para Europa
description: Este artículo proporciona vínculos a recursos de documentación para Europa de Microsoft Dynamics 365 Finance.
author: kfend
ms.date: 01/15/2022
ms.topic: overview
ms.prod: ''
...
ms.locfileid: "8856529"
---
# <a name="europe-overview"></a>Información general para Europa

[!include [banner](../includes/banner.md)]

Este artículo incluye información y vínculos a recursos que pueden ayudarle a configurar para personas jurídicas con una dirección principal en Europa. 

- [Visión general de los titulares de anticipo](emea-advance-holders.md)
 - [Transacciones de titulares de anticipo](emea-advance-holders-transactions.md)
 - [Pago de anticipos al empleado](tasks/advance-payment-employee.md)
- [Facturas anticipadas para Europa del Este](emea-advance-invoice.md)
- [Extracto bancario y conciliación de pagos](emea-bank-reconciliation.md)
- [Facturación correctiva](emea-corrective-invoice.md)
- [Dividir períodos en diarios periódicos](emea-create-post-periodic-journals.md)
- [Crear pagos para un cliente con órdenes de domiciliación bancaria](tasks/create-payments-customers-who-have-direct-debit-mandates.md)
- [Editar Id. de la factura en pedidos de ventas para Europa del Este](emea-edit-invoice-id-sales-orders.md)
- [Certificados de entrada de la UE](emea-entry-certificates.md)
- [Informes de listas de ventas de la UE](emea-eu-sales-list.md)
  - [Ejemplo de lista de ventas de la EU genérica](emea-eu-sales-list-example.md)
...
- [Visión general de intrastat](emea-intrastat.md)
  - [Transferir transacciones a intrastat](tasks/transfer-transactions-intrastat.md)
  - [Especificación de una dirección de embarque para una transacción intracomunitaria](tasks/eur-00002-specify-lading-address-intra-community.md)
...
- [Fecha de límite de emisión de factura](emea-invoice-issue-deadline.md)
...
- [Caja en metálico para Europa del Este y Rusia](emea-petty-cash.md)
...
- [IVA de cargos invertidos](emea-reverse-charge.md)
- [Visión general de transferencias de crédito SEPA](../accounts-payable/sepa-credit-transfer.md)
- [Visión general de las domiciliaciones SEPA](../accounts-receivable/sepa-direct-debit-overview.md)
- [Configurar la compensación de clientes y proveedores](emea-compensation-customer-vendor-transactions.md)
...
- Impuesto sobre el valor añadido (IVA)
  - [Configuración del id. de IVA](tasks/eur-00015-vat-id.md)
  - [Registro de ID de IVA del proveedor](tasks/eur-00015-registration-vendor-vat-id.md)
  - [Visión general del tipo de cambio del IVA](emea-vat-exchange-rate.md)
  ...
  - [Ver transacciones sobre la liquidación para Europa del Este](emea-transactions-settlement-form.md)
  - [Fecha de punto fiscal (fecha de registro del IVA)](emea-tax-point-date.md)
  - [Fecha de registro de IVA de proveedor](emea-date-vendor-VAT-register.md)
- [Extensión de la función de motivos financieros](emea-financial-reason.md)
