...
description: Este artículo proporciona información acerca de miembros de dimensión estadística y plantillas de proveedor de medidas estadísticas.
author: AndersGirke
ms.date: 06/16/2017
ms.topic: article
ms.prod: ''
...
Las medidas estadísticas pueden proceder de muchos tipos de fuentes. Dynamics 365 Finance es un origen muy interesante para extraer estadísticas de medidas. Puede usar una plantilla de proveedor de medidas estadísticas para configurar fácilmente las medidas estadísticas que desea extraer.
...
Vaya a **Libro mayor de contabilidad de costes** \> **Versión real** \> **Gestionar** \> **Medidas estadísticas** para establecer la relación. Para esta situación, seleccione el conector de datos **Dynamics 365 Finance– Medidas estadísticas**, pues deseamos extraer datos de Finance.

**Origen de datos**

| Nombre        | Conector de datos                                                                     | Miembro de dimensión estadística |
|-------------|------------------------------------------------------------------------------------|------------------------------|
| EJC D365FO | Dynamics 365 Finance - Medidas estadísticas | EJC                         |
...
| Nombre           | Conector de datos                                                                     | Miembro de dimensión estadística |
|----------------|------------------------------------------------------------------------------------|------------------------------|
| Paquete CC D365FO | Dynamics 365 Finance - Medidas estadísticas | Paquete CC                      |
