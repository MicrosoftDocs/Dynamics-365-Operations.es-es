...
| Función            | Descripción |
|---------------------|-------------|
| Normal              | Use la función **Normal** en su método de pago al definir métodos de pago como efectivo o asientos. Cuando se aplican a estos tipos de pagos a un pedido de ventas en el centro de llamada, se registran inmediatamente como anticipos en la cuenta del cliente. El asiento de anticipos se registra en el historial de transacciones del cliente, donde se liquidará sistemáticamente con la factura del pedido de ventas cuando se creen las facturas. |
| Comprobación               | Use la función **Cheque** al definir un instrumento de cheque bancario como forma de pago. Cuando este tipo de pago se aplica a un pedido de ventas, el usuario debe introducir el número de cheque del cliente como parte del procesamiento de solicitud de pago. Los pagos en cheques siempre se tratan como anticipos cuando se aplican. Con respecto a la función de pago **Normal**, estos asientos de anticipo se liquidarán sistemáticamente con las facturas que se crean para el pedido. |
