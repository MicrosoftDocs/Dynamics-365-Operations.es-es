...
Antes de poder procesar correctamente las ventas a través de un canal del centro de llamadas, deben definirse los [métodos de pago](https://docs.microsoft.com/en-us/dynamics365/unified-operations/retail/work-with-payments) y modos de entrega correctos para el canal.
