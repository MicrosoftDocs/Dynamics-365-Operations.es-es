...
description: Este tema proporciona una visión general de los pagos de omnicanal en Microsoft Dynamics 365 for Retail.
author: rubendel
manager: AnnBe
ms.date: 05/12/2019
ms.topic: article
...
ms.locfileid: "1606201"
---
# <a name="omni-channel-payments-overview"></a>Información general de pagos omnicanal

[!include [banner](../includes/banner.md)]

Este tema proporciona una visión general de los pagos de omnicanal en Microsoft Dynamics 365 for Retail. Incluye una lista completa de escenarios admitidos, información sobre funcionalidad, configuración, soluciones de problemas y las descripciones de problemas habituales.
...
- **Configuración de pagos de omnicanal:** en la oficina administrativa, vaya a **Retail \> Configuración de sede \> Parámetros \> Parámetros compartidos de Retail**. A continuación, en la pestaña **Pagos de omnicanal**, establezca la opción **Usar pagos omnicanal** en **Sí**.
...
- La opción **Pagos de omnicanal** en la página **Parámetros compartidos de Retail** se establece en **Verdad**.
...
3. En Retail, utilice el trabajo por lotes **Sincronizar los pedidos** y la programación de la distribución **P-001** para crear los pedidos en el área de operaciones.
...
1. En Retail, en la página **Servicio al cliente**, especifique **Karen Berg** en la barra de búsqueda y a continuación seleccione **Buscar**. 
