...
ms.locfileid: "2017583"
---
# <a name="omni-channel-payments-overview"></a>Información general de pagos omnicanal

[!include [banner](../includes/banner.md)]

Este tema proporciona una visión general de los pagos de omnicanal en Dynamics 365 Retail. Incluye una lista completa de escenarios admitidos, información sobre funcionalidad, configuración, soluciones de problemas y las descripciones de problemas habituales.
