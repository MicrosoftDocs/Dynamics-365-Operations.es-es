...
---
# <a name="configure-payroll-integration-between-talent-and-dayforce"></a>Configurar integración de nóminas entre Talent y Dayforce

La integración entre Microsoft Dynamics 365 Talent y Ceridian Dayforce se basa en varios pasos de configuración que se describen en este tema. Debe configurar la integración en Talent y Dayforce para poder procesar un período de pago.
...
- [Crear una nueva prestación](https://docs.microsoft.com/dynamics365/unified-operations/fin-and-ops/hr/tasks/create-new-benefit)
...
- [Crear un departamento y asociarlo a la jerarquía de departamentos](https://docs.microsoft.com/dynamics365/unified-operations/talent/create-department-add-department-hierarchy)
