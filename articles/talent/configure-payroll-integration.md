...
- <span data-ttu-id="ba5c6-110">Datos de recursos humanos</span><span class="sxs-lookup"><span data-stu-id="ba5c6-110">Human resources data</span></span>
...
## <a name="configure-your-data"></a><span data-ttu-id="ba5c6-140">Configurar los datos</span><span class="sxs-lookup"><span data-stu-id="ba5c6-140">Configure your data</span></span> 
...
##### <a name="benefits"></a><span data-ttu-id="ba5c6-157">Beneficios</span><span class="sxs-lookup"><span data-stu-id="ba5c6-157">Benefits</span></span>
...
- [<span data-ttu-id="ba5c6-203">Definición del proceso de compensación y el cálculo de resultados</span><span class="sxs-lookup"><span data-stu-id="ba5c6-203">Define compensation process and calculate results</span></span>](https://docs.microsoft.com/en-us/dynamics365/unified-operations/fin-and-ops/hr/tasks/define-compensation-process-calculate-results)
...
- <span data-ttu-id="ba5c6-225">Ciclo de pago (obligatorio)</span><span class="sxs-lookup"><span data-stu-id="ba5c6-225">Pay cycle (required)</span></span>
...
#### <a name="pay-cycles-and-pay-periods"></a><span data-ttu-id="ba5c6-240">Ciclos y períodos de pago</span><span class="sxs-lookup"><span data-stu-id="ba5c6-240">Pay cycles and pay periods</span></span>
...
#### <a name="earning-codes"></a><span data-ttu-id="ba5c6-256">Códigos de ganancia</span><span class="sxs-lookup"><span data-stu-id="ba5c6-256">Earning codes</span></span>
...
#### <a name="contact-information"></a><span data-ttu-id="ba5c6-295">Información de contacto</span><span class="sxs-lookup"><span data-stu-id="ba5c6-295">Contact information</span></span> 
...
<span data-ttu-id="ba5c6-341">Un plan de compensación fija se debe asociar al puesto principal de cada empleado durante un período de empleo.</span><span class="sxs-lookup"><span data-stu-id="ba5c6-341">A fixed compensation plan must be associated with every employee's primary position throughout an employment period.</span></span> <span data-ttu-id="ba5c6-342">Este período comienza en la fecha de contratación del empleado (o la fecha de inicio del empleo) y continúa hasta la finalización.</span><span class="sxs-lookup"><span data-stu-id="ba5c6-342">This period starts on the date that the employee was hired (or the employment start date) and continues until termination.</span></span>
...
- <span data-ttu-id="ba5c6-357">Principal (obligatorio)</span><span class="sxs-lookup"><span data-stu-id="ba5c6-357">Primary (required)</span></span>
...
### <a name="job-types"></a><span data-ttu-id="ba5c6-395">Tipos de trabajo</span><span class="sxs-lookup"><span data-stu-id="ba5c6-395">Job types</span></span>
...
|------------------------|----------------------|
| <span data-ttu-id="ba5c6-453">Casado/a</span><span class="sxs-lookup"><span data-stu-id="ba5c6-453">Married</span></span>                | <span data-ttu-id="ba5c6-454">Casado/a</span><span class="sxs-lookup"><span data-stu-id="ba5c6-454">Married</span></span>              |
...
- <span data-ttu-id="ba5c6-483">Todas</span><span class="sxs-lookup"><span data-stu-id="ba5c6-483">All</span></span>
...
### <a name="addresses"></a><span data-ttu-id="ba5c6-512">Direcciones</span><span class="sxs-lookup"><span data-stu-id="ba5c6-512">Addresses</span></span>
...
| <span data-ttu-id="ba5c6-523">Población</span><span class="sxs-lookup"><span data-stu-id="ba5c6-523">City</span></span>            | <span data-ttu-id="ba5c6-524">Población</span><span class="sxs-lookup"><span data-stu-id="ba5c6-524">City</span></span>                  |
| <span data-ttu-id="ba5c6-525">Comarca</span><span class="sxs-lookup"><span data-stu-id="ba5c6-525">County</span></span>          | <span data-ttu-id="ba5c6-526">Condado (municipio)</span><span class="sxs-lookup"><span data-stu-id="ba5c6-526">County (Municipality)</span></span> |
| <span data-ttu-id="ba5c6-527">Calle</span><span class="sxs-lookup"><span data-stu-id="ba5c6-527">Street</span></span>          | <span data-ttu-id="ba5c6-528">Línea de dirección 1</span><span class="sxs-lookup"><span data-stu-id="ba5c6-528">Address Line 1</span></span>        |

### <a name="tax-regions"></a><span data-ttu-id="ba5c6-529">Regiones de impuestos</span><span class="sxs-lookup"><span data-stu-id="ba5c6-529">Tax regions</span></span>

<span data-ttu-id="ba5c6-530">Las regiones de impuestos se usan para determinar los impuestos correspondientes que se deben aplicar durante la generación de nómina.</span><span class="sxs-lookup"><span data-stu-id="ba5c6-530">Tax regions are used to determine the appropriate tax that should be applied during payroll generation.</span></span> <span data-ttu-id="ba5c6-531">Las regiones de impuestos se asignan a Dayforce como direcciones de ubicación.</span><span class="sxs-lookup"><span data-stu-id="ba5c6-531">Tax regions are mapped to Dayforce as location addresses.</span></span> <span data-ttu-id="ba5c6-532">La región de impuestos predeterminada se debe asociar al puesto activo del trabajador.</span><span class="sxs-lookup"><span data-stu-id="ba5c6-532">The default tax region must be associated with the worker's active position.</span></span> 

- <span data-ttu-id="ba5c6-533">Región de impuestos (obligatorio)</span><span class="sxs-lookup"><span data-stu-id="ba5c6-533">Tax region (required)</span></span>
- <span data-ttu-id="ba5c6-534">País o región (obligatorio)</span><span class="sxs-lookup"><span data-stu-id="ba5c6-534">Country/Region (required)</span></span>
- <span data-ttu-id="ba5c6-535">Estado (obligatorio)</span><span class="sxs-lookup"><span data-stu-id="ba5c6-535">State (required)</span></span>
- <span data-ttu-id="ba5c6-536">Comarca</span><span class="sxs-lookup"><span data-stu-id="ba5c6-536">County</span></span> 
- <span data-ttu-id="ba5c6-537">Ciudad (obligatorio)</span><span class="sxs-lookup"><span data-stu-id="ba5c6-537">City (required)</span></span>

## <a name="configure-your-data-to-generate-payroll-in-mexico"></a><span data-ttu-id="ba5c6-538">Configurar los datos para generar nóminas en México</span><span class="sxs-lookup"><span data-stu-id="ba5c6-538">Configure your data to generate payroll in Mexico</span></span>

<span data-ttu-id="ba5c6-539">Si va a generar el sueldo de los empleados en México, los siguientes elementos deben estar configurados:</span><span class="sxs-lookup"><span data-stu-id="ba5c6-539">If you're generating pay for employees in Mexico, the following elements must be configured:</span></span>

- <span data-ttu-id="ba5c6-540">Se requieren departamentos en los puestos.</span><span class="sxs-lookup"><span data-stu-id="ba5c6-540">Departments are required on positions.</span></span>
- <span data-ttu-id="ba5c6-541">Los centros de coste deben configurarse como dimensiones financieras y deben ser el primer elemento de la cadena de dimensión financiera predeterminada.</span><span class="sxs-lookup"><span data-stu-id="ba5c6-541">Cost centers must be set as financial dimensions and must be the first element in the Default Financial Dimension string.</span></span>

### <a name="job-types"></a><span data-ttu-id="ba5c6-542">Tipos de trabajo</span><span class="sxs-lookup"><span data-stu-id="ba5c6-542">Job types</span></span>

<span data-ttu-id="ba5c6-543">Los tipos de trabajo se utilizan para agrupar trabajos similares en categorías.</span><span class="sxs-lookup"><span data-stu-id="ba5c6-543">Job types are used to group similar jobs into categories.</span></span> <span data-ttu-id="ba5c6-544">Los tipos de trabajo son obligatorios para procesar la nómina en México.</span><span class="sxs-lookup"><span data-stu-id="ba5c6-544">Job types are required in order to process payroll in Mexico.</span></span> <span data-ttu-id="ba5c6-545">Entre los ejemplos de tipos de trabajo se incluyen jornada completa y tiempo parcial, o con sueldo y paga por horas.</span><span class="sxs-lookup"><span data-stu-id="ba5c6-545">Examples of job types include full-time and part-time, or salary and hourly pay.</span></span> <span data-ttu-id="ba5c6-546">Los tipos de trabajo se asignan a Dayforce como tipos de sueldo que indican si un empleado trabaja por horas o es asalariado.</span><span class="sxs-lookup"><span data-stu-id="ba5c6-546">Job types are mapped to Dayforce as pay types that indicate whether an employee is hourly or salaried.</span></span>

<span data-ttu-id="ba5c6-547">Los siguientes tipos de trabajo y descripciones son obligatorios.</span><span class="sxs-lookup"><span data-stu-id="ba5c6-547">The following job types and descriptions are required.</span></span>

| <span data-ttu-id="ba5c6-548">Tipo de trabajo</span><span class="sxs-lookup"><span data-stu-id="ba5c6-548">Job type</span></span>   | <span data-ttu-id="ba5c6-549">Descripción</span><span class="sxs-lookup"><span data-stu-id="ba5c6-549">Description</span></span> |
|------------|-------------|
| <span data-ttu-id="ba5c6-550">Por hora</span><span class="sxs-lookup"><span data-stu-id="ba5c6-550">Hourly</span></span>     | <span data-ttu-id="ba5c6-551">MX Por hora</span><span class="sxs-lookup"><span data-stu-id="ba5c6-551">MX Hourly</span></span>   |
| <span data-ttu-id="ba5c6-552">Asalariado</span><span class="sxs-lookup"><span data-stu-id="ba5c6-552">Salaried</span></span>   | <span data-ttu-id="ba5c6-553">MX Asalariado</span><span class="sxs-lookup"><span data-stu-id="ba5c6-553">MX Salaried</span></span> |

### <a name="position-types"></a><span data-ttu-id="ba5c6-554">Tipos de puestos</span><span class="sxs-lookup"><span data-stu-id="ba5c6-554">Position types</span></span> 

<span data-ttu-id="ba5c6-555">Use los tipos de puesto para describir si el puesto es a jornada completa, a tiempo parcial u otro tipo.</span><span class="sxs-lookup"><span data-stu-id="ba5c6-555">You use position types to describe whether the position is full-time, part-time, or something else.</span></span> <span data-ttu-id="ba5c6-556">Los tipos de puesto se asignan a Dayforce como clases de sueldo que indican si un empleado a jornada completa o a tiempo parcial.</span><span class="sxs-lookup"><span data-stu-id="ba5c6-556">Position types are mapped to Dayforce as pay classes that indicate whether an employee is full-time or part-time.</span></span>

<span data-ttu-id="ba5c6-557">Los siguientes tipos de puesto y descripciones son obligatorios.</span><span class="sxs-lookup"><span data-stu-id="ba5c6-557">The following position types and descriptions are required.</span></span>

| <span data-ttu-id="ba5c6-558">Tipo de puesto</span><span class="sxs-lookup"><span data-stu-id="ba5c6-558">Position type</span></span>   | <span data-ttu-id="ba5c6-559">Descripción</span><span class="sxs-lookup"><span data-stu-id="ba5c6-559">Description</span></span>        |
|-----------------|--------------------|
| <span data-ttu-id="ba5c6-560">Jornada completa</span><span class="sxs-lookup"><span data-stu-id="ba5c6-560">Full-time</span></span>       | <span data-ttu-id="ba5c6-561">Empleado a jornada completa</span><span class="sxs-lookup"><span data-stu-id="ba5c6-561">Full time employee</span></span> |
| <span data-ttu-id="ba5c6-562">A tiempo parcial</span><span class="sxs-lookup"><span data-stu-id="ba5c6-562">Part-time</span></span>       | <span data-ttu-id="ba5c6-563">Empleado a tiempo parcial</span><span class="sxs-lookup"><span data-stu-id="ba5c6-563">Part time employee</span></span> |

### <a name="reason-codes"></a><span data-ttu-id="ba5c6-564">Códigos de motivos</span><span class="sxs-lookup"><span data-stu-id="ba5c6-564">Reason codes</span></span>

<span data-ttu-id="ba5c6-565">Los códigos de motivos proporcionan información sobre el estado de un empleado.</span><span class="sxs-lookup"><span data-stu-id="ba5c6-565">Reason codes provide information about the status of an employee.</span></span> <span data-ttu-id="ba5c6-566">Los códigos de motivos se asignan a Dayforce como motivos de estado que indican el motivo de los cambios en el puesto de un empleado o su situación laboral.</span><span class="sxs-lookup"><span data-stu-id="ba5c6-566">Reason codes are mapped to Dayforce as status reasons that indicate the reason for changes to an employee's position or employment status.</span></span>

<span data-ttu-id="ba5c6-567">Los siguientes códigos de motivos y descripciones son obligatorios.</span><span class="sxs-lookup"><span data-stu-id="ba5c6-567">The following reason codes and descriptions are required.</span></span>

| <span data-ttu-id="ba5c6-568">Código de motivo</span><span class="sxs-lookup"><span data-stu-id="ba5c6-568">Reason code</span></span>            | <span data-ttu-id="ba5c6-569">Descripción</span><span class="sxs-lookup"><span data-stu-id="ba5c6-569">Description</span></span>                    | <span data-ttu-id="ba5c6-570">Situaciones aplicables</span><span class="sxs-lookup"><span data-stu-id="ba5c6-570">Applicable scenarios</span></span> |
|------------------------|--------------------------------|----------------------|
| <span data-ttu-id="ba5c6-571">DEPARTUREBEFOREPAYMENT</span><span class="sxs-lookup"><span data-stu-id="ba5c6-571">DEPARTUREBEFOREPAYMENT</span></span> | <span data-ttu-id="ba5c6-572">Salida antes de la primera nómina</span><span class="sxs-lookup"><span data-stu-id="ba5c6-572">Departure before first payroll</span></span> | <span data-ttu-id="ba5c6-573">Dar de baja a trabajador</span><span class="sxs-lookup"><span data-stu-id="ba5c6-573">Terminate worker</span></span>     |
| <span data-ttu-id="ba5c6-574">RESIGNATION</span><span class="sxs-lookup"><span data-stu-id="ba5c6-574">RESIGNATION</span></span>            | <span data-ttu-id="ba5c6-575">Dimisión</span><span class="sxs-lookup"><span data-stu-id="ba5c6-575">Resignation</span></span>                    | <span data-ttu-id="ba5c6-576">Dar de baja a trabajador</span><span class="sxs-lookup"><span data-stu-id="ba5c6-576">Terminate worker</span></span>     |
| <span data-ttu-id="ba5c6-577">PENSION</span><span class="sxs-lookup"><span data-stu-id="ba5c6-577">PENSION</span></span>                | <span data-ttu-id="ba5c6-578">Pensión</span><span class="sxs-lookup"><span data-stu-id="ba5c6-578">Pension</span></span>                        | <span data-ttu-id="ba5c6-579">Dar de baja a trabajador</span><span class="sxs-lookup"><span data-stu-id="ba5c6-579">Terminate worker</span></span>     |
| <span data-ttu-id="ba5c6-580">TERMINATION</span><span class="sxs-lookup"><span data-stu-id="ba5c6-580">TERMINATION</span></span>            | <span data-ttu-id="ba5c6-581">Finalización</span><span class="sxs-lookup"><span data-stu-id="ba5c6-581">Termination</span></span>                    | <span data-ttu-id="ba5c6-582">Dar de baja a trabajador</span><span class="sxs-lookup"><span data-stu-id="ba5c6-582">Terminate worker</span></span>     |
| <span data-ttu-id="ba5c6-583">JUBILACIÓN</span><span class="sxs-lookup"><span data-stu-id="ba5c6-583">RETIREMENT</span></span>             | <span data-ttu-id="ba5c6-584">Jubilación</span><span class="sxs-lookup"><span data-stu-id="ba5c6-584">Retirement</span></span>                     | <span data-ttu-id="ba5c6-585">Dar de baja a trabajador</span><span class="sxs-lookup"><span data-stu-id="ba5c6-585">Terminate worker</span></span>     |
| <span data-ttu-id="ba5c6-586">ABSENTEE</span><span class="sxs-lookup"><span data-stu-id="ba5c6-586">ABSENTEE</span></span>               | <span data-ttu-id="ba5c6-587">Ausente</span><span class="sxs-lookup"><span data-stu-id="ba5c6-587">Absentee</span></span>                       | <span data-ttu-id="ba5c6-588">Dar de baja a trabajador</span><span class="sxs-lookup"><span data-stu-id="ba5c6-588">Terminate worker</span></span>     |
| <span data-ttu-id="ba5c6-589">OTHER</span><span class="sxs-lookup"><span data-stu-id="ba5c6-589">OTHER</span></span>                  | <span data-ttu-id="ba5c6-590">Otros motivos</span><span class="sxs-lookup"><span data-stu-id="ba5c6-590">Other Reasons</span></span>                  | <span data-ttu-id="ba5c6-591">Dar de baja a trabajador</span><span class="sxs-lookup"><span data-stu-id="ba5c6-591">Terminate worker</span></span>     |
| <span data-ttu-id="ba5c6-592">CLOSURE</span><span class="sxs-lookup"><span data-stu-id="ba5c6-592">CLOSURE</span></span>                | <span data-ttu-id="ba5c6-593">Cierre de operaciones</span><span class="sxs-lookup"><span data-stu-id="ba5c6-593">Business Closure</span></span>               | <span data-ttu-id="ba5c6-594">Dar de baja a trabajador</span><span class="sxs-lookup"><span data-stu-id="ba5c6-594">Terminate worker</span></span>     |
| <span data-ttu-id="ba5c6-595">MUERTE</span><span class="sxs-lookup"><span data-stu-id="ba5c6-595">DEATH</span></span>                  | <span data-ttu-id="ba5c6-596">Muerte</span><span class="sxs-lookup"><span data-stu-id="ba5c6-596">Death</span></span>                          | <span data-ttu-id="ba5c6-597">Dar de baja a trabajador</span><span class="sxs-lookup"><span data-stu-id="ba5c6-597">Terminate worker</span></span>     |
| <span data-ttu-id="ba5c6-598">LEAVEOFABSENCE</span><span class="sxs-lookup"><span data-stu-id="ba5c6-598">LEAVEOFABSENCE</span></span>         | <span data-ttu-id="ba5c6-599">Permiso para ausentarse</span><span class="sxs-lookup"><span data-stu-id="ba5c6-599">Leave of Absence</span></span>               | <span data-ttu-id="ba5c6-600">Dar de baja a trabajador</span><span class="sxs-lookup"><span data-stu-id="ba5c6-600">Terminate worker</span></span>     |
| <span data-ttu-id="ba5c6-601">CONTRACTEND</span><span class="sxs-lookup"><span data-stu-id="ba5c6-601">CONTRACTEND</span></span>            | <span data-ttu-id="ba5c6-602">Fin de contrato</span><span class="sxs-lookup"><span data-stu-id="ba5c6-602">End of Contract</span></span>                | <span data-ttu-id="ba5c6-603">Dar de baja a trabajador</span><span class="sxs-lookup"><span data-stu-id="ba5c6-603">Terminate worker</span></span>     |
| <span data-ttu-id="ba5c6-604">SALARYCHANGE</span><span class="sxs-lookup"><span data-stu-id="ba5c6-604">SALARYCHANGE</span></span>           | <span data-ttu-id="ba5c6-605">Cambio de salario</span><span class="sxs-lookup"><span data-stu-id="ba5c6-605">Change of Salary</span></span>               | <span data-ttu-id="ba5c6-606">Compensación</span><span class="sxs-lookup"><span data-stu-id="ba5c6-606">Compensation</span></span>         |

### <a name="terms-of-employment"></a><span data-ttu-id="ba5c6-607">Condiciones laborales</span><span class="sxs-lookup"><span data-stu-id="ba5c6-607">Terms of employment</span></span>

<span data-ttu-id="ba5c6-608">Las condiciones laborales se usan para crear categorías de condiciones laborales.</span><span class="sxs-lookup"><span data-stu-id="ba5c6-608">Terms of employment are used to create categories of employment terms.</span></span> <span data-ttu-id="ba5c6-609">Las condiciones se asignan a Dayforce como valores de indicador de empleo.</span><span class="sxs-lookup"><span data-stu-id="ba5c6-609">The terms are mapped to Dayforce as employment indicator values.</span></span>

<span data-ttu-id="ba5c6-610">Las siguientes condiciones laborales y descripciones son obligatorias.</span><span class="sxs-lookup"><span data-stu-id="ba5c6-610">The following terms of employment and descriptions are required.</span></span>

| <span data-ttu-id="ba5c6-611">Condiciones laborales</span><span class="sxs-lookup"><span data-stu-id="ba5c6-611">Terms of employment</span></span>   | <span data-ttu-id="ba5c6-612">Descripción</span><span class="sxs-lookup"><span data-stu-id="ba5c6-612">Description</span></span> |
|-----------------------|-------------|
| <span data-ttu-id="ba5c6-613">Normal</span><span class="sxs-lookup"><span data-stu-id="ba5c6-613">Regular</span></span>               | <span data-ttu-id="ba5c6-614">Normal</span><span class="sxs-lookup"><span data-stu-id="ba5c6-614">Regular</span></span>     |
| <span data-ttu-id="ba5c6-615">Directo</span><span class="sxs-lookup"><span data-stu-id="ba5c6-615">Direct</span></span>                | <span data-ttu-id="ba5c6-616">Directo</span><span class="sxs-lookup"><span data-stu-id="ba5c6-616">Direct</span></span>      |
| <span data-ttu-id="ba5c6-617">Prácticas</span><span class="sxs-lookup"><span data-stu-id="ba5c6-617">Internship</span></span>            | <span data-ttu-id="ba5c6-618">Prácticas</span><span class="sxs-lookup"><span data-stu-id="ba5c6-618">Internship</span></span>  |
| <span data-ttu-id="ba5c6-619">Permanente</span><span class="sxs-lookup"><span data-stu-id="ba5c6-619">Permanent</span></span>             | <span data-ttu-id="ba5c6-620">Permanente</span><span class="sxs-lookup"><span data-stu-id="ba5c6-620">Permanent</span></span>   |

### <a name="marital-status"></a><span data-ttu-id="ba5c6-621">Estado civil</span><span class="sxs-lookup"><span data-stu-id="ba5c6-621">Marital status</span></span>

<span data-ttu-id="ba5c6-622">Los valores de estado civil se asignan a Dayforce y se traducen, según corresponda, a los valores aceptados tras la integración.</span><span class="sxs-lookup"><span data-stu-id="ba5c6-622">Marital status values are mapped to Dayforce and translated, as appropriate, to the accepted values upon integration.</span></span>

<span data-ttu-id="ba5c6-623">En la siguiente tabla se muestra cómo los valores de estado civil se asignan a Dayforce.</span><span class="sxs-lookup"><span data-stu-id="ba5c6-623">The following table shows how marital status values are mapped to Dayforce.</span></span>

| <span data-ttu-id="ba5c6-624">Talent</span><span class="sxs-lookup"><span data-stu-id="ba5c6-624">Talent</span></span>                 | <span data-ttu-id="ba5c6-625">Dayforce</span><span class="sxs-lookup"><span data-stu-id="ba5c6-625">Dayforce</span></span>                  |
|------------------------|---------------------------|
| <span data-ttu-id="ba5c6-626">Casado/a</span><span class="sxs-lookup"><span data-stu-id="ba5c6-626">Married</span></span>                | <span data-ttu-id="ba5c6-627">Casado/a</span><span class="sxs-lookup"><span data-stu-id="ba5c6-627">Married</span></span>                   |
| <span data-ttu-id="ba5c6-628">Soltero/a</span><span class="sxs-lookup"><span data-stu-id="ba5c6-628">Single</span></span>                 | <span data-ttu-id="ba5c6-629">Soltero/a</span><span class="sxs-lookup"><span data-stu-id="ba5c6-629">Single</span></span>                    |
| <span data-ttu-id="ba5c6-630">Viudo/a</span><span class="sxs-lookup"><span data-stu-id="ba5c6-630">Widowed</span></span>                | <span data-ttu-id="ba5c6-631">Viudo/a</span><span class="sxs-lookup"><span data-stu-id="ba5c6-631">Widowed</span></span>                   |
| <span data-ttu-id="ba5c6-632">Divorciado/a</span><span class="sxs-lookup"><span data-stu-id="ba5c6-632">Divorced</span></span>               | <span data-ttu-id="ba5c6-633">Divorciado/a</span><span class="sxs-lookup"><span data-stu-id="ba5c6-633">Divorced</span></span>                  |
| <span data-ttu-id="ba5c6-634">Unión registrada</span><span class="sxs-lookup"><span data-stu-id="ba5c6-634">Registered Partnership</span></span> | <span data-ttu-id="ba5c6-635">Sociedad doméstica</span><span class="sxs-lookup"><span data-stu-id="ba5c6-635">Domestic Partnership</span></span>      |
| <span data-ttu-id="ba5c6-636">Sin ordenar</span><span class="sxs-lookup"><span data-stu-id="ba5c6-636">None</span></span>                   | <span data-ttu-id="ba5c6-637">*No se admite en México*</span><span class="sxs-lookup"><span data-stu-id="ba5c6-637">*Not supported by Mexico*</span></span> |
| <span data-ttu-id="ba5c6-638">Cohabitando</span><span class="sxs-lookup"><span data-stu-id="ba5c6-638">Cohabiting</span></span>             | <span data-ttu-id="ba5c6-639">*No se admite en México*</span><span class="sxs-lookup"><span data-stu-id="ba5c6-639">*Not supported by Mexico*</span></span> |

### <a name="gender"></a><span data-ttu-id="ba5c6-640">Género</span><span class="sxs-lookup"><span data-stu-id="ba5c6-640">Gender</span></span>

<span data-ttu-id="ba5c6-641">Las designaciones de género se asignan a Dayforce y se traducen, según corresponda, a los valores aceptados tras la integración.</span><span class="sxs-lookup"><span data-stu-id="ba5c6-641">Gender designations are mapped to Dayforce and translated, as appropriate, to the accepted values upon integration.</span></span>

<span data-ttu-id="ba5c6-642">En la siguiente tabla se muestra cómo las designaciones de género se asignan a Dayforce.</span><span class="sxs-lookup"><span data-stu-id="ba5c6-642">The following table shows how gender designations are mapped to Dayforce.</span></span>

| <span data-ttu-id="ba5c6-643">Talent</span><span class="sxs-lookup"><span data-stu-id="ba5c6-643">Talent</span></span>       | <span data-ttu-id="ba5c6-644">Dayforce</span><span class="sxs-lookup"><span data-stu-id="ba5c6-644">Dayforce</span></span>                  |
|--------------|---------------------------|
| <span data-ttu-id="ba5c6-645">Hombre</span><span class="sxs-lookup"><span data-stu-id="ba5c6-645">Male</span></span>         | <span data-ttu-id="ba5c6-646">Hombre</span><span class="sxs-lookup"><span data-stu-id="ba5c6-646">Male</span></span>                      |
| <span data-ttu-id="ba5c6-647">Mujer</span><span class="sxs-lookup"><span data-stu-id="ba5c6-647">Female</span></span>       | <span data-ttu-id="ba5c6-648">Mujer</span><span class="sxs-lookup"><span data-stu-id="ba5c6-648">Female</span></span>                    |
| <span data-ttu-id="ba5c6-649">No específico</span><span class="sxs-lookup"><span data-stu-id="ba5c6-649">Non-specific</span></span> | <span data-ttu-id="ba5c6-650">*No se admite en México*</span><span class="sxs-lookup"><span data-stu-id="ba5c6-650">*Not supported by Mexico*</span></span> |

### <a name="payment-method"></a><span data-ttu-id="ba5c6-651">Método de pago</span><span class="sxs-lookup"><span data-stu-id="ba5c6-651">Payment method</span></span>

<span data-ttu-id="ba5c6-652">Los métodos de pago ofrecen al empleado y la empresa una forma de describir cómo se pagará a los empleados.</span><span class="sxs-lookup"><span data-stu-id="ba5c6-652">Payment methods give the employee and the company a way to describe how employees will be paid.</span></span> <span data-ttu-id="ba5c6-653">Los métodos de pago se asignan a Dayforce y se traducen, según corresponda, a los valores aceptados tras la integración.</span><span class="sxs-lookup"><span data-stu-id="ba5c6-653">Payment methods are mapped to Dayforce and translated, as appropriate, to the accepted values upon integration.</span></span>

<span data-ttu-id="ba5c6-654">En la siguiente tabla se muestra cómo los métodos de pago se asignan a Dayforce.</span><span class="sxs-lookup"><span data-stu-id="ba5c6-654">The following table shows how payment methods are mapped to Dayforce.</span></span>

| <span data-ttu-id="ba5c6-655">Talent</span><span class="sxs-lookup"><span data-stu-id="ba5c6-655">Talent</span></span>             | <span data-ttu-id="ba5c6-656">Dayforce</span><span class="sxs-lookup"><span data-stu-id="ba5c6-656">Dayforce</span></span>                  |
|--------------------|---------------------------|
| <span data-ttu-id="ba5c6-657">Efectivo</span><span class="sxs-lookup"><span data-stu-id="ba5c6-657">Cash</span></span>               | <span data-ttu-id="ba5c6-658">Efectivo</span><span class="sxs-lookup"><span data-stu-id="ba5c6-658">Cash</span></span>                      |
| <span data-ttu-id="ba5c6-659">Pago electrónico</span><span class="sxs-lookup"><span data-stu-id="ba5c6-659">Electronic Payment</span></span> | <span data-ttu-id="ba5c6-660">Transferir</span><span class="sxs-lookup"><span data-stu-id="ba5c6-660">Transfer</span></span>                  |
| <span data-ttu-id="ba5c6-661">Comprobación</span><span class="sxs-lookup"><span data-stu-id="ba5c6-661">Check</span></span>              | <span data-ttu-id="ba5c6-662">Cheque</span><span class="sxs-lookup"><span data-stu-id="ba5c6-662">Cheque</span></span>                    |
| <span data-ttu-id="ba5c6-663">Efecto bancario</span><span class="sxs-lookup"><span data-stu-id="ba5c6-663">Bank Draft</span></span>         | <span data-ttu-id="ba5c6-664">*No se admite en México*</span><span class="sxs-lookup"><span data-stu-id="ba5c6-664">*Not supported by Mexico*</span></span> |
| <span data-ttu-id="ba5c6-665">Otras</span><span class="sxs-lookup"><span data-stu-id="ba5c6-665">Other</span></span>              | <span data-ttu-id="ba5c6-666">*No se admite en México*</span><span class="sxs-lookup"><span data-stu-id="ba5c6-666">*Not supported by Mexico*</span></span> |

### <a name="bank-account-type"></a><span data-ttu-id="ba5c6-667">Tipo de cuenta bancaria</span><span class="sxs-lookup"><span data-stu-id="ba5c6-667">Bank account type</span></span>

<span data-ttu-id="ba5c6-668">Los tipos de cuenta bancaria se usan para los pagos electrónicos a los empleados.</span><span class="sxs-lookup"><span data-stu-id="ba5c6-668">Bank account types are used for electronic payments to employees.</span></span> <span data-ttu-id="ba5c6-669">Los tipos de cuenta bancaria se asignan a Dayforce como información de cuenta de transferencia.</span><span class="sxs-lookup"><span data-stu-id="ba5c6-669">Bank account types are mapped to Dayforce as transfer account information.</span></span> <span data-ttu-id="ba5c6-670">Los tipos de cuenta bancaria se convierten, según proceda, en los valores aceptados en la integración.</span><span class="sxs-lookup"><span data-stu-id="ba5c6-670">The bank account types are translated, as appropriate, to the accepted values upon integration.</span></span>

| <span data-ttu-id="ba5c6-671">Talent</span><span class="sxs-lookup"><span data-stu-id="ba5c6-671">Talent</span></span>            | <span data-ttu-id="ba5c6-672">Dayforce</span><span class="sxs-lookup"><span data-stu-id="ba5c6-672">Dayforce</span></span>                  |
|-------------------|---------------------------|
| <span data-ttu-id="ba5c6-673">Cuenta corriente</span><span class="sxs-lookup"><span data-stu-id="ba5c6-673">Checking Account</span></span>  | <span data-ttu-id="ba5c6-674">CheckingAccount</span><span class="sxs-lookup"><span data-stu-id="ba5c6-674">CheckingAccount</span></span>           |
| <span data-ttu-id="ba5c6-675">Cuenta de nómina</span><span class="sxs-lookup"><span data-stu-id="ba5c6-675">Payroll Account</span></span>   | <span data-ttu-id="ba5c6-676">PayrollAccount</span><span class="sxs-lookup"><span data-stu-id="ba5c6-676">PayrollAccount</span></span>            |
| <span data-ttu-id="ba5c6-677">Cuenta de ahorros</span><span class="sxs-lookup"><span data-stu-id="ba5c6-677">Savings Account</span></span>   | <span data-ttu-id="ba5c6-678">*No se admite en México*</span><span class="sxs-lookup"><span data-stu-id="ba5c6-678">*Not supported by Mexico*</span></span> |
| <span data-ttu-id="ba5c6-679">Cuenta de BankGirot</span><span class="sxs-lookup"><span data-stu-id="ba5c6-679">BankGirot account</span></span> | <span data-ttu-id="ba5c6-680">*No se admite en México*</span><span class="sxs-lookup"><span data-stu-id="ba5c6-680">*Not supported by Mexico*</span></span> |
| <span data-ttu-id="ba5c6-681">Cuenta de PlusGirot</span><span class="sxs-lookup"><span data-stu-id="ba5c6-681">PlusGirot account</span></span> | <span data-ttu-id="ba5c6-682">*No se admite en México*</span><span class="sxs-lookup"><span data-stu-id="ba5c6-682">*Not supported by Mexico*</span></span> |

### <a name="earning-codes"></a><span data-ttu-id="ba5c6-683">Códigos de ganancia</span><span class="sxs-lookup"><span data-stu-id="ba5c6-683">Earning codes</span></span>

<span data-ttu-id="ba5c6-684">Los códigos de ganancias identifican de forma exclusiva cada tipo de ganancias que reciben trabajadores.</span><span class="sxs-lookup"><span data-stu-id="ba5c6-684">Earning codes uniquely identify every type of earnings that workers receive.</span></span> <span data-ttu-id="ba5c6-685">Los códigos abarcan varios parámetros relacionados con las ganancias, como las reglas de contabilidad, las leyes tributarias, los requisitos de informes y la capacidad de valor bruto.</span><span class="sxs-lookup"><span data-stu-id="ba5c6-685">The codes cover several parameters that are related to earnings, such as accounting rules, tax laws, reporting requirements, and gross-up capability.</span></span> <span data-ttu-id="ba5c6-686">Si se usa una frecuencia no admitida, la frecuencia **Cada sueldo** se utiliza de forma predeterminada para el cálculo.</span><span class="sxs-lookup"><span data-stu-id="ba5c6-686">If an unsupported frequency is used, the **Every Pay** frequency is used by default for the calculation.</span></span>

#### <a name="supported-frequencies"></a><span data-ttu-id="ba5c6-687">Frecuencias admitidas</span><span class="sxs-lookup"><span data-stu-id="ba5c6-687">Supported frequencies</span></span>

- <span data-ttu-id="ba5c6-688">Todas</span><span class="sxs-lookup"><span data-stu-id="ba5c6-688">All</span></span>
- <span data-ttu-id="ba5c6-689">EVERYPAY</span><span class="sxs-lookup"><span data-stu-id="ba5c6-689">EVERYPAY</span></span>
- <span data-ttu-id="ba5c6-690">EACHPAYPERIOD</span><span class="sxs-lookup"><span data-stu-id="ba5c6-690">EACHPAYPERIOD</span></span>
- <span data-ttu-id="ba5c6-691">EVRYOTHRPAYODD</span><span class="sxs-lookup"><span data-stu-id="ba5c6-691">EVRYOTHRPAYODD</span></span>
- <span data-ttu-id="ba5c6-692">EVRYOTHRPAYEVN</span><span class="sxs-lookup"><span data-stu-id="ba5c6-692">EVRYOTHRPAYEVN</span></span>
- <span data-ttu-id="ba5c6-693">1OFMTH</span><span class="sxs-lookup"><span data-stu-id="ba5c6-693">1OFMTH</span></span>
- <span data-ttu-id="ba5c6-694">LASTOFMTH</span><span class="sxs-lookup"><span data-stu-id="ba5c6-694">LASTOFMTH</span></span>
- <span data-ttu-id="ba5c6-695">2OFMTH</span><span class="sxs-lookup"><span data-stu-id="ba5c6-695">2OFMTH</span></span>
- <span data-ttu-id="ba5c6-696">3OFMTH</span><span class="sxs-lookup"><span data-stu-id="ba5c6-696">3OFMTH</span></span>
- <span data-ttu-id="ba5c6-697">4OFMTH</span><span class="sxs-lookup"><span data-stu-id="ba5c6-697">4OFMTH</span></span>
- <span data-ttu-id="ba5c6-698">5OFMTH</span><span class="sxs-lookup"><span data-stu-id="ba5c6-698">5OFMTH</span></span>
- <span data-ttu-id="ba5c6-699">1N2OFMTH</span><span class="sxs-lookup"><span data-stu-id="ba5c6-699">1N2OFMTH</span></span>
- <span data-ttu-id="ba5c6-700">3N4OFMTH</span><span class="sxs-lookup"><span data-stu-id="ba5c6-700">3N4OFMTH</span></span>
- <span data-ttu-id="ba5c6-701">1N3OFMTH</span><span class="sxs-lookup"><span data-stu-id="ba5c6-701">1N3OFMTH</span></span>
- <span data-ttu-id="ba5c6-702">1N4OFMTH</span><span class="sxs-lookup"><span data-stu-id="ba5c6-702">1N4OFMTH</span></span>
- <span data-ttu-id="ba5c6-703">2N3OFMTH</span><span class="sxs-lookup"><span data-stu-id="ba5c6-703">2N3OFMTH</span></span>
- <span data-ttu-id="ba5c6-704">2N4OFMTH</span><span class="sxs-lookup"><span data-stu-id="ba5c6-704">2N4OFMTH</span></span>
- <span data-ttu-id="ba5c6-705">1N2N3OFMTH</span><span class="sxs-lookup"><span data-stu-id="ba5c6-705">1N2N3OFMTH</span></span>
- <span data-ttu-id="ba5c6-706">1N2N4OFMTH</span><span class="sxs-lookup"><span data-stu-id="ba5c6-706">1N2N4OFMTH</span></span>
- <span data-ttu-id="ba5c6-707">1N3N4OFMTH</span><span class="sxs-lookup"><span data-stu-id="ba5c6-707">1N3N4OFMTH</span></span>
- <span data-ttu-id="ba5c6-708">2N3N4OFMTH</span><span class="sxs-lookup"><span data-stu-id="ba5c6-708">2N3N4OFMTH</span></span>
- <span data-ttu-id="ba5c6-709">1N2N3N4OFMTH - 1N2N3N4OFMTH</span><span class="sxs-lookup"><span data-stu-id="ba5c6-709">1N2N3N4OFMTH - 1N2N3N4OFMTH</span></span>
- <span data-ttu-id="ba5c6-710">2N3N4N5OFMth - 2N3N4N5OFMth</span><span class="sxs-lookup"><span data-stu-id="ba5c6-710">2N3N4N5OFMth - 2N3N4N5OFMth</span></span>
- <span data-ttu-id="ba5c6-711">1OFQTR - 1OFQTR</span><span class="sxs-lookup"><span data-stu-id="ba5c6-711">1OFQTR - 1OFQTR</span></span>
- <span data-ttu-id="ba5c6-712">LASTOFQTR – LASTOFQTR</span><span class="sxs-lookup"><span data-stu-id="ba5c6-712">LASTOFQTR – LASTOFQTR</span></span>
- <span data-ttu-id="ba5c6-713">LASTMTHOFQTR – LASTMTHOFQTR</span><span class="sxs-lookup"><span data-stu-id="ba5c6-713">LASTMTHOFQTR – LASTMTHOFQTR</span></span>
- <span data-ttu-id="ba5c6-714">1OFYEAR - 1OFYEAR</span><span class="sxs-lookup"><span data-stu-id="ba5c6-714">1OFYEAR - 1OFYEAR</span></span>
- <span data-ttu-id="ba5c6-715">LASTOFYEAR – LASTOFYEAR</span><span class="sxs-lookup"><span data-stu-id="ba5c6-715">LASTOFYEAR – LASTOFYEAR</span></span>
- <span data-ttu-id="ba5c6-716">NOVNDECOFYEAR - NOVNDECOFYEAR</span><span class="sxs-lookup"><span data-stu-id="ba5c6-716">NOVNDECOFYEAR - NOVNDECOFYEAR</span></span>

### <a name="addresses"></a><span data-ttu-id="ba5c6-717">Direcciones</span><span class="sxs-lookup"><span data-stu-id="ba5c6-717">Addresses</span></span>

<span data-ttu-id="ba5c6-718">La identificación de códigos específicos de país o región, estado y condado (municipio) requiere formatos específicos que los proveedores de Dayforce y en el país o región puedan reconocer.</span><span class="sxs-lookup"><span data-stu-id="ba5c6-718">The identification of specific country or region, state, and county (municipality) codes requires specific formats that Dayforce and in-country/in-region providers can recognize.</span></span> <span data-ttu-id="ba5c6-719">Aunque el formato de las ciudades sea flexible, cada una debe asociarse a un estado.</span><span class="sxs-lookup"><span data-stu-id="ba5c6-719">Although the format for cities is flexible, every city must be associated with a state.</span></span>

| <span data-ttu-id="ba5c6-720">Talent</span><span class="sxs-lookup"><span data-stu-id="ba5c6-720">Talent</span></span>              | <span data-ttu-id="ba5c6-721">Dayforce</span><span class="sxs-lookup"><span data-stu-id="ba5c6-721">Dayforce</span></span>              |
|---------------------|-----------------------|
| <span data-ttu-id="ba5c6-722">País/región</span><span class="sxs-lookup"><span data-stu-id="ba5c6-722">Country/Region</span></span>      | <span data-ttu-id="ba5c6-723">Código de país</span><span class="sxs-lookup"><span data-stu-id="ba5c6-723">Country Code</span></span>          |
| <span data-ttu-id="ba5c6-724">Código postal</span><span class="sxs-lookup"><span data-stu-id="ba5c6-724">Zip/Postal Code</span></span>     | <span data-ttu-id="ba5c6-725">Código postal</span><span class="sxs-lookup"><span data-stu-id="ba5c6-725">Postal Code</span></span>           |
| <span data-ttu-id="ba5c6-726">Comunidad autónoma</span><span class="sxs-lookup"><span data-stu-id="ba5c6-726">State</span></span>               | <span data-ttu-id="ba5c6-727">Código de la comunidad autónoma</span><span class="sxs-lookup"><span data-stu-id="ba5c6-727">State Code</span></span>            |
| <span data-ttu-id="ba5c6-728">Población</span><span class="sxs-lookup"><span data-stu-id="ba5c6-728">City</span></span>                | <span data-ttu-id="ba5c6-729">Población</span><span class="sxs-lookup"><span data-stu-id="ba5c6-729">City</span></span>                  |
| <span data-ttu-id="ba5c6-730">Comarca</span><span class="sxs-lookup"><span data-stu-id="ba5c6-730">County</span></span>              | <span data-ttu-id="ba5c6-731">Condado (municipio)</span><span class="sxs-lookup"><span data-stu-id="ba5c6-731">County (Municipality)</span></span> |
| <span data-ttu-id="ba5c6-732">Calle</span><span class="sxs-lookup"><span data-stu-id="ba5c6-732">Street</span></span>              | <span data-ttu-id="ba5c6-733">Línea de dirección 1</span><span class="sxs-lookup"><span data-stu-id="ba5c6-733">Address Line 1</span></span>        |
| <span data-ttu-id="ba5c6-734">Número de calle</span><span class="sxs-lookup"><span data-stu-id="ba5c6-734">Street Number</span></span>       | <span data-ttu-id="ba5c6-735">Línea de dirección 2</span><span class="sxs-lookup"><span data-stu-id="ba5c6-735">Address Line 2</span></span>        |
| <span data-ttu-id="ba5c6-736">Complemento de edificio</span><span class="sxs-lookup"><span data-stu-id="ba5c6-736">Building Complement</span></span> | <span data-ttu-id="ba5c6-737">Línea de dirección 5</span><span class="sxs-lookup"><span data-stu-id="ba5c6-737">Address Line 5</span></span>        |

### <a name="passport-number"></a><span data-ttu-id="ba5c6-738">Número de pasaporte</span><span class="sxs-lookup"><span data-stu-id="ba5c6-738">Passport number</span></span>

<span data-ttu-id="ba5c6-739">Los empleados pueden declarar la información del pasaporte.</span><span class="sxs-lookup"><span data-stu-id="ba5c6-739">Employees can declare passport information.</span></span> <span data-ttu-id="ba5c6-740">Esta información es del tipo de identificación **Pasaporte** y se integra en Dayforce como parte de la información específica de México de un empleado.</span><span class="sxs-lookup"><span data-stu-id="ba5c6-740">This information is of the **Passport** identification type and is integrated into Dayforce as part of an employee's Mexico-specific information.</span></span>

- <span data-ttu-id="ba5c6-741">Tipo de identificación = "Pasaporte"</span><span class="sxs-lookup"><span data-stu-id="ba5c6-741">Identification Type = "Passport"</span></span>
- <span data-ttu-id="ba5c6-742">Fecha de emisión</span><span class="sxs-lookup"><span data-stu-id="ba5c6-742">Issued Date</span></span>
- <span data-ttu-id="ba5c6-743">Fecha de vencimiento</span><span class="sxs-lookup"><span data-stu-id="ba5c6-743">Expiration Date</span></span>

<span data-ttu-id="ba5c6-744">Los empleados pueden declarar números de identificación múltiples del tipo de identificación del **Pasaporte**.</span><span class="sxs-lookup"><span data-stu-id="ba5c6-744">Employees can declare multiple identification numbers of the **Passport** identification type.</span></span> <span data-ttu-id="ba5c6-745">Sin embargo, solo la entrada de pasaporte activa actual se integra en Dayforce.</span><span class="sxs-lookup"><span data-stu-id="ba5c6-745">However, only the current active passport entry is integrated into Dayforce.</span></span> <span data-ttu-id="ba5c6-746">Si todas las entradas de pasaporte han caducado, el pasaporte que se emitió más recientemente se integra en Dayforce.</span><span class="sxs-lookup"><span data-stu-id="ba5c6-746">If all passport entries are expired, the passport that was most recently issued is integrated into Dayforce.</span></span>
