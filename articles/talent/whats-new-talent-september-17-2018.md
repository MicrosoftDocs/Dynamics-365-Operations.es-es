...
**Compilación 8.1.154.0**

Este tema describe las características que son nuevas o que se han cambiado en Core HR.

## <a name="leave-and-absence--accrue-time-based-on-hours-worked"></a>Baja y ausencias – tiempo acumulado basado en horas trabajadas
...
-   En la Platform update 18 para Finance and Operations, el cliente Web de Talent ahora adapta sus representaciones visuales con Microsoft Fluent Design.
    ...
    -   Cambios en cómo los campos se muestran en modo de lectura.
