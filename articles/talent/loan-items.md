...
Cada artículo físico debe tener un artículo correspondiente de préstamo. Cada registro de artículo de préstamo debe describir lo que se está prestando, la persona responsable del préstamo y el número de días que se puede prestar el artículo a un trabajador. Puede crear varios artículos en préstamo al mismo tiempo, como llaves, tarjetas de acceso o uniformes. 
...
Los gerentes pueden ver los artículos prestados para sus informes directos. También pueden disponer de permiso para agregar nuevos artículos de préstamo en nombre de sus empleados.
 ...
 <a name="account-for-lost-or-misplaced-loan-items"></a>Cuenta para los artículos de préstamos perdidos o mal colocados
-----------------------------------------
