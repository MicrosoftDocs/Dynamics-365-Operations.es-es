...
---
# <a name="whats-new-or-changed-in-dynamics-365-talent-january-14-2020"></a>Novedades y cambios en Dynamics 365 Talent (14 de enero de 2020)
...
Los cambios que se describen en esta sección se aplican a la compilación número 8.1.2709. Los números entre paréntesis en algunos encabezados hacen referencia a los números de soporte en Microsoft Dynamics Lifecycle Services (LCS).

### <a name="system-unable-to-generate-calendar-days-when-importing-through-data-management-framework-381195"></a>El sistema no puede generar días de calendario al importar a través del Marco de administración de datos (381195)

Este cambio corrige un problema en el que la importación de días de calendario genera el error **Formato de fecha no válido**. Este error impide la creación de líneas de fecha de calendario de trabajo.
