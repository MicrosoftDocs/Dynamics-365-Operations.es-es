...
Ahora se pueden ver los registros con fecha de vencimiento en el autoservicio de directores. Las nuevas opciones le permiten configurar qué información estará disponible para que la vean los administradores. Esas opciones incluyen:
...
Por ejemplo, los administradores que solicitan transferencias de empleado pueden no tener acceso para realizar sugerencias o para especificar importes de compensación asociados a la solicitud de transferencia. Los responsables pueden crear y enviar solicitudes de transferencia, pero no pueden especificar asignaciones de compensación o de la lista de tareas. En esta misma configuración, RR. HH. puede asignar nuevos valores de compensación y asignar cualquier lista de comprobación adicional que se completará como resultado de completar la transferencia.
