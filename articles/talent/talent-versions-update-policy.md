...
---
# <a name="talent-system-requirements"></a>Requisitos del sistema de Talent

[!include [banner](includes/banner.md)]

Este tema describe los requisitos para Microsoft Dynamics 365 Talent, incluido Attract y Onboard. También describe los países y regiones donde Talent está disponible, además de información sobre idiomas y ubicación para los datos de Talent. Además, este tema proporciona la actualización de la directiva de Talent.
