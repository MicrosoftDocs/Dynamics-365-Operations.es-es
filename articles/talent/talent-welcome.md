...
Microsoft Dynamics 365 Talent simplifica muchas tareas rutinarias de mantenimiento de registros y automatiza un gran número de procesos relacionados con la dotación de personal para la organización. Estos procesos incluyen la conservación de empleados, la administración de prestaciones, la formación, las evaluaciones de desempeño y la administración de cambios. También proporciona un marco de trabajo para que el personal de recursos humanos administre las áreas de supervisión.
...
Explore Dynamics 365 Talent viendo el vídeo [Introducción a Dynamics 365 Talent.](https://www.youtube.com/watch?v=6rg2ByadbN0)


> [!NOTE] 
> Dynamics 365 Talent está estrechamente relacionado con los recursos humanos en Dynamics 365 Finance. Puede que ambos productos tengan la misma funcionalidad. Como resultado, en los temas relacionados principalmente con Recursos humanos, el nombre del producto será Dynamics 365 Finance. En los temas relacionados principalmente con Talent, el nombre del producto será Dynamics 365 Talent. Los temas que se redactan para un producto se pueden aplicar a la misma funcionalidad de un producto relacionado.
...
-   [Cómo administrar compensaciones en Dynamics 365 Talent (vídeo)](https://www.youtube.com/watch?v=lEw5oKopHDk)
