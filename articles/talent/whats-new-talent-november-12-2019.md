...
---
# <a name="whats-new-or-changed-in-dynamics-365-talent-november-12-2019"></a>Novedades y cambios en Dynamics 365 Talent (12 de noviembre de 2019)
...
Los cambios que se describen en esta sección se aplican a la compilación número 8.1.2604. Los números entre paréntesis en algunos encabezados hacen referencia a los números de soporte en Microsoft Dynamics Lifecycle Services (LCS).

### <a name="office-location-isnt-updated-via-excel-workbook-369727"></a>La ubicación de Office no está actualizada a través del libro de Excel (369727)

Con este cambio, ahora puede actualizar la ubicación de Office mediante el diseñador de libros de trabajo de Office.
