...
ms.locfileid: "2897290"
---
# <a name="whats-new-or-changed-in-dynamics-365-for-talent-september-17-2019"></a>Novedades y cambios en Dynamics 365 for Talent (17 de septiembre de 2019)
...
Los cambios que se describen en esta sección se aplican a la compilación número 8.1.2492. Los números entre paréntesis en algunos encabezados hacen referencia a los números de soporte en Microsoft Dynamics Lifecycle Services (LCS).
...
### <a name="human-resources-staff-cant-see-performance-review-details-once-assigned-to-them-by-workflow-370308"></a>El personal de recursos humanos no puede ver los detalles de la evaluación del rendimiento una vez asignados a ellos por el flujo de trabajo (370308)

Con la actualización de esta semana, los profesionales de recursos humanos podrán ver los detalles de la evaluación del rendimiento que se han asignado ellos con el proceso del flujo de trabajo. Para ver estudios, vaya a **Autoservicio para empleados > Elementos que me han asignado**.

### <a name="job-family-field-missing-in-the-manage-changes-page-for-job-details-346031"></a>Falta el campo de la familia de trabajo en la página para gestionar los detalles del trabajo (346031)

En esta versión, el campo de la familia de trabajo se ha agregado a la página **Gestionar los cambios** para los detalles de trabajo.
