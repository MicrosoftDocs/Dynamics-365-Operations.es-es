...
description: Este artículo explica de qué manera los distribuidores pueden crear y administrar manualmente listas de productos para los clientes de Microsoft Dynamics 365 Commerce.
author: bebeale
ms.date: 05/26/2020
ms.topic: article
ms.prod: ''
...
Este artículo explica de qué manera los distribuidores pueden crear y administrar manualmente listas de recomendaciones de productos para los clientes de Microsoft Dynamics 365 Commerce.
