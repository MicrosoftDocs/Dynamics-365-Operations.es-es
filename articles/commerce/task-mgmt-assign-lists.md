...
Antes de comenzar el proceso de asignación de tareas, asegúrese de haber creado una lista de tareas siguiendo los pasos del artículo [Crear listas de tareas y agregar tareas](task-mgmt-create-lists.md). Para comenzar el proceso de asignación de una lista de tareas, siga estos pasos.
