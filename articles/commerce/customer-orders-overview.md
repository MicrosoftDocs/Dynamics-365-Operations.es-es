...
Este tema proporciona información acerca de los pedidos de cliente en Modern POS (MPOS). Los pedidos de cliente también se conocen como pedidos especiales. El tema incluye una discusión de parámetros y flujos de transacción relacionados.
...
A continuación se muestran algunos de los parámetros que se pueden configurar en la página **Parámetros de Commerce** para definir cómo se realizan los pedidos de cliente:
...
### <a name="create-a-customer-order-in-modern-pos"></a>Crear un pedido de cliente en Modern POS
