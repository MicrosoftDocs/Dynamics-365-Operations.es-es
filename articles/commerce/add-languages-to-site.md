...
description: Este artículo explica cómo agregar compatibilidad para idiomas adicionales a un sitio de Microsoft Dynamics 365 Commerce.
...
ms.locfileid: "9281188"
---
# <a name="add-languages-to-your-site"></a>Agregar idiomas al sitio

[!include [banner](includes/banner.md)]

Este artículo explica cómo agregar compatibilidad para idiomas adicionales a un sitio de Microsoft Dynamics 365 Commerce.

Puede localizar su sitio web en cualquier idioma admitido por Commerce. (La lista de idiomas admitidos aparece más adelante en este artículo.) Para agregar un idioma en su sitio web, primero debe agregarlo a una tienda en línea que esté enlazada a su sitio.
...
El idioma que ha agregado estará ahora disponible de modo que pueda configurar su sitio para utilizarlo en el entorno de creación del sitio.

### <a name="languages-that-are-supported-by-dynamics-365-commerce"></a>Idiomas que se admiten por Dynamics 365 Commerce
