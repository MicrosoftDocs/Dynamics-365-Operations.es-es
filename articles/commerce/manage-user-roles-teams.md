...
Para más información, consulte [Asignar propietarios y miembros del equipo en Microsoft Teams](https://docs.microsoft.com/microsoftteams/assign-roles-permissions).
