...
description: En este artículo se tratan los módulos de contenedor y se describe cómo agregarlos a las páginas de sitio en Microsoft Dynamics 365 Commerce.
author: anupamar-ms
ms.date: 05/18/2022
ms.topic: article
ms.prod: ''
...
1. En el cuadro de diálogo **Crear nueva página**, en **Nombre de página**, introduzca una **Página de contenedor** y luego seleccione **Siguiente**.
1. En **Elegir plantilla**, seleccione la **Plantilla de contenedor** que ha creado y, a continuación, seleccione **Siguiente**.
