...
description: En este artículo se tratan los módulos de características interactivas y se describe cómo agregarlos a las páginas de sitio en Microsoft Dynamics 365 Commerce.
author: anupamar-ms
ms.date: 05/18/2022
ms.topic: article
ms.prod: ''
...
ms.locfileid: "9284724"
---
# <a name="interactive-feature-module"></a>Módulo de funciones interactivas

[!include [banner](includes/banner.md)]

En este artículo se tratan los módulos de características interactivas y se describe cómo agregarlos a las páginas de sitio en Microsoft Dynamics 365 Commerce.
...
1. En el cuadro de diálogo **Seleccionar módulos**, seleccione el módulo **Característica interactiva** y, a continuación, **Aceptar**.
...
1. En el cuadro de diálogo **Seleccionar módulos**, en **Seleccionar módulos**, seleccione el módulo **Característica interactiva** y, a continuación, **Aceptar**.
1. En el panel de propiedades del módulo de características interactivas, agregue un encabezado.
1. En el espacio **Característica interactiva**, seleccione el botón de puntos suspensivos (**...**) y después seleccione **Agregar módulo**.
1. En el cuadro de diálogo **Seleccionar módulos**, seleccione el módulo **Elemento de características interactivas** y, a continuación, **Aceptar**.
1. En el panel de propiedades del módulo de elementos de características interactivas, agregue una imagen, un texto de encabezado, un texto de párrafo y una URL.
