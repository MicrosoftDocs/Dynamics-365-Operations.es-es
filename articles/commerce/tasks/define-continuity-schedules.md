...
description: Este artículo explica la configuración de un programa de continuidad (conocido también como pedidos recurrentes).
author: josaw1
ms.date: 08/29/2018
...
ms.locfileid: "8885093"
---
# <a name="define-continuity-schedules"></a>Definir programaciones de continuidad

[!include [banner](../includes/banner.md)]

Este artículo explica la configuración de un programa de continuidad (conocido también como pedidos recurrentes). Este artículo usa la empresa USRT en los datos de demostración.
