...
Este artículo proporciona información sobre canales de tiendas en línea y acerca de cómo configurarlas en Dynamics 365 Commerce.

Commerce admite varios canales comerciales. Estos canales incluyen tiendas en línea, centros de llamadas y tiendas minoristas (también conocidas como tiendas físicas). Las tiendas en línea proporcionan al distribuidor una presencia en línea, de modo que los clientes puedan comprar productos de su tienda en línea además de en sus tiendas físicas. Si los clientes compran productos en la tienda en línea, esos productos se les pueden enviar o los clientes pueden recogerlos en una tienda local. 

Puede crear una tienda en línea en el cliente de Commerce. A continuación esta tienda en línea se publica en un tienda en línea de terceros que se integra con Commerce. Su tienda en línea de terceros sirve como escaparate electrónico (interfaz de usuario) para la tienda en línea y le proporciona una serie de capacidades de sistema de gestión del cliente (CMS) y de interfaz de usuario. Varias integraciones de este tipo están disponibles. 

Las propiedades que defina para la tienda en línea controlan el comportamiento de la tienda en línea. Por ejemplo, puede definir la jerarquía de categorías de navegación y asignarla a la tienda en línea. Cuando se publique la tienda en línea en la tienda en línea de terceros, la jerarquía de categorías de navegación aparecen en la versión en línea de la tienda. Después, ,los compradores usan la jerarquía de categorías de navegación para explorar la tienda en línea y para buscar productos. 

Para crear una tienda en línea, debe configurar los componentes que permiten el procesamiento de transacciones para la tienda. Por ejemplo, debe agregar los surtidos, aplicar atributos y establecer métodos de pago y métodos de envío. También puede definir precios, promociones, descuentos, acuerdos comerciales y condiciones de envío específicos de la tienda en línea. 

Después publicar la tienda en línea en la tienda en línea de terceros, puede crear catálogos de productos para la tienda en línea. Los productos del catálogo se convierten en listados de productos en la tienda en línea. Cuando un comprador adquiere productos de la tienda en línea, el inventario disponible se actualiza y se sincroniza en el cliente. Además, se generan pedidos de ventas para las compras y se envían al cliente para el cumplimiento y procesamiento de pedidos.
...
## <a name="commerce-channel-navigation-hierarchies"></a>Jerarquías de navegación de canales de Commerce

Antes de crear una tienda en línea, debe definir la jerarquía de navegación de canales de Commerce que desee usar en ella. La jerarquía de navegación de canales representa la jerarquía de categoría que se muestra en la tienda en línea después de la publicación del almacén. Cuando se publiquen catálogos de productos en la tienda en línea, los productos del catálogo se asignan a las categorías de la jerarquía de navegación de canales. Después los compradores usan la jerarquía para navegar por la tienda en línea.

## <a name="organization-hierarchies"></a>Jerarquías organizativas

Las jerarquías organizativas se usan para estructurar canales de Commerce y para representar las relaciones que hay entre las organizaciones que forman el negocio. Al configurar tiendas en línea, puede agregarlas a una jerarquía organizativa. A continuación, las tiendas comparten los datos que se usan para los surtidos, el reaprovisionamiento y los informes. 
