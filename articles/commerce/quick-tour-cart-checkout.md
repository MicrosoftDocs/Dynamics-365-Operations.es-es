...
La finalización de compra muestra un resumen de los artículos de línea del carro, de modo que el cliente pueda verificar el pedido antes de terminarlo. Los artículos de línea no se pueden editar durante el flujo de desprotección. Sin embargo, se proporciona un vínculo al carro en el caso de que el usuario desee volver y editar los artículos de línea.
