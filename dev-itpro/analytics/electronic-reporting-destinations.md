...
# Destinos de informes electrónicos
...
## Disponibilidad y requisitos previos generales
...
#### Correo electrónico de configuración
...
### He importado configuraciones electrónicas y las veo en la página Configuraciones de informes electrónicos. Pero, ¿por qué no las veo en la página Destinos de informes electrónicos?
...
### ¿Hay alguna manera de definir qué cuentas de Azure Storage y Azure Blob Storage se utilizan?
...
### ¿Cuál es el propósito del destino de archivo en la configuración del destino? ¿Qué hace esa configuración?
...
### ¿Puede dar un ejemplo de la fórmula que hace referencia a una cuenta de proveedor a la que puedo enviar correo electrónico?
