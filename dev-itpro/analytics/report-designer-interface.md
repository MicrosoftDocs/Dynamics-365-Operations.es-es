...
| Ver informe                       | Abre la versión más reciente del informe generado en Dynamics 365 para las operaciones. Este comando está disponible desde una definición del informe si ha generado al menos un informe.                                 |
...
| Importar jerarquía del conjunto de dimensiones         | Abrir el cuadro de diálogo **Jerarquía del conjunto de dimensiones**, donde puede importar una jerarquía del conjunto de dimensiones de los datos financieros. Este comando sólo está disponible de una definición del árbol del informe de errores para el. A. \ \ dimensiones financieras sistema dimensión- basado.  |
...
| Comando | Descripción                                                  |
|---------|--------------------------------------------------------------|
| Ayuda    | Abra las Dynamics 365 para la wiki de página de ayuda de operaciones para el informe financiero. |
|         |                                                              |
...
| Botón                                                                                                                                                                                   | Descripción                                                                                                                                                                            |
|------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| [![New button](./media/rowc130389.png)](./media/rowc130389.png)                              | Crear una nueva definición del informe, definición de la fila, definición de la columna o definición del organigrama (en blanco).                                                                               |
| [botón de Abierto![] (. /media/openfolderc130389.png])(. /media/openfolderc130389.png)               | Abrir una definición de la fila, definición de la columna, definición del organigrama o definición del informe existentes.                                                                                   |
| [botón para guardar![] (. /media/savec130389.png])(. /media/savec130389.png)                           | Guardar la definición de la fila, definición de la columna, definición del organigrama o definición del informe actuales.                                                                                   |
| [botón Copiar de![] (. /media/copyc130389.png])(. /media/copyc130389.png)                           | Copiar el texto seleccionado en el portapapeles.                                                                                                                                               |
| [botón de fallo![] (. /media/cutc130389.png])(. /media/cutc130389.png)                              | Eliminar el texto seleccionado y copiarlo en el Portapapeles.                                                                                                                                |
| [botón de pegar![] (. /media/pastec130389.png])(. /media/pastec130389.png)                        | Insertar el texto del portapapeles.                                                                                                                                                    |
| [![deshacer el botón (]. /media/undoc130389.png])(. /media/undoc130389.png)                           | Deshacer la última acción.                                                                                                                                                                  |
| [![rehace el botón (]. /media/redoc130389.png])(. /media/redoc130389.png)                           | Invertir la última acción que se deshizo.                                                                                                                                                          |
| [botón de búsqueda![] (. /media/findc130389.png])(. /media/findc130389.png)                           | Abra el cuadro de diálogo **Buscar y reemplazar**, donde puede buscar y reemplazar texto en la ventana activa.                                                                                  |
| [botón de la fila de Insertar![] (. /media/insertrowc130389.png])(. /media/insertrowc130389.png)           | Insertar una fila en blanco en la definición de fila o una fila de cabecera en blanco en la definición de columna. Este botón está disponible desde una definición de fila o una definición de columna.                    |
| [botón de la columna de Insertar![] (. /media/insertcolumnc130389.png])(. /media/insertcolumnc130389.png)  | Insertar una columna en blanco en la definición de la columna. Este botón está disponible desde una definición de columna.                                                                                  |
| [botón de bloqueo de![] (. /media/lockc130389.png])(. /media/lockc130389.png)                           | Aplicar una contraseña a la unidad del bloque de creación actual. Este botón está disponible para los usuarios que tienen el rol de **Diseñador** o de **Administrador**.                                                 |
| [botón del vínculo![la fila![] (. /media/rowlinkc130389.png])(. /media/rowlinkc130389.png)                 | Abrir el cuadro de diálogo **Vínculos de filas**, donde puede especificar las fuentes de los vínculos de datos en las definiciones de filas y en definiciones de los organigramas. Este botón está disponible desde una definición de la fila. |
| [![asciende el botón (]. /media/promotec130389.png])(. /media/promotec130389.png)                  | Promueva una unidad de la definición del organigrama. Cuando selecciona una unidad secundaria y hace clic en **Promover**, la unidad secundaria se transfiere al mismo nivel que su unidad principal.                |
| ![degrada [] (botón. /media/demotec130389.png])(. /media/demotec130389.png)                     | Degrade una unidad de la definición del organigrama. Cuando selecciona una unidad y hace clic en **Degradar**, la unidad se convierte en la unidad secundaria que la precede.                               |
| ![expande [] (botón. /media/expandtreebuttonc130389.png])(. /media/expandtreebuttonc130389.png) | Expandir todas las unidades de la definición del organigrama en el nivel de la unidad seleccionada.                                                                                                   |
| [botón de hundimiento![] (. /media/collapsec130389.png])(. /media/collapsec130389.png)               | Contraer el organigrama.                                                                                                                                                           |
| [botón de ayuda![] (. /media/helpc130389.png])(. /media/helpc130389.png)                           | Abra la Ayuda.                                                                                                                                                                             |
...
| [botón de la fuente de![] (. /media/fonttype.png])(. /media/fonttype.png)                                                 | Definir el texto actual al estilo de fuente seleccionado.              |
| [botón Tamaño de fuente![] (. /media/fontsize.png])(. /media/fontsize.png)                                            | Definir el texto actual al tamaño de fuente (en puntos). |
| [botón negrita de![] (. /media/boldc130389.png])(. /media/boldc130389.png)                                           | Poner el texto actual en negrita.                             |
| [botón cursiva de![] (. /media/italicsc130389.png])(. /media/italicsc130389.png)                                   | Poner el texto actual en cursiva.                           |
| [botón de la![la] (![. /media/underlinec130389.png])(. /media/underlinec130389.png)                            | Surayar el texto actual.                             |
| [botón de la sangría de la reducción![] (. /media/outdentlsc130389.png])(. /media/outdentlsc130389.png)                      | Reducir la sangría del texto actual.                |
| [botón de la sangría![aumento![] (. /media/indentlsc130389.png])(. /media/indentlsc130389.png)                        | Aumentar la sangría del texto actual.                |
| [botón de color![fondo![] (. /media/fillbackgroundcolorc130389.png])(. /media/fillbackgroundcolorc130389.png) | Cambiar el color de fondo de la celda actual.        |
| [botón de color de fuente![] (. /media/fontcolorc130389.png])(. /media/fontcolorc130389.png)                           | Cambiar el color del texto actual                   |
...
| Botón                                                                                                                                                                                          | Descripción                                                                                                                                                                  |
|-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| [botón de la definición del informe![] (. /media/reportc130389.png])(. /media/reportc130389.png)                 | Mostrar la definición del informe indicada en el menú **Ventana**.                                                                                                            |
| [botón de la definición de filas de![] (. /media/rowc130389.png])(. /media/rowc130389.png)                          | Mostrar la definición de filas que se asigna a la definición del informe activo.                                                                                                    |
| [botón de la definición de columna de![] (. /media/columnc130389.png])(. /media/columnc130389.png)                 | Mostrar la definición de columnas que se asigna a la definición del informe activo.                                                                                                 |
| [botón de la definición del árbol![] (. /media/treec130389.png])(. /media/treec130389.png)             | Mostrar la definición del organigrama que se asigna a la definición del informe activo.                                                                                         |
| [botón del visor de informes![] (. /media/reportviewerc130389.png])(. /media/reportviewerc130389.png)         | Iniciar el visor de informes y mostrar la versión más reciente del informe generado. Este botón está disponible desde una definición del informe si ha generado al menos un informe. |
| [![genera el botón del informe (]. /media/generate-to-ddvc130389.png])(. /media/generate-to-ddvc130389.png) | Generar un informe de la definición del informe activo. Este botón está disponible desde una definición del informe.                                                                      |
