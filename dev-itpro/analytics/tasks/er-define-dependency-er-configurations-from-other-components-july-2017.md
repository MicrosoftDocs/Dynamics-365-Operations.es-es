...
---
# <a name="define-the-dependency-of-configurations-from-othcomponents-for-electronic-reporting-er"></a>Definir la dependencia de las configuraciones de otros componentes para informes electrónicos (ER)
