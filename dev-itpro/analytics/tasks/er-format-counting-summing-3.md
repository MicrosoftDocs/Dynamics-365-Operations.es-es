...
---
# <a name="use-computations-to-make-the-output-for-counting-and-summing-for-electronic-reporting-er"></a>Usar los cálculos para generar el resultado de recuentos y sumas para informes electrónicos (ER)
