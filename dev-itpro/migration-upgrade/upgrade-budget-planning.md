...
# Actualización de la planificación presupuestaria
...
### Procesos de planificación presupuestaria
...
En AX 2012, los documentos de la justificación se guardaban en una carpeta de archivos adjuntos. No se actualiza ningún documento de justificación anterior. Ahora los documentos de justificación se almacenan en la base de datos. Si esta información debe guardarse en la versión actualizada, puede cargar los documentos de justificación finales de cada plan como un archivo adjunto usando el botón **Justificación** del panel de acciones. En AX 2012, las hojas de cálculo de Excel de cada plan presupuestario se creaban a partir de la plantilla. En Finance and Operations, todos los planes abren una copia del diseño. Sin embargo, no se guardan los cambios en el archivo de Excel. Las fórmulas o la información de soporte que se emplearon por cada plan se deben agregar mediante comentarios, un documento de justificación, o algún otro proceso suplementario.

## Configuración de un entorno actualizado desde AX 2012
...
### Definición de columnas y diseños
...
### Actualice los procesos de planificación presupuestaria para que usen el diseño adecuado para cada etapa del presupuesto
...
## Funciones adicionales que debe tener en cuenta en el proceso presupuestario
<a id="additional-features-to-consider-in-your-budgeting-process" class="xliff"></a>
### Espacio de trabajo de planificación presupuestaria
...
### Copia desde una asignación del plan presupuestario
...
### Generación de planes presupuestarios a partir de nuevos orígenes del presupuesto
...
### Seguimiento de importes más completo
<a id="more-complete-tracking-of-amounts" class="xliff"></a>

En AX 2012, la planificación presupuestaria tenía un solo importe del plan que se almacenaba para cada valor. En Finance and Operations, se ha ampliado el modelo de datos. Ahora hay el importe de la divisa de contabilidad, divisa de transacción, y divisa de notificación para cada valor. Durante la actualización, estas nuevas columnas se rellenan automáticamente para los datos existentes.

### No convertir divisa en la agregación
...
### Consulta desde un plan presupuestario de otros módulos que contribuyeron al presupuesto
...
### Sobrescribir o anexar al plan para las programaciones de asignación
...
### Conjunto predeterminado de dimensiones financieras para la configuración de la planificación presupuestaria
