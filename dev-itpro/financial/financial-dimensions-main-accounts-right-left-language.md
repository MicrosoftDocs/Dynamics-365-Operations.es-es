...
-   Al seleccionar el delimitador para los planes contables, seleccione una de las opciones de dobles delimitador: doble (guiónnúcleo), doble (barra_=__=_) o idénticas el período (.), o idénticas subrayado\_(\_).
