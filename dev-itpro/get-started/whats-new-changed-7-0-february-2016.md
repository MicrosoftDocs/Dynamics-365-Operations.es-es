---
title: Novedades o cambiado en Dynamics AX 7.0 (febrero de 2016)
...
# <a name="whats-new-or-changed-in-dynamics-ax-70-february-2016"></a>Novedades o cambiado en Dynamics AX 7.0 (febrero de 2016)
...
<td>Se agregaron las opciones de informe, para poder aplicar varios filtros cuando un usuario está viendo un informe. Un nuevo informe se genera en función de los filtros.</td>
...
<td>Analizar los datos financieros usando el contenido “de Power BI de rendimiento financiero de Monitor”.</td>
<td>No disponible</td>
...
<td>El sistema de ayuda en la versión actual de Dynamics AX muestra guías de tarea que se almacenan en el BPM de Microsoft Dynamics Lifecycle Services (LCS). El sistema de ayuda también muestra temas de la Wiki de Microsoft. Para obtener más información, consulte [Ayuda de Dynamics AX - Introducción help-overview.md] () y [la nueva tarea dirige disponible (febrero de 2016)](new-task-guides-available-february-2016.md).</td>
<td>Las guías de tarea proporcionan una experiencia guiada e interactiva que le lleva por los pasos de una tarea o de un proceso empresarial. Puede descargar y personalizar las guías de tareas que proporciona Microsoft. La wiki proporciona una forma más rápida y flexible de crear, entregar y actualizar la documentación del producto. Por lo tanto, ayuda a garantizar que puede acceder a la información técnica más reciente.</td>
</tr>
</tbody>
</table>
...
<td>Esta característica se ha implementado como electrónica configuración de informes. La función está disponible para Alemania y Austria.</td>
...
<td>Lista de saldo con el informe de las cuentas totales de grupo se implementa como un informe de SSRS LedgerAccountSum\_(franco).</td>
...
<td>La lista independiente de códigos de mercancía Intrastat se combina con jerarquía de producto del código de mercancía escrito.</td>
...
<td>El código de mercancía Intrastat tiene un campo de texto para identificar unidades adicionales, y ** producto ** la tarjeta tiene un campo para identificar la cantidad de unidades adicionales en kilogramos.</td>
...
<tr class="odd">
<td>Analizar los datos de ventas del canal “minoristas mediante el contenido de Power BI de rendimiento del canal minoristas de Monitor”.</td>
<td>No disponible</td>
...
<li>Proporciona los paquetes alternativos “confeccionados” de la entrega, como un sitio en la combinación/un almacén de datos/una variante o un modo de transporte, según el criterio más rápido de entrega (disponible la fecha más temprana) desde el que el usuario puede elegir.</li>
