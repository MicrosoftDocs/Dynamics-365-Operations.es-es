...
# Novedades o cambios en la versión 1611 de Dynamics 365 for Operations (noviembre de 2016)
...
### Gestión avanzada de almacén en una tienda al por menor
...
### Habilitar el comercio fluido para todos los canales
...
| Lo que puede hacer                                                                                                                                                                                                                                                                        | Por qué es importante                                                                                                                                                                                                                                                                                                                                                                                                                                                                |
|----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| Ver las recomendaciones personalizadas de productos en varios puntos de contacto en el punto de venta (PDV) para determinar el posible interés de un cliente sobre la base de su historial de compras, artículos en su lista de deseos, y artículos que otros clientes han comprado en línea y en tiendas físicas. | Para los minoristas con grandes catálogos, las recomendaciones personalizadas ayudan al cliente a descubrir los productos y a capacitar a los empleados de la tienda con una relación con clientes inteligente. Al mostrar productos orientados a los intereses y hábitos de compra de un cliente, las recomendaciones de productos pueden ayudar a aumentar las ventas minoristas y mejorar la retención de clientes. En Microsoft Dynamics 365 for Retail, las recomendaciones de productos son impulsadas por servicios cognitivos y el aprendizaje automático de Microsoft Azure. |

### Grabador de tareas de PDV
...
### Sistema de la tienda: proporcionar una experiencia fluida en las instalaciones de la tienda
...
### Aplicación de la plataforma de Windows universal para PDV moderno al por menor
...
| Obtenga más información acerca del soporte de envío de Dynamics 365 for Operations                                                                                                         | Para obtener más información sobre el soporte para los procesos de envío, consulte [Envío](/dynamics365/unified-operations/supply-chain/inventory/consignment), [Configuración del envío](/dynamics365/unified-operations/supply-chain/inventory/set-up-consignment), [Crear un pedido de reabastecimiento de envío (Guía de tareas)](http://ax.help.dynamics.com/en/wiki/create-a-consignment-replenishment-order/), y [Cambiar la propiedad del inventario de envío en base a la demanda de la producción (Guía de tareas)](http://ax.help.dynamics.com/en/wiki/change-the-ownership-of-consignment-inventory-based-on-production-demand/).                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                    |

### Colaboración del proveedor (conocido anteriormente como el Portal de proveedores)
...
| Obtenga más información acerca de la colaboración del proveedor de Dynamics 365 for Operations. | Para obtener más información acerca de la colaboración del proveedor, consulte [Colaboración de proveedor con los proveedores externos](/dynamics365/unified-operations/supply-chain/procurement/vendor-collaboration-work-external-vendors), [Colaboración de proveedor con los clientes](/dynamics365/unified-operations/supply-chain/procurement/vendor-collaboration-work-customers-dynamics-365-operations), [Gestionar usuarios de colaboración del proveedor](/dynamics365/unified-operations/supply-chain/procurement/manage-vendor-collaboration-users), [Configurar y mantener la colaboración del proveedor](/dynamics365/unified-operations/supply-chain/procurement/set-up-maintain-vendor-collaboration), y [Espacio de trabajo de facturación de la colaboración del proveedor](/dynamics365/unified-operations/financials/accounts-payable/vendor-portal-invoicing-workspace).                                                         |

### Procesamiento de pedidos de empresa vinculada
...
### Mejoras del almacén para los centros de distribución de grandes cantidades
...
### Mejoras de la operación de almacén
...
### Mejoras de menor importancia de la Gestión de cadenas de suministro
