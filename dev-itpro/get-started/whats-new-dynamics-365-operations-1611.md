...
| Use los períodos de revisión para definir el intervalo de tiempo para la revisión.                                    | Puede definir un período de tiempo para una evaluación de rendimiento y las fechas de inicio y fin de la revisión se especificarán automáticamente. Sin embargo, puede cambiar las fechas predeterminadas según sea necesario.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                       |
| Acceso cinco paquetes de contenido de Power BI para Recursos humanos                                     | Los nuevos paquetes contentos permiten a organizaciones Recurso humano y a los administradores de Recursos humanos para analizar lo siguiente: Métrica de conservación de trabajadores • Desgloses demográficos de la edad, de edad, y el estado civil • Comparar el año de los índices de ropa durante año y ver los empleados de una lista de motivos haber dado para permitir a la organización • Permite ver una lista de puestos abierto, así como una comparación de abierto a la compensación cierra y prestaciones de puestos • Comparar a los empleados por hora y a sueldo • Ver el número de empleados inscritos en beneficios disponible • Permite ver los empleados por escrito contratación el empleo • Analizar candidatos basados en el número de candidatos, de dónde proceden, y qué puestos se aplican para la formación de organización • Certificado del curso registro por ubicación • Asistencia de Couse de estado • La lista de empleados registradas para las capacidades y el desarrollo de empleado de los cursos • Lista de conocimientos retenidos por los empleados • Desglose de tipos de aptitudes de miembro del equipo |
...
<td>Banco CD Misc. Formato de la asignación de gasto para la Arabia Saudí</td>
</tr>
<tr class="odd">
...
| Lo que puede hacer                                                                                                                                                                                                      | Por qué es importante                                                                                                                                                                                                                                                                                                                                                                                                                 |
|----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| Establezca la configuración de pedido predeterminada para ventas y compras, en función de las dimensiones de producto activo en el producto principal. Por lo tanto, puede definir la configuración predeterminada de pedido para la referencia de almacén (SKU) o una SKU parcial. | Puede especificar la configuración predeterminada del pedido que se aplica a una dimensión de producto o una combinación de dimensiones de producto. ** Ejemplo ** venda un producto que se denomina Polo T-shirt. Este producto está disponible en dos colores: verde y azul. También está disponible en dos tallas: pequeña y mediana. El Color y la Talla son dimensiones de producto activo para la camiseta Polo. Puede bloquear las compras de todas las camisetas verdes Polo, independientemente de su talla. |
...
### <a name="personalized-product-recommendations"></a>Recomendaciones personalizadas del producto

| Lo que puede hacer                                                                                                                                                                                                                                                                        | Por qué es importante                                                                                                                                                                                                                                                                                                                                                                                                                                                                |
|----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| Ver las recomendaciones personalizadas de productos en los touchpoints varios en el punto de venta (POS) de determinar qué puede ser interesado en un cliente basado en el historial de compra, los artículos de la lista de solicitudes, y los artículos que compraron otros clientes en línea y en Tiendas de físicas mortero | Para los minoristas con los catálogos tamaño, las recomendaciones personalizadas ayudan al cliente con descubrimiento de productos y todos los socios de la tienda con clienteling inteligente. Presentar los productos mediante los intereses de un cliente y los hábitos de compra, las recomendaciones de producto pueden ayudar a minoristas con el upsell y pueden ampliar la retención de cliente. En Dynamics 365 para las operaciones (al por menor, recomendaciones del producto son accionados por el lugar cognoscitivo de servicios y de equipo de Microsoft Azure. |
...
| Obtenga más información acerca del soporte de envío de Dynamics 365 for Operations                                                                                                         | Para obtener más información acerca del soporte para los procesos de envío, consulte envío [] (/dynamics365/operations/scm/inventory/consignment), el envío [] de la configuración (/dynamics365/operations/scm/inventory/setup-consignment), [cree un reabastecimiento de envío pedido (Guía de la tarea)](http://ax.help.dynamics.com/en/wiki/create-a-consignment-replenishment-order/), y [cambie la propiedad del inventario de envío en función de la demanda de la producción (Guía de la tarea)](http://ax.help.dynamics.com/en/wiki/change-the-ownership-of-consignment-inventory-based-on-production-demand/).                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                    |
...
| Obtenga más información acerca de la colaboración del proveedor de Dynamics 365 for Operations. | Para obtener más información acerca de la colaboración del proveedor, consulte [Colaboración de proveedor con los proveedores externos](/dynamics365/operations/scm/procurement/vendor-collaboration-work-external-vendors), [Colaboración de proveedor con los clientes](/dynamics365/operations/scm/procurement/vendor-collaboration-work-customers-dynamics-365-operations), [Gestionar usuarios de colaboración del proveedor](/dynamics365/operations/scm/procurement/manage-vendor-collaboration-users), [Configurar y mantener la colaboración del proveedor](/dynamics365/operations/scm/procurement/set-up-maintain-vendor-collaboration), y [Espacio de trabajo de facturación de la colaboración del proveedor](/dynamics365/operations/financials/accounts-payable/vendor-portal-invoicing-workspace).                                                         |
...
<tbody>
<tr class="odd">
<td>Definir, directamente en las líneas de pedido de ventas, dónde debería originarse la demanda y cómo debería abastecerse. <strong>Ejemplo</strong> Crear una línea de pedido de ventas, y especifique la entrega directa como el tipo de entrega. Se añadirá el proveedor principal a la línea de pedido de ventas como punto de abastecimiento.</td>
