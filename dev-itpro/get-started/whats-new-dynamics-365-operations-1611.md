...
| Obtenga más información acerca del soporte de envío de Dynamics 365 for Operations                                                                                                         | Para obtener más información sobre el soporte para los procesos de envío, consulte [Envío](/dynamics365/operations/scm/inventory/consignment), [Configuración del envío](/dynamics365/operations/scm/inventory/set-up-consignment), [Crear un pedido de reabastecimiento de envío (Guía de tareas)](http://ax.help.dynamics.com/en/wiki/create-a-consignment-replenishment-order/), y [Cambiar la propiedad del inventario de envío en base a la demanda de la producción (Guía de tareas)](http://ax.help.dynamics.com/en/wiki/change-the-ownership-of-consignment-inventory-based-on-production-demand/).                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                    |
