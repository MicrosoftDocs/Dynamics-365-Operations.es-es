...
Para generar la previsión, Dynamics 365 for Operations usa un servicio web de Aprendizaje automático. Para conectarse con el servicio, debe proporcionar a Dynamics 365 for Operations la siguiente información si inicia sesión en Estudio de aprendizaje automático de Microsoft Azure.
