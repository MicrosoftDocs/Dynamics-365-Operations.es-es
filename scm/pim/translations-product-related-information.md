---
title: "Preguntas más frecuentes relacionadas con el producto de las traducciones"
...
# <a name="product-related-translations-faq"></a>Preguntas más frecuentes relacionadas con el producto de las traducciones
...
## <a name="how-do-i-create-translations-for-productrelated-information"></a>¿Cómo creo las traducciones para la información relacionada con el producto?
...
2.  Seleccione un producto y, en el panel de acciones, en los idiomas ** ** el grupo, haga clic en ** traducciones **.
3.  En la página **Traducción de texto** del campo de **Idioma** , seleccione un idioma. Para agregar más idiomas, expanda ** idioma ** campos, y haga clic en ** éste **.
...
4.  En la página **Traducción de texto** del campo de **Idioma** , seleccione un idioma. Para agregar más idiomas, expanda ** idioma ** campos, y haga clic en ** éste **.
...
5.  En la página **Traducción de texto** del campo de **Idioma** , seleccione un idioma. Para agregar más idiomas, expanda ** idioma ** campos, y haga clic en ** éste **.
6.  En ** texto traducido ** el grupo, especifique las traducciones en ** ** nombre y descripción ** ** campos.
...
El nombre de una variante del producto que se basa en los valores de dimensión pequeños y rojo es **\#3: Pequeño: Rojo **.  

Un cliente desea comprar algunas camisetas pequeñas, rojas y el nombre de la camiseta debe aparecer en francés en la factura. Se traduce los valores de dimensión, pequeño y Rojo, en francés, y el nombre de la variante del producto es **\#3: Pequeno: ** Colorete.
<table>
<colgroup>
<col width="100%" />
</colgroup>
...
<ol>  
<li>Haga <strong>Ventas y marketing</strong> &gt; <strong>Campo común</strong> &gt; <strong>Clientes</strong> &gt; <strong>Todos</strong><strong>clientes</strong>clic en.</li>
...
3.  Haga clic ** ** nuevo y, a continuación escribir un nombre para el grupo en ** tamaño ** ** el grupo ** **, Grupo de colores **, o ** grupo de estilo ** campo. Haga clic en **Tallas**, **Colores**, o **Estilos** para crear líneas para esos grupos.
4.  En ** tamaño ** ** el grupo ** líneas, Color ** ** ** grupo ** ** ** líneas, o ** el grupo de estilo MAT ** página, haga clic en ** nuevo **, y luego haga, los tamaños, colores y estilos para grupos.
...
2.  Haga clic en **Traducción de texto**. En ** traducción de texto ** pagine, en ** texto traducido ** el grupo, especifique las traducciones en ** ** nombre y descripción ** ** campos.

## <a name="when-can-translations-of-productrelated-information-be-managed"></a>¿Cuándo pueden las traducciones de la información relacionada con el producto se tratan?
