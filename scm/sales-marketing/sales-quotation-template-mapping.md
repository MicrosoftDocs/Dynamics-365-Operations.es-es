...
- Antes de sincronizar presupuestos de ventas, en Sales, vaya a **Configuración** &gt; **Administración** &gt; **Configuración del sistema** &gt; **Ventas**, y asegúrese de que el campo **Método de cálculo del descuento** está establecido en **Por unidad**. Este valor ayuda a garantizar que el descuento del artículo de la línea de Sales coincide con la configuración en Finance and Operations. De lo contrario, el descuento no será correcto en Finance and Operations, ya que Finance and Operations leerá el descuento como un descuento por unidad incluso si era un descuento por línea en Sales.
- En Finance and Operations, vaya a **Clientes** &gt; **Configuración** &gt; **Parámetros de cliente**. En la pestaña **Secuencia numérica**, seleccione la secuencia numérica para presupuestos de ventas y luego haga clic en **Ver detalles**. A continuación, en **Configuración general**, establezca el campo **Manual** en **Sí**.
- En Finance and Operations, vaya a **Clientes** &gt; **Configuración** &gt; **Parámetros de clientes**. A continuación, en la pestaña **Envíos**, establezca el campo **Control de fecha de entrega** en **Ninguno**. Este valor ayuda a evitar que la sincronización falle para presupuestos de ventas.
