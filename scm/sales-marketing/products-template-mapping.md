...
-   Asegúrese de que **Decimales admitidos** para la U. de M. coincide con sus requisitos en **CDS -\> Destino**. Si necesita valores diferentes por U. de M., esto se puede hacer con **ValueMap** desde la unidad, por ejemplo, [Cada: 0] y [Libra: 2].

    -   El valor de plantilla se establece de forma predeterminada como 0.
