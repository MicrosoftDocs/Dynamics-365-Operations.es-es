...
## <a name="2-review-and-change-the-new-costing-version-for-the-conversion-record"></a>2. Revise y cambie la nueva versión de gestión de costes del registro de conversión
...
## <a name="3-identify-the-items-to-convert-to-standard-cost"></a>3. Identifique los artículos para convertir a coste estándar
...
## <a name="5-check-and-resolve-any-issues-for-the-items-that-are-being-converted"></a>5. Compruebe si hay algún problema para los artículos que se están convirtiendo
...
## <a name="7-back-up-the-database-before-conversion"></a>7. Realizar una copia de seguridad de la base de datos antes de la conversión
La copia de seguridad le permite restaurar la base de datos si se encuentran errores durante la conversión.

## <a name="8-perform-the-conversion-when-the-conversion-record-has-a-ready-status"></a>8. Realizar la conversión cuando el registro de conversión tenga el estado listo
