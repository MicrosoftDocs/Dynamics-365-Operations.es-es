...
-   [Búsqueda de proveedores](http://ax.help.dynamics.com/en/wiki/search-for-vendors/)
-   [Aprobar proveedores para productos específicos](http://ax.help.dynamics.com/en/wiki/approve-vendors-for-specific-products/)
...
-   [Secuencia de entrada de demostración de inventario de envío para Microsoft Dynamics 365 for Operations](https://mbs.microsoft.com/customersource/northamerica/AX/learning/documentation/white-papers/InboundConsignmentInventoryDemoScriptDynamics365Operations)(documentación)
-   [Supervisar el inventario de envío mediante la colaboración de proveedor](http://ax.help.dynamics.com/en/wiki/monitor-consignment-inventory-using-vendor-collaboration/)
-   [Colaboración con proveedores mediante el portal de proveedores](collaborate-vendors-vendor-portal.md)  (solo en las versiones de febrero de 2016 y mayo de 2016 de Dynamics 365 for Operations)
-   [Configuración de seguridad para los usuarios del portal de proveedores](configure-security-vendor-portal-users.md) (solo en las versiones de mayo de 2016 de Dynamics 365 for Operations)
-   [Espacio de trabajo móvil de colaboración de proveedor para la aplicación Microsoft Dynamics 365 for Operations](vendor-collaboration-mobile-workspace.md)
...
-   [Configurar una jerarquía de categorías de compras](http://ax.help.dynamics.com/en/wiki/set-up-a-procurement-category-hierarchy/)
...
-   [Crear un pedido de compra](http://ax.help.dynamics.com/en/wiki/create-a-purchase-order/)
-   [Crear un pedido de compra de repetición](http://ax.help.dynamics.com/en/wiki/create-a-repeat-purchase-order/)
-   [Crear un pedido de compra desde un pedido de ventas](http://ax.help.dynamics.com/en/wiki/create-a-purchase-order-from-a-sales-order/)
-   [Crear un pedido de compra para un distribuidor plantilla](http://ax.help.dynamics.com/en/wiki/create-a-purchase-order-for-a-one-time-supplier/)
-   [Crear un pedido de compra con una programación de entrega](http://ax.help.dynamics.com/en/wiki/create-a-purchase-order-with-a-delivery-schedule/)
-   [Crear un pedido de devolución de compra](http://ax.help.dynamics.com/en/wiki/create-a-purchase-return-order/)
-   [Crear un pedido parcial de compra de un acuerdo de compra](http://ax.help.dynamics.com/en/wiki/create-a-purchase-release-order-from-a-purchase-agreement/)
...
-   [Crear directivas de compra](http://ax.help.dynamics.com/en/wiki/create-purchasing-policies/)
