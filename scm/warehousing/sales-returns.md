...
## Proceso de pedido de devolución
...
### Proceso de devolución física de pedidos
...
### Crear línea de pedido de devolución
...
## Entrega en almacén para su inspección.
...
### Identificar los productos de la lista de la Visión general de entradas
...
### Proceso de la orden de cuarentena
...
## Crear pedidos de devolución de empresas vinculadas
...
### Devoluciones de empresas vinculadas simples
...
### Devoluciones de envío de entrega directo entre tres partes
...
### Ejemplo 1: el pedido de devolución no hace referencia una factura de cliente
...
### Ejemplo 2: La corrección de crédito se selecciona para el pedido de devolución
...
### Ejemplo 3: La línea de pedido de devolución se crea mediante la función Buscar pedido de ventas
