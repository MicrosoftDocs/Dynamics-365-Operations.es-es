...
El control de calidad requiere realizar pruebas de los productos y gestionar el material de disconformidad. Los procesos de gestión de calidad ayudan a garantizar un nivel superior de la calidad del producto en la cadena de suministro. Estos procesos también ayudan a optimizar los procesos de la cadena de suministro y la satisfacción del cliente. La gestión de calidad puede ayudarle a gestionar los plazos de entrega con productos de disconformidad, independientemente del punto de origen de los productos. Puede vincular resultados de diagnóstico a tareas de corrección. El sistema puede programar tareas de sortear problemas y por tanto de ayudar a evitar frecuencias de estos problemas en el futuro. La administración de calidad también permite realizar un seguimiento de problemas problemas internos (incluido) por el tipo de problema, y le permiten identificar soluciones como a corto o a largo plazo. Las estadísticas acerca de los indicadores clave de rendimiento (KPI) proporcionan información sobre problemas de disconformidad que se han producido anteriormente y las soluciones aplicadas para corregirlos. Puede usar los datos históricos para ayudar a revisar la eficacia de las medidas de calidad que se han aplicado anteriormente y determinar medidas adecuadas en el futuro.
...
[proceso de administración de calidad![] (. /media/quality-management-process-diagram.png])(. /media/quality-management-process-diagram.png)  
...
Una no conformidad describe un artículo que tiene un problema de calidad. ** ** El proceso de no conformidad le permite crear una no conformidad que describa la cantidad de material de no conformidad, el origen del problema, el tipo de problema, y las notas aclaratorias. Puede definir una clasificación de tipos de problemas para que el análisis del material de disconformidad resulte más fácil. También puede imprimir una etiqueta de disconformidad y un informe de disconformidad para guiar la disposición del material de disconformidad. Por ejemplo, la etiqueta y el informe pueden indicar una condición **No utilizable** o **Uso restringido**. La tabla siguiente muestra los seis tipos de disconformidad predeterminados y describe la información que se debe registrar para cada tipo.
...
Las disconformidades se asocian a un tipo de problema. Los tipos de problema se definen en la página **Tipos de problemas**, donde se especifica qué tipos de problema se pueden asociar con cada tipo de disconformidad. Por ejemplo, los tipos de problemas para no conformidades ** solicitud de servicio ** del tipo pueden reflejar una clasificación de las denuncias de clientes, mientras que los tipos de problemas para disconformidades ** ** interno del tipo pueden representar una clasificación de códigos defectuoso. 
...
[Pedidos de calidad de la configuración (guía de la tarea)](http://ax.help.dynamics.com/en/wiki/set-up-quality-orders/)
