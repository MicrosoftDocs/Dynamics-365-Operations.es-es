...
# <a name="set-up-consignment"></a>Configurar envío
...
[inventario-propietarios de![] (. /media/inventory-owners.png])(. /media/inventory-owners.png)
...
[grupo de dimensiones de seguimiento de![] (. /media/tracking-dimension-group.png])(. /media/tracking-dimension-group.png)
