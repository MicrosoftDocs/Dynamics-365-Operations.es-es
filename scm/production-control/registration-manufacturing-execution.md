...
description: "Este tema describe los conceptos y los términos clave que necesita comprender para configurar y usar la ejecución de fabricación."
author: YuyuScheller
manager: AnnBe
ms.date: 04/04/2017
ms.topic: article
...
Este tema describe los conceptos y los términos clave que necesita comprender para configurar y usar la ejecución de fabricación. 

El objetivo de la ejecución de fabricación es que la empleen principalmente las empresas de fabricación. Los trabajadores pueden registrar el consumo de tiempo y artículos en trabajos de producción mediante la página **Registro del trabajo**. Todos los registros se aprueban y se transfieren más tarde a los módulos relevantes. Las aprobaciones y transferencias continuas de registros permiten a los gerentes hacer un fácil seguimiento de los costes reales de los pedidos de producción.
...
|-------------------------------|-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| Ejecución de fabricación       | Una función que se usa para registrar la hora, el consumo de materiales, costes en trabajos de producción, proyectos, y actividades indirectas. El registro se realiza en un cliente de registro de una ejecución de fabricación.                                                                                                                                                                                                                                                                                                                                                                                                   |
