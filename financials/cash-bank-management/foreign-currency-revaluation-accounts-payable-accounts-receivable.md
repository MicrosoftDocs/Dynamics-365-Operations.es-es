...
El valor teórico, o valor en los libros, de las transacciones de proveedores abiertas en divisas extranjeras varía con el tiempo debido a las fluctuaciones del tipo de cambio. Para actualizar el valor de las transacciones de proveedores y clientes abiertas, ejecute un proceso de revalorización de divisa extranjera. Puede ejecutarse una revalorización de divisa extranjera tanto para clientes como para proveedores. Este proceso utiliza un nuevo tipo de cambio para revalorizar los importes abiertos o no liquidados en una fecha concreta. Las diferencias entre las cantidades registradas originales y los importes revalorizados producirán un beneficio no realizado o una pérdida para cada transacción abierta. Los subledgers de los proveedores y los clientes se actualizan para reflejar el beneficio no realizado o las pérdidas, y una entrada contable se registra en la contabilidad general.
...
Use ** revalorización de divisa extranjera ** la página en ** tareas periódicas ** para revalorizar las transacciones abiertas. Puede ejecutar el proceso en tiempo real o programarlo para ejecutarlo mediante un lote. Al definir los valores para el proceso de revalorización, asegúrese de comprobar si desea imprimir un informe de resultados. El informe de revalorización no se puede volver a imprimir después de que el proceso se completado. Si se genera el informe de revalorización de divisa extranjera, este mostrará los distintos saldos en el nivel de cliente o proveedor y el nivel de divisa:
...
Se mantiene un registro cada vez que se ejecuta una revalorización de divisa extranjera. Desde la página **Evaluación de divisa extranjera**, seleccione **Transacciones** para ver la lista detallada de transacciones creadas a raíz de la revalorización. Cada transacción de asiento representa la transacción abierta que se revalorizada. Si una transacción abierta se revalorizada más de una vez, verá dos registros que usen el mismo asiento. Un registro será para la inversión de descuento de pérdidas o ganancias no realizados anteriores, y el otro registro será para el nuevo beneficio no realizado o pérdida. Para ejecutar el proceso de revalorización, haga clic en el botón **Revalorización de divisa extranjera**. Defina los ajustes oportunos para los parámetros siguientes:
