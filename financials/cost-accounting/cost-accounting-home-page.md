...
-   Crear unidades de control de costes.
-   Procesar entradas de contabilidad general.
-   Procesar entradas presupuestarias.
-   Crear e implementar las directivas de comportamiento del coste.
-   Costes de seguimiento.
-   Definir las jerarquías de dimensión.
...
Los laboratorios de prácticas para Contabilidad de costes proporcionan los pasos básicos para configurar Microsoft Dynamics 365 for Finance and Operations, Enterprise Edition – Contabilidad de costes para realizar el análisis de costes reales. También proporciona una serie de procedimientos que puede completar en el orden en que aparecen.
...
-   [Contenido de Power BI sobre configuración de la seguridad para el análisis de la contabilidad de costes](/dynamics365/unified-operations/dev-itpro/analytics/setup-security-cost-accounting-content-pack)
