...
ms.openlocfilehash: 3cc7e7b8ff32df87e080476016015a740df2a39a
...
# Opciones de pagaré español
<a id="spanish-promissory-note-options" class="xliff"></a>
...
## Parámetros de proveedor para pagarés españoles
<a id="accounts-payable-parameters-for-spanish-promissory-notes" class="xliff"></a>
...
## Validación de los diarios de pagarés
<a id="validation-for-promissory-notes-journals" class="xliff"></a>
...
## Fechas en los diarios de pagarés
<a id="dates-in-promissory-notes-journals" class="xliff"></a>
...
## Confirmación de facturas
<a id="invoice-confirmation" class="xliff"></a>
