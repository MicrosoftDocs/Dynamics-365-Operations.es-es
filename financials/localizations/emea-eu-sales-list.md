...
<td>La dirección principal de la entidad jurídica debe estar en un estado miembro de la Unión Europea. En <strong>Entidades jurídicas</strong> la página (haga <strong>Administración de la organización</strong> &gt; <strong>Organizaciones</strong> &gt; <strong>Entidades jurídicas</strong>clic), seleccione la entidad jurídica. En la ficha desplegable <strong>Direcciones</strong>, cree una dirección, seleccione un país o región y otros componentes de la dirección y marque la dirección como <strong>Principal</strong>. En la ficha desplegable <strong>Registrar impuestos</strong>, en el campo <strong>Número de registro de impuestos</strong>, especifique el número de registro de impuestos de la empresa.</td>
</tr>
<tr class="even">
<td><strong>Configuración:</strong> parámetros de identificación de exención de impuestos</td>
<td>Parámetros exentos de impuestos de la identificación en <strong>Parámetros de país o región</strong> la página (haga <strong>Impuestos</strong> &gt; <strong>Configuración</strong> &gt; <strong>impuestos</strong> &gt; <strong>Parámetros de país o región</strong>clic). Para cada país o región donde tiene contrapartidas, cree un registro en la página y especifique la información siguiente:
<ul>
...
<td>Crear números de identificación fiscal para las contrapartidas en <strong>Números de identificación fiscal</strong> la página (haga <strong>Impuestos</strong> &gt; <strong>Configuración</strong> &gt; <strong>impuestos</strong> &gt; <strong>Números de identificación fiscal</strong>clic). Para cada número de identificación fiscal (NIF), cree un registro en la página y especifique la información siguiente:
<ul>
...
<td>Configuración de la información de registro de impuestos de las contrapartidas en <strong>Todos los clientes</strong> la página (haga <strong>Ventas y marketing</strong> &gt; <strong>Clientes</strong> &gt; <strong>Todos los clientes</strong>clic en, seleccione un registro de cliente, y haga <strong>Opciones</strong> &gt; <strong>Vista de cambio</strong> &gt; <strong>Vista de detalles</strong>clic en) o <strong>Proveedores</strong> la página (haga <strong>Adquisición y abastecimiento de componentes</strong> &gt; <strong>Proveedores</strong> &gt; <strong>Proveedores</strong>clic en, seleccione un registro de proveedor, y haga <strong>Opciones</strong> &gt; <strong>Vista de cambio</strong> &gt; <strong>Vista de detalles</strong>clic en). En la ficha desplegable <strong>Factura y entrega</strong>, en el campo <strong>Número de identificación fiscal</strong>, seleccione el número de registro de impuestos.</td>
</tr>
<tr class="odd">
<td><strong>Configuración: </strong>impuestos</td>
<td>Configuración de códigos de impuestos para incluir en <strong>Lista de ventas de la UE</strong> el informe en <strong>Códigos de impuestos</strong> la página (haga <strong>Impuestos</strong> &gt; <strong>Impuestos indirectos</strong> &gt; <strong>impuestos</strong> &gt; <strong>Códigos de impuestos</strong>clic). En la ficha desplegable <strong>Configuración de informes</strong> para cada código de impuestos que se debe incluir en el informe, desactive la casilla <strong>Excluído</strong>. Configuración de parámetros de impuestos para los artículos en <strong>Grupos de impuestos de artículos</strong> la página (haga <strong>Impuestos</strong> &gt; <strong>Impuestos indirectos</strong> &gt; <strong>impuestos</strong> &gt; <strong>Grupos de impuestos de artículos</strong>clic). Para cada grupo de impuestos de artículos, seleccione un valor en el campo <strong>Tipo de notificación</strong>. El valor que seleccione determina la columna de ESL del importe donde se incluirá el importe de línea.
<ul>
...
<td>Configuración de parámetros de notificación de ESL en <strong>Parámetros de comercio exterior</strong> la página (haga <strong>Impuestos</strong> &gt; <strong>Configuración</strong> &gt; <strong>Comercio exterior</strong> &gt; <strong>Parámetros de comercio exterior</strong>clic). Especifique los parámetros siguientes:
<ul>
