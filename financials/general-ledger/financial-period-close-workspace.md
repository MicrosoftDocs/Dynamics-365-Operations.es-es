...
Para poder usar el espacio de trabajo **Cierre del periodo financiero**, debe configurar el proceso en Microsoft Dynamics 365 for Operations con la página **Configuración de cierre del período financiero**. (Haga clic en **Contabilidad general** &gt; **Cierre de período** &gt; **Configuración de cierre del período financiero**.)
