---
title: "Índices de impuestos basados en la base y los métodos de cálculo marginales"
...
# <a name="sales-tax-rates-based-on-the-marginal-base-and-calculation-methods"></a>Índices de impuestos basados en la base y los métodos de cálculo marginales

Este artículo explica cómo los valores de los campos Base marginal y Método de cálculo determinan los índices de impuestos en transacciones de compras y ventas.
...
Si la factura tiene dos líneas de cuatro artículos en cada línea, el importe neto de cada línea es 100.00 y los impuestos se calculan del modo siguiente: 
...
Base marginal: ** Importe neto unitario ** 
...
Base marginal: ** Importe neto de factura equilibrar ** 

Método de cálculo: ** Intervalo ** una factura de ventas tiene 2 líneas de 4 lámparas que gravan las líneas para 25.00 cada una. El importe neto del saldo de la factura es 4 x 25,00 + 4 x 25,00 = 200,00. Los impuestos se calculan como sigue: Total de impuestos = 50 x 0,30 + 50 x 0,20 + 100 x 0,10 = 15 + 10 + 10 = 35,00 Importe total de factura = 200,00 + 35,00 = 235,00
...
Base marginal: **Importe bruto por línea** Método de cálculo: **Intervalo** Hay además otro código de impuestos calculado para un arancel especial de 5,00 en cada lámpara. Los aranceles se añaden al importe neto antes del cálculo de impuestos de ventas. Supongamos que compra 8 lámparas que cuestan 25,00 cada una. El importe neto de la línea de factura es 200,00. El importe bruto de la línea de factura es 8 x 25,00 + 8 x 5,00 = 240,00. El impuesto se calcula del modo siguiente: Importe total de impuestos aranceles totales = 50 x 0.30 + 50 x 0.20 + 140 x 0.10 = 15 + 20 + 14 = 39.00 = 5.00 x 8 = 40.00 importes totales de factura = 200.00 + 39.00 + 40.00 = 279.00

**Variation** 

Si la factura se crea con 2 líneas de 4 artículos en cada línea, el importe neto por línea de factura es 100.00. El importe bruto (incluidos los aranceles 4 x 5,00) por línea de factura sería 120,00, y se crearían los impuestos como sigue: Factura de impuestos línea 1 = 50 x 0,30 + 50 x 0,20 + 20 x 0,10 = 15 + 10 + 2 = 27,00 Factura de impuestos línea 2 = 50 x 0,30 + 50 x 0,20 + 20 x 0,10 = 15 + 10 + 2 = 27,00 Impuestos totales = 27,00 + 27,00 = 54,00 Arancel total = 5,00 x 8 = 40,00 Importe total de factura = 200,00 + 54,00 + 40,00 = 294,00
...
> [!NOTE]
> En un grupo de impuestos, sólo puede tener un código de impuestos con esta selección en el campo Base marginal
...
Base marginal: ** Total de la factura incluidos otros importes de impuestos ** método de cálculo: ** Intervalo **   
...
Para obtener más información, consulte [importe y las opciones del cálculo enteros del intervalo para los códigos de impuestos whole-amount-interval-options-sales-tax-codes.md] () y [los métodos de cálculo de impuestos en el campo Origen sales-tax-calculation-methods-origin-field.md] ().
