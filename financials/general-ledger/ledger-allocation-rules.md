...
-   **Origen**: este componente es donde el usuario especifica los datos de origen para la asignación. La asignación se puede basar en los saldos contables (** origen de datos ** = ** libro mayor **) o los importes fijos (** origen de datos ** = ** valor fijo **). Cuando **Origen de datos** se establece en **Libro mayor**, se deben definir criterios de filtro de suministro para la regla de asignación de contabilidad (por ejemplo, para los gastos de publicidad).
