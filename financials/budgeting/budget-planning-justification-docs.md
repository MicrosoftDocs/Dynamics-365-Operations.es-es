...
# Planificación presupuestaria para documentos de justificación
...
##### Configure el complemento de Microsoft Dynamics Office para Microsoft Word
...
##### Defina la plantilla de justificación en Microsoft Word
...
##### Configure el proceso de planificación presupuestaria para usar la plantilla de justificación
<a id="set-up-the-budget-planning-process-to-use-the-justification-template" class="xliff"></a>

1.  En Finance and Operations, vaya a **Gestión presupuestaria** &gt; **Configuración** &gt; **Planificación presupuestaria** &gt; **Plantillas de documento de justificación**.
...
##### Edite y guarde los documentos de justificación personalizados
