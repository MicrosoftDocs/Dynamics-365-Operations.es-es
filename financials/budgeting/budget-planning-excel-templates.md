...
> [!NOTE] 
> Para evitar posibles problemas con la visualización y edición de los datos del plan presupuestario con Excel, el mismo usuario se debe registrar en Dynamics 365 for Operations y el conector de datos del complemento de Office para Microsoft Dynamics.
...
Guarde y cierre el archivo de Excel. Vuelva a Dynamics 365 for Operations y en **Diseños** haga clic en clic **Plantilla &gt; Cargar** para cargar la plantilla de Excel guardada que se utilizará para el plan presupuestario. 
