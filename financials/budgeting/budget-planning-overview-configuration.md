...
Cuando se dispone los conceptos y la terminología que se utilizan en Microsoft Dynamics 365 para las operaciones, se más fácil implementar el presupuesto planificado en su organización.
...
[terminología de planificación de presupuesto![] (. /media/budgetplanning-terms-1024x504.png])(. /media/budgetplanning-terms.png)
...
[esquema genérico planificado presupuesto![] (. /media/budgetplanninggenericschema-300x145.png])(. /media/budgetplanninggenericschema.png) 

En el siguiente ejemplo, Retail Headquarters corporativas estiman los importes iniciales de la línea de base de presupuesto y distribuyen los departamentos de ventas. Los departamentos de ventas calculan y devuelven su previsión a las sedes, donde el director de presupuestos agrega y ajusta la previsión. Finalmente, el director de presupuestos envía importes de presupuesto ajustados al director financiero para revisión, ajustes finales y aprobación. 

[el presupuesto![se pondrán ejemplo del esquema (]. /media/budgetplanningexampleschema-300x145.png])(. /media/budgetplanningexampleschema.png)
...
Un flujo de trabajo de planificación presupuestaria consiste en un conjunto ordenado de etapas por las que se mueve un plan presupuestario. Cada flujo de trabajo de planificación presupuestaria se asocia a un flujo de trabajo presupuestario. Los flujos de trabajo son uno de los tipos de flujo de trabajo que se usan en Microsoft Dynamics 365 para las operaciones. El flujo de trabajo presupuestario enruta los planes presupuestarios, junto con las hojas de cálculo, las justificaciones y los datos adjuntos, a la organización para su revisión y aprobación. 
...
Cree el flujo de trabajo de presupuesto para la planificación presupuestaria en la página **Flujos de trabajo presupuestarios**. El proceso es similar al que se usa para crear otros flujos de trabajo en Microsoft Dynamics 365 para las operaciones. En la ilustración siguiente se muestra un ejemplo de un flujo de trabajo de sedes. 

[flujo de trabajo![para el presupuesto planificado (]. /media/budgetingworkflowforbudgetplanning-300x300.png])(. /media/budgetingworkflowforbudgetplanning.png) 

El flujo de trabajo incluye elementos para su asignación a los departamentos de ventas y al agregado de los envíos, la revisión del director de presupuestos, la aprobación por el CFO, y las transiciones de la etapa entre cada etapa. 
...
-   **Asignar en períodos**: use una clave de asignación de período para asignar las líneas del plan presupuestario desde el escenario del plan presupuestario de origen a través de los períodos del escenario de destino. ** Nota: ** Para poder asignar entre los períodos, debe configurar las claves de asignación por períodos de la página de **** de las categorías de asignación de períodos de ****.
-   **Asignar a dimensiones**: las líneas del plan presupuestario se asignan desde el escenario del plan presupuestario de origen a través de las dimensiones financieras del escenario de destino. ** Nota: ** Para poder asignar a dimensiones, debe configurar condiciones de asignación del presupuesto en la página de **** de las condiciones de asignación del presupuesto de ****.
...
Cuando configura una asignación de etapa, asocia el flujo de trabajo y la etapa de planificación presupuestaria con la programación de asignación. El flujo de trabajo de planificación de presupuesto se debe asociar a un flujo de trabajo que utilice la tarea de flujo de trabajo automatizada **** de la asignación desde la fase de planificación de presupuesto de ****. Cuando el flujo de trabajo alcanza la etapa especificada, la asignación se produce automáticamente. Esta tarea automatizada se puede usar para crear líneas de plan presupuestario en un nuevo escenario. 
...
[asignación de la etapa![] (. /media/stageallocation-204x300.png])(. /media/stageallocation.png) 

Además, en el esquema de ejemplo, una adición se hace de planes y de escenarios de presupuesto en la etapa mostrará departamento de ventas a un plan principal en la etapa de acumulación de la sede. En la ilustración siguiente se muestra la sección relevante del esquema de ejemplo.
...
También designa si cada artículo de diseño (columna) se puede editar, y si está disponible en la plantilla de la hoja de cálculo creada para dicho diseño. Para el esquema de ejemplo, en el diseño que se usa para la etapa Estimación, las columnas de previsión son editables, mientras que las columnas de ventas PY y contratos son de solo lectura.
...
> [!NOTE] 
> La plantilla se debe guardar en una ubicación a la que el usuario tenga acceso a, para que se pueda cargar en el diseño después de que el editar complete. De esa manera, la plantilla se usará con los planes presupuestarios que usan la configuración.
