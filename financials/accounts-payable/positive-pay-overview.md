...
Después de que se hayan pagado los cheques que aparecen en un archivo de pago positivo, recibirá un número de confirmación del banco. A continuación puede confirmar positivo el archivo de pago de Microsoft Dynamics 365 para las operaciones. 
...
Para obtener más información, consulte [la configuración y generar los archivos positivos] del sueldo (setup-generate-positive-pay-files.md).
