...
<a name="what-is-the-goal-of-sepa-direct-debits"></a>¿Qué es el objetivo de los débitos directos de SEPA?
---------------------------------------

Un débito directo de SEPA permite a un acreedor cobrar fondos de la cuenta bancaria de un cliente de, siempre que un pedido firmado se ha concedido por el cliente al acreedor. El cliente firma una orden que autorice el acreedor a cobrar un pago y da instrucciones al banco del cliente para pagar el cobro. 
...
El número internacional de cuenta bancaria (IBAN) y el código de identificador del banco (BIC) se usan para identificar las cuentas en los 32 países o regiones de SEPA. Especifique el Bic en el campo Código SWIFT y IBAN en el campo de IBAN. Ambos campos se encuentran en la ficha desplegable Identificación adicional de la ficha de Cuenta bancaria de la página Cuentas bancarias. Esto ocurre para la cuenta bancaria del acreedor y la cuenta bancaria del cliente.
...
Los formatos de datos de SEPA se basan en la normativa de mensajes ISO 20022. Se comprobará la casilla electrónica genérica de informe y seleccione el formato de débito directo de SEPA como configuración del formato de exportación al configurar las formas de pago de los clientes. Usará dicho método de pago cuando genere un archivo de pago en un diario de pago de cliente.
