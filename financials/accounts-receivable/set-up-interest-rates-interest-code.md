...
-   ** Porcentaje ** se selecciona ** ** en ** calcula el interés basa ** campo en ** configurar los códigos de interés ** página.

Por ejemplo, para configurar un código de interés que evalúa el 5 por ciento de interés para cada dos meses que el pago de la factura supera la fecha de vencimiento de la transacción, se introduciría 2 en ** calcula el interés cada ** el campo y seleccione ** ** mes.
...
-   Se pueden especificar límites de interés opcionales.
-   ** Importe ** se selecciona en ** calcula el interés basa ** campo en ** configurar los códigos de interés ** página.

Por ejemplo, para configurar un código de interés que evalúa el interés de 25.00 por cada 20 días que el pago de la factura supera la fecha de vencimiento de la transacción, se introduciría 20 en ** calcula el interés cada ** el campo y seleccione ** ** día.
...
## <a name="new-versions"></a>Nuevas versiones
