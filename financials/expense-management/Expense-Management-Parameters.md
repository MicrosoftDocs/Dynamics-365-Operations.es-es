...
| **Campo**                             | **Descripción**             |
|---------------------------------------|--------------------------------------------------------------------------------------|
|**Horas mínimas para dietas**           | Especifique el número mínimo de horas que debe trabajar un empleado por día para que tenga derecho a recibir dietas para gastos relacionados con un viaje.                                                                                      |
