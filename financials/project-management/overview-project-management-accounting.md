...
Un proyecto es un grupo de actividades que está diseñado para proporcionar un servicio, para producir un producto, o para alcanzar un resultado. Los proyectos consumen los recursos y generar resultados financieros en forma de ingresos o activos.

## <a name="projects-across-industries"></a>Proyectos entre sectores
La funcionalidad de contabilidad y administración de proyectos se puede usar en varios sectores, como se muestra en la siguiente ilustración. [proyectos![a través de sectores] (. /media/projects-accross-industries.jpg])(. /media/projects-accross-industries.jpg) 

En un centro de llamadas, se puede usar un ticket para describir el conjunto de acciones que se requieren para resolver una llamada. Las empresas asesoría administrativa, como la gestión o organizaciones o agencias de publicidad de asesoría técnicas, hacen referencia a sus actividades como proyectos. En el marketing, una campaña representa un conjunto de trabajo que va entregar. En la fabricación basada en proyectos, un pedido de producción está relacionado con el trabajo diverso que se debe realizar para producir algunos bienes terminados. Cualquier nombre se utiliza para ellos, estos recursos implicars los proyectos, las programaciones, y costes, y la funcionalidad de gestión de proyectos y contabilidad en Microsoft Dynamics 365 para las operaciones pueden ayudarle con la planificación, la ejecución, y análisis de los proyectos.
...
Durante la liberación del proyecto, varios procesos clave aparecen. Puede usar un presupuesto de proyecto para comunicar el trabajo, gastos, y el material estimados al cliente. Puede registrar los términos, los límites, y los acuerdos de la factura en un contrato de proyecto. Puede usar una estructura de descomposición del trabajo (WBS) para planificar y realizar la estimación del trabajo. Puede configurar previsiones y presupuestos para guiar la ejecución de proyectos. La ilustración siguiente muestra la estructura de un proyecto. [estructura de proyecto de![] (. /media/project-structure1.jpg])(. /media/project-structure1.jpg)  
...
| Precio fijo       | En proyectos de precio fijo, las facturas constan de transacciones a cuenta. Un proyecto de precio fijo se factura como una programación de facturación basada en un contrato de proyecto. El ingreso para un Proyecto de precio fijo se puede calcular y registrar en el proyecto mediante el método de porcentaje completado. Como alternativa, los ingresos se pueden calcular y registrar una vez completado el proyecto, con el método de contrato completado. Las empresas pueden a menudo beneficiarse de utilizar el valor del trabajo en proceso (WIP) para calcular el grado de finalización de un proyecto o grupo de proyectos.                                                                                                                                     |
| Inversión        | Los proyectos de inversión son los proyectos que no producen ganancias inmediatas. Normalmente se usan para proyectos internos a largo plazo en los que se deberán capitalizar los costes. Solo se pueden registrar los costes por artículos, horas y gastos para un proyecto de inversión. A los costes de un proyecto de inversión se les realiza un seguimiento y se controlan mediante la función de estimación. Los proyectos de inversión se pueden configurar con un capitalización máxima opcional. A medida que un proyecto de inversión progrese, deberá registrar los costes en las cuentas de trabajo en curso, donde se reservan los costes hasta que se complete el proyecto. Cuando se elimina el proyecto, deberá transferir el valor de trabajo en curso a un activo fijo, a una cuenta contable, o a un nuevo proyecto.
> [!NOTE] 
> Las transacciones en los proyectos de inversión no se muestran en los ** Registrar costes, ** ** acumular ingresos **, o ** cree las propuestas de factura ** la página.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                 _=_ _=_ Proyecto de coste      _=_ Como proyectos de inversión, los proyectos de coste se utilizan normalmente de seguir proyectos internos, y sólo las horas, gastos, y los artículos se pueden registrar para ellos. Sin embargo, la duración de los proyectos de coste es normalmente más corta que la de los proyectos de inversión. Además, a diferencia de los proyectos de inversión, los proyectos de coste no se pueden capitalizar en las cuentas de balance general. En su lugar, las transacciones de proyecto se registran solo en las cuentas de ganancias y pérdidas. 
[!NOTE] 
> Las transacciones en los proyectos de coste no se reflejen en los ** Registrar costes, ** ** acumular ingresos **, o ** cree las propuestas de factura ** la página. Dado que los proyectos de coste se utilizan normalmente de seguir proyectos internos, no tienen que normalmente estar asociados a una cuenta de cliente. Sin embargo, si su configuración requiere la creación de requisitos de artículos para pedidos de compra, debe asociar el proyecto de coste a un cliente. Esta asociación es necesaria porque los requisitos de artículos se administran como líneas de pedidos de ventas y el sistema necesita que se especifique un cliente. Sin embargo, esta configuración no provocará que se creen automáticamente los requisitos de artículos automáticamente a partir de un pedido de compra. Para los proyectos de coste, se omite el ajuste **Crear requisito de artículo**. Si necesita un requisito de artículo en un proyecto de coste, puede crear uno manualmente, siempre que haya un cliente asociado al proyecto. _=_ _=_ Interno          _=_ Los proyectos internos se usan para los costes de realizar un seguimiento de un proyecto que esté interno a su organización. Los proyectos internos pueden proporcionar una herramienta de planificación gestionar el consumo de recursos. ** Nota: ** Las transacciones en proyectos internos no se reflejen en ** acumular ingresos o ** ** cree las propuestas de factura ** la página.                                                                                                                                                                                                                                                                       _=_ _=_ Tiempo              _=_ Se utilizan los proyectos de tiempo de seguir el tiempo que está asociado a actividades no imputables y no productivas, como un proyecto de la hora enferma para los trabajadores. Las transacciones en los proyectos de tiempo no se registran en el libro mayor. En su lugar, se incluyen en los informes de utilización del trabajador. En este caso, solo se podrán registrar las transacciones por horas en los proyectos de tiempo. Usa un diario o una hoja de horas de horas para registrar estas horas en el proyecto. Después de las horas se registran, estos aparecen como transacciones de proyecto pero no tienen transacciones de asiento correspondientes.

> [!NOTE] 
> Los proyectos de las transacciones a tiempo no se reflejen en los ** Registrar costes, ** ** acumular ingresos **, o ** cree las propuestas de factura ** la página.                                                                                                                                                                                       |
...
Aquí hay algunas de las maneras que puede utilizar la funcionalidad de programación de recursos:
...
-   Para pedir artículos del inventario de la empresa, debe especificar el pedido como un requisito de artículo. Si usa ** los requisitos de artículo ** la página, puede configurar el requisito de forma que reciba los artículos como entregas parciales. Por lo tanto, puede posponer el consumo de una cantidad de artículos hasta que se necesiten los artículos.
-   Para pedir artículos a un proveedor externo, debe crear el pedido como un pedido de compra en la página **Pedido de compra**.

> [!NOTE] 
> El albarán para un pedido de ventas relacionado con el proyecto no se puede cancelar si los artículos se han marcado ya para empaquetar. 
...
Microsoft Dynamics 365 para las operaciones automáticamente no reduce las estimaciones previstas. Por tanto, es buena idea mantener un modelo de previsión original en el proyecto de precio fijo para establecer una base para comparación una vez completado el proyecto. 
> [!NOTE] al seleccionar este método, utilice al menos dos modelos de previsión. Un modelo debe contener la previsión original. Para el otro modelo, debe copiar las transacciones de previsión de otro modelo. Este método solo es válido para proyectos de precios fijos e inversión.</td>
> </tr>
<tr class="odd">
...
-   ** Fecha de factura: ** 31 de marzo de 2012. Esta fecha se determina en función de frecuencia de facturación. Para este ejemplo, se establece la frecuencia de facturación al mes actual. Por tanto, todas las transacciones que se registran en el mes de marzo se facturan el último día del mes.
-   ** Fecha de vencimiento: ** 14 de abril de 2012. Esta fecha se determina en función de las condiciones de pago que se han liquidado para el proyecto. Para este ejemplo, seleccionó condiciones de pago de 14 días. Por lo tanto, se agregaron 14 días a la fecha de la factura del envío en una fecha de vencimiento de 14 de abril de 2012.
-   ** Fecha esperada de pago de ventas: ** 27 de abril de 2012. Esta fecha se calcula sumando el número de días en ** los días de almacenaje generales ** el campo en ** parámetros de contabilidad y gestión de proyectos ** la página al número de días en ** los días de almacenaje ** individuales del campo en la página ** los contratos de proyecto ** y, a continuación a agregar el total al número de días en ** fecha de vencimiento ** el campo. Por ejemplo, ha especificado **3** en el campo **Días de almacenaje generales** y **10** en el campo **Días de almacenaje individual**. Por lo tanto, se agregaron 13 días a la fecha de vencimiento del envío en una fecha esperada de pago de ventas de 27 de abril de 2012.
...
-   ** Fecha esperada de pago de ventas: ** 29 de marzo de 2012. El cálculo incluye tres días de almacenaje generales y 10 días de almacenaje individuales.
...
> [!NOTE] 
> La fecha de vencimiento para el pedido de compra se basa en la transacción de proveedor cuando se crea el pedido de compra de proyecto. La fecha de vencimiento no se determina por la configuración predeterminada. 
...
|----------------|-------------------------|
| Flujos de entrada de efectivo   | Ingresos                 |
...
> [!NOTE] 
> Cuando usa ** control de costes ** la página para ver el estado actual de costes de proyecto, use los modelos de previsión seleccionadas para el original y el presupuesto restante. Si selecciona otros modelos de previsión al calcular costes, los resultados del cálculo no serán precisos.
