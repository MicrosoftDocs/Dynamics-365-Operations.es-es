...
description: "En versiones anteriores, había dos conceptos de la evaluación para los activos fijos - modelos de valor y libros de amortización. En Microsoft Dynamics 365 para la liberación de las operaciones (1611, la función del modelo de valor y la funcionalidad del libro depreciación se han combinado en un solo concepto que se conoce como libro."
author: twheeloc
manager: AnnBe
ms.date: 04/04/2017
ms.topic: article
...
La función del nuevo libro se basa en la función anterior del modelo de valor pero también incluye todas las funciones que se proporcionaron anteriormente únicamente en libros de amortización. [Libreta![como una combinación de la función del modelo de valor y libro amortización (]. /media/fixed-assets.png])(. /media/fixed-assets.png) Debido a esta combinación, ahora puede usar un único conjunto de páginas, de preguntas, e informes para todos los procesos del activo fijo. Las tablas de este tema describen la función anterior para los libros de amortización y los modelos de valor, así como la nueva función para los libros.
