...
> [!NOTE] 
> Normalmente, cuando el importe que se calcula mediante el método de depreciación degresiva 125% se reduce por debajo del importe que sería calculado mediante el método lineal, hay una conversión al método de depreciación lineal para el tiempo de vida restante.
