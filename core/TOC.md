...
# [Integrada a Dynamics 365 para operaciones](get-started/onboarding-home.md)
## Introducción a Dynamics 365 para operaciones
### [Introducción a Microsoft FastTrack para Dynamics 365](get-started/fasttrack-dynamics-365-overview.md)
...
### [Sintaxis de consulta y filtro avanzado](get-started/advanced-filtering-query-options.md)
### [Dynamics 365 para cliente de operaciones FAQ](get-started/client-faq.md)
...
### [Administrar cómo mostrar páginas](get-started/window-management.md)
### [Comprender los servicios del ciclo de vida](/dynamics365/operations/dev-itpro/lifecycle-services/lcs-works-lcs?toc=/dynamics365/operations/toc.json)

## Obtener ayuda y soporte técnico
### [Resumen de la Ayuda](/dynamics365/operations/dev-itpro/get-started/help-overview?toc=/dynamics365/operations/toc.json)
### [Conectar ayuda](/dynamics365/operations/dev-itpro/get-started/help-connect?toc=/dynamics365/operations/toc.json)
...
## [Contenido de ayuda específicas de país/región](/dynamics365/operations/dev-itpro/lcs-solutions/country-region?toc=/dynamics365/operations/toc.json)

# [Configurar la organización](organization-administration/organization-administration-home-page.md)
## [Organizations and organizational hierarchies](organization-administration/organizations-organizational-hierarchies.md)
## [Configurar la jerarquía de la organización](organization-administration/plan-organizational-hierarchy.md)
...
### [Configurar libretas de direcciones globales](organization-administration/plan-configuration-global-address-book-additional-address-books.md)
...
## [Visión general de la administración de casos](organization-administration/cases.md)
### [Configurar seguridad mayúsculas, los procesos y categorías](organization-administration/plan-case-management.md)
...
## [Datos de fecha y hora y zonas horarias](organization-administration/date-time-zones.md)

# Diseñar flujos de trabajo
## [Introducción al sistema de flujo de trabajo](organization-administration/overview-workflow-system.md)
...
## [Configurar las propiedades de flujo de trabajo](organization-administration/configure-workflow-properties.md)
...
# [Programador y administrador](/dynamics365/operations/dev-itpro/index)

# Otros recursos
## [Dynamics 365 para Glosario de operaciones](get-started/glossary.md)
