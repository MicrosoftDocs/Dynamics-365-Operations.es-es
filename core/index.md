---
title: "Introducción a Dynamics 365 para operaciones"
description: "Microsoft Dynamics 365 para operaciones es la aplicación de negocio de Microsoft para empresas. Esta página le ayuda a aprender y empezar a utilizar el producto."
author: margoc
manager: AnnBe
ms.date: 04/04/2017
ms.topic: index-page
...
---
# <a name="introduction-to-dynamics-365-for-operations"></a>Introducción a Dynamics 365 para operaciones

[!include[banner](includes/banner.md)]

Microsoft Dynamics 365 para operaciones es la aplicación de negocio de Microsoft para empresas. Permite que varias personas rápidamente tomar decisiones más acertadas a través de una interfaz de usuario inteligente que proporciona acceso a datos y perspectivas en tiempo real. Permite a las empresas de transformación y innnovate al ofrecer la lógica empresarial probada que les permite rediseñar sus procesos de negocio con mayor rapidez. Proporciona a las empresas la flexibilidad necesaria para crecer a su propio ritmo y hacer negocios casi en cualquier lugar y momento, lo que les permite escalar sus operaciones a nivel mundial para satisfacer las necesidades del negocio. 

Este manual del usuario puede ayudarle a aprender cómo hacer 365 Dynamics para operaciones para su negocio.    
...
<tbody>
<tr class="odd">
<td><p><a href="get-started/onboarding-home.md">Incorporación de la organización</a></p>
...
<p>Recursos humanos</p>
   <ul>
  <li><a href="human-resources/departments-jobs-positions.md">Estrategia de RRHH</a></li>
  <li><a href="human-resources/manage-recruiting-process.md">Reclutar, contratar y motivar a</a></li>
  ...
  <li><a href="human-resources/localizations/noam-usa-payroll.md">Características de EE.</a></li>
</ul></td>
  <td>
  <p>Venta minorista</p>
  <ul>
<li><a href="retail/call-center-functionality.md">Call center</a></li>
  ...
  <li><a href="retail/define-maintain-channel-clients-registers-hw-stations.md">POS MPOS y nube</a></li>
  <li><a href="retail/dev-itpro/dev-retail-home-page.md">Administración y desarrollador comercial</a></li></ul>
...
<li><a href="supply-chain/cost-management/costing-sheets.md">Cost management</a></li>
  ...
  <p>Funciones de programador y admin</p>
